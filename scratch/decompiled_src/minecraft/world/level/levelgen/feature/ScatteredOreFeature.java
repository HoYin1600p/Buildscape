...
public class ScatteredOreFeature extends AbstractOreFeature {
   ...
   public static final MapCodec CODEC = makeCodec(ScatteredOreFeature::new);

   public ScatteredOreFeature(final List targetStates, final int size, final float discardChanceOnAirExposure) {
