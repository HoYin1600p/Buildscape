...
public class ParticleTypes {
   ...
   public static final ParticleType GEYSER = register("geyser", true, GeyserParticleOptions::codec, GeyserParticleOptions::streamCodec);
   public static final ParticleType GEYSER_BASE = register("geyser_base", true, GeyserBaseParticleOptions::codec, GeyserBaseParticleOptions::streamCodec);
   public static final ParticleType GEYSER_POOF = register("geyser_poof", true, GeyserBaseParticleOptions::codec, GeyserBaseParticleOptions::streamCodec);
   public static final ParticleType GEYSER_PLUME = register("geyser_plume", true, GeyserParticleOptions::codec, GeyserParticleOptions::streamCodec);
   ...
   public static final Codec CODEC = BuiltInRegistries.PARTICLE_TYPE.byNameCodec().dispatch(ParticleOptions::getType, ParticleType::codec);
   public static final StreamCodec STREAM_CODEC = ByteBufCodecs.registry(Registries.PARTICLE_TYPE).dispatch(ParticleOptions::getType, ParticleType::streamCodec);
   ...
   private static ParticleType register(final String name, final boolean overrideLimiter, final Function codec, final Function streamCodec) {
      return (ParticleType)Registry.register(BuiltInRegistries.PARTICLE_TYPE, name, new ParticleType(overrideLimiter) {
