...
public class PostEffectCommand {
   ...
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_ADD = CommandResponseTracker.messages(ERROR_ADD_FAILED, (entity, var1, posteffect) -> Component.translatable("commands.posteffect.add.success.single", Component.translationArg(posteffect), entity.getDisplayName()), (entityCount, var1, posteffect) -> Component.translatable("commands.posteffect.add.success.multiple", Component.translationArg(posteffect), entityCount));
   private static final CommandResponseTracker.Messages RESPONSE_CLEAR = CommandResponseTracker.messages(ERROR_CLEAR_FAILED, (entity, var1) -> Component.translatable("commands.posteffect.clear.success.single", entity.getDisplayName()), (entityCount, var1) -> Component.translatable("commands.posteffect.clear.success.multiple", entityCount));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_REMOVE = CommandResponseTracker.messages(ERROR_REMOVE_FAILED, (entity, var1, posteffect) -> Component.translatable("commands.posteffect.remove.success.single", Component.translationArg(posteffect), entity.getDisplayName()), (entityCount, var1, posteffect) -> Component.translatable("commands.posteffect.remove.success.multiple", Component.translationArg(posteffect), entityCount));
   ...
   private static int addPostEffect(final CommandSourceStack source, final Collection players, final Identifier posteffect) throws CommandSyntaxException {
   ...
   private static int clearPostEffect(final CommandSourceStack source, final Collection players) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
   ...
   private static int listPostEffects(final CommandSourceStack source, final ServerPlayer player) {
      List postEffects = player.getPostEffects();
   ...
   private static int removePostEffect(final CommandSourceStack source, final Collection players, final Identifier posteffect) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
