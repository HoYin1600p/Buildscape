...
public class BlockModelFeatureRenderer extends RenderTypeFeatureRenderer {
   public static final FeatureRendererType TYPE = FeatureRendererType.create("Block Model");
   ...
   public static record Submit(PoseStack.Pose pose, RenderType renderType, List modelParts, int[] tintLayers, int lightCoords, int overlayCoords, int tintColor, PoseStack.@Nullable Pose sheetedDecalPose) implements TranslucentSubmit {
