...
public class ItemIdFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type oldItemType = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
      Type newItemType = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
      OpticFinder id = DSL.fieldFinder("id", oldItemType);
