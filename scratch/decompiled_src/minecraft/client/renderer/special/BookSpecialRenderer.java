...
public class BookSpecialRenderer implements NoDataSpecialModelRenderer {
   ...
   public static record Unbaked(float openAngle, float page1, float page2) implements NoDataSpecialModelRenderer.Unbaked {
      public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Codec.FLOAT.fieldOf("open_angle").forGetter(BookSpecialRenderer.Unbaked::openAngle), Codec.FLOAT.fieldOf("page1").forGetter(BookSpecialRenderer.Unbaked::page1), Codec.FLOAT.fieldOf("page2").forGetter(BookSpecialRenderer.Unbaked::page2)).apply(i, BookSpecialRenderer.Unbaked::new));
