...
public abstract class BossEvent {
   ...
   public static enum BossBarColor implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(BossEvent.BossBarColor::values);
   ...
   public static enum BossBarOverlay implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(BossEvent.BossBarOverlay::values);
      private final String name;
