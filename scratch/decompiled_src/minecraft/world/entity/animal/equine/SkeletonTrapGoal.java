...
public class SkeletonTrapGoal extends Goal {
   ...
   public void tick() {
      ...
      this.horse.setAge(0);
      LightningBolt bolt = (LightningBolt)EntityTypes.LIGHTNING_BOLT.create(level, EntitySpawnReason.TRIGGERED);
      if (bolt != null) {
            ...
            for(int i = 0; i < 3; ++i) {
               ...
               if (otherHorse != null) {
                  ...
                  if (otherSkeleton != null) {
                     ...
                     otherHorse.push(this.horse.getRandom().triangle(0.0D, 1.1485D), 0.0D, this.horse.getRandom().triangle(0.0D, 1.1485D));
