...
public class GiantTrunkPlacer extends TrunkPlacer {
   ...
   private void placeLogIfFreeWithOffset(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final BlockPos.MutableBlockPos trunkPos, final TreeFeature tree, final BlockPos treePos, final int x, final int y, final int z) {
