...
public class PineFoliagePlacer extends FoliagePlacer {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> foliagePlacerParts(i).and(IntProviders.codec(0, 24).fieldOf("height").forGetter((p) -> p.height)).apply(i, PineFoliagePlacer::new));
