...
public class ShulkerBoxRenderer implements BlockEntityRenderer {
   private static final Map TRANSFORMATIONS = Util.makeEnumMap(Direction.class, ShulkerBoxRenderer::createModelTransform);
   ...
   public void getExtents(final float progress, final Consumer output) {
