...
public interface ScoreHolder {
   ...
   default Component getFeedbackDisplayName() {
      ...
      return displayName != null ? displayName.copy().withStyle((style) -> style.withHoverEvent(new HoverEvent.ShowText(Component.literal(this.getScoreboardName())))) : Component.literal(this.getScoreboardName());
   }
