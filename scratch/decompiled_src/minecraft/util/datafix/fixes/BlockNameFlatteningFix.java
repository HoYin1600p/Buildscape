...
public class BlockNameFlatteningFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type expectedBlockType = DSL.named(References.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.namespacedString()));
      Type expectedNewBlockType = DSL.named(References.BLOCK_NAME.typeName(), NamespacedSchema.namespacedString());
