...
public record ChunkPos(int x, int z) {
   public static final Codec CODEC = Codec.INT_STREAM.comapFlatMap((input) -> Util.fixedSize(input, 2).map((ints) -> new ChunkPos(ints[0], ints[1])), (pos) -> IntStream.of(new int[]{pos.x, pos.z})).stable();
