...
public record HeightRangePlacement(HeightProvider height) implements PlacementModifier {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(HeightProvider.CODEC.fieldOf("height").forGetter(HeightRangePlacement::height)).apply(i, HeightRangePlacement::new));
