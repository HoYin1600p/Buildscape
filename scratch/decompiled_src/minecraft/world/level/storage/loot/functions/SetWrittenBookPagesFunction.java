...
public class SetWrittenBookPagesFunction extends LootItemConditionalFunction {
   ...
   protected SetWrittenBookPagesFunction(final Optional condition, final List pages, final ListOperation pageOperation) {
      super(condition);
      this.pages = pages;
   ...
   public WrittenBookContent apply(final WrittenBookContent original) {
      List newPages = this.pageOperation.apply(original.pages(), this.pages);
