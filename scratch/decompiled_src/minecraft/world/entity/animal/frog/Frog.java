...
public class Frog extends Animal {
   private static final Brain.Provider BRAIN_PROVIDER = Brain.provider(List.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.HURT_BY, SensorType.FROG_ATTACKABLES, SensorType.FROG_TEMPTATIONS, SensorType.IS_IN_WATER), (var0) -> FrogAi.getActivities());
   private static final EntityDataAccessor DATA_VARIANT_ID = SynchedEntityData.defineId(Frog.class, EntityDataSerializers.FROG_VARIANT);
   private static final EntityDataAccessor DATA_TONGUE_TARGET_ID = SynchedEntityData.defineId(Frog.class, EntityDataSerializers.OPTIONAL_UNSIGNED_INT);
   private static final int FROG_FALL_DAMAGE_REDUCTION = 5;
   private static final ResourceKey DEFAULT_VARIANT = FrogVariants.TEMPERATE;
   ...
   protected void defineSynchedData(final SynchedEntityData.Builder entityData) {
      ...
      Registry variants = this.registryAccess().lookupOrThrow(Registries.FROG_VARIANT);
   ...
   public void playEatingSound() {
      this.level().playSound((Entity)null, this, SoundEvents.FROG_EAT, SoundSource.NEUTRAL, 2.0F, 1.0F);
   }

   public @Nullable AgeableMob getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      Frog frog = (Frog)EntityTypes.FROG.create(level, EntitySpawnReason.BREEDING);
      if (frog != null) {
