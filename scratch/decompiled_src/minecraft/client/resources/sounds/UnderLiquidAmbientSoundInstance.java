...
public class UnderLiquidAmbientSoundInstance extends AbstractTickableSoundInstance {
   ...
   private final Predicate isUnderLiquid;
   private int fade;

   public UnderLiquidAmbientSoundInstance(final SoundEvent event, final LocalPlayer player, final Predicate isUnderLiquid) {
