...
public class Chicken extends Animal {
   ...
   private static final EntityDataAccessor DATA_VARIANT_ID = SynchedEntityData.defineId(Chicken.class, EntityDataSerializers.CHICKEN_VARIANT);
   private static final EntityDataAccessor DATA_SOUND_VARIANT_ID = SynchedEntityData.defineId(Chicken.class, EntityDataSerializers.CHICKEN_SOUND_VARIANT);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new TemptGoal(this, 1.0D, (i) -> i.is(ItemTags.CHICKEN_FOOD), false));
   ...
   public @Nullable Chicken getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      Chicken baby = (Chicken)EntityTypes.CHICKEN.create(level, EntitySpawnReason.BREEDING);
   ...
   protected void defineSynchedData(final SynchedEntityData.Builder entityData) {
      ...
      Registry chickenSoundVariants = this.registryAccess().lookupOrThrow(Registries.CHICKEN_SOUND_VARIANT);
      entityData.define(DATA_VARIANT_ID, VariantUtils.getDefaultOrAny(this.registryAccess(), ChickenVariants.TEMPERATE));
      entityData.define(DATA_SOUND_VARIANT_ID, (Holder)chickenSoundVariants.get(ChickenSoundVariants.CLASSIC).or(chickenSoundVariants::getAny).orElseThrow());
   }
   ...
   public @Nullable Object get(final DataComponentType type) {
      if (type == DataComponents.CHICKEN_VARIANT) {
         ...
         return type == DataComponents.CHICKEN_SOUND_VARIANT ? castComponentValue(type, this.getSoundVariant()) : super.get(type);
      }
   }
