...
public class BeaconMenu extends AbstractContainerMenu {
   ...
   public boolean updateEffects(final Optional primary, final Optional secondary) {
      if (this.paymentSlot.hasItem()) {
         int levels = this.getLevels();
         Holder primaryEffect = (Holder)primary.orElse((Object)null);
         Holder secondaryEffect = (Holder)secondary.orElse((Object)null);
