...
public record BannerPatternLayers(List layers) implements TooltipProvider {
   ...
   public static final Codec CODEC = BannerPatternLayers.Layer.CODEC.listOf().xmap(BannerPatternLayers::new, BannerPatternLayers::layers);
   public static final StreamCodec STREAM_CODEC = BannerPatternLayers.Layer.STREAM_CODEC.apply(ByteBufCodecs.list()).map(BannerPatternLayers::new, BannerPatternLayers::layers);
   ...
   public static class Builder {
      ...
      /** @deprecated */
      @Deprecated
      public BannerPatternLayers.Builder addIfRegistered(final HolderGetter patternGetter, final ResourceKey patternKey, final DyeColor color) {
         Optional pattern = patternGetter.get(patternKey);
         if (pattern.isEmpty()) {
      ...
      public BannerPatternLayers.Builder add(final Holder pattern, final DyeColor color) {
   ...
   public static record Layer(Holder pattern, DyeColor color) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(BannerPattern.CODEC.fieldOf("pattern").forGetter(BannerPatternLayers.Layer::pattern), DyeColor.CODEC.fieldOf("color").forGetter(BannerPatternLayers.Layer::color)).apply(i, BannerPatternLayers.Layer::new));
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(BannerPattern.STREAM_CODEC, BannerPatternLayers.Layer::pattern, DyeColor.STREAM_CODEC, BannerPatternLayers.Layer::color, BannerPatternLayers.Layer::new);
