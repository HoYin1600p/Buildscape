...
public class AccountProfileKeyPairManager implements ProfileKeyPairManager {
   ...
   public boolean shouldRefreshKeyPair() {
      return this.keyPair.isDone() && Instant.now().isAfter(this.nextProfileKeyRefreshTime) ? ((Optional)this.keyPair.join()).map(ProfileKeyPair::dueRefresh).orElse(true) : false;
   }
