...
public class ConfirmExperimentalFeaturesScreen extends Screen {
   ...
   protected void init() {
      ...
      helper.addChild(Button.builder(DETAILS_BUTTON, (var1) -> this.minecraft.gui.setScreen(new ConfirmExperimentalFeaturesScreen.DetailsScreen())).width(100).build(), 2, centered);
   ...
   private class DetailsScreen extends Screen {
      ...
      // $FF: synthetic method
      static Font access$200(ConfirmExperimentalFeaturesScreen.DetailsScreen x0) {
         return x0.font;
      }

      private class PackList extends ObjectSelectionList {
         public PackList(final ConfirmExperimentalFeaturesScreen.DetailsScreen this$1, final Minecraft minecraft, final Collection selectedPacks) {
            Objects.requireNonNull(this$1);
            super(minecraft, this$1.width, this$1.layout.getContentHeight(), this$1.layout.getHeaderHeight(), (9 + 2) * 3);
            ...
            for(Pack pack : selectedPacks) {
               ...
               if (!nonVanillaFeatures.isEmpty()) {
                  ...
                  this.addEntry(this$1.new PackListEntry(title, message, MultiLineLabel.create(this$1.font, message, this.getRowWidth())));
               }
            }
