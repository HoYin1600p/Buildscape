...
public class FluidRenderer {
   ...
   private static boolean isFaceOccludedByState(final Direction direction, final float height, final BlockState state) {
      ...
      if (occluder == Shapes.empty()) {
         ...
         VoxelShape shape = Shapes.box(0.0D, 0.0D, 0.0D, 1.0D, (double)height, 1.0D);
   ...
   public void tesselate(final BlockAndTintGetter level, final BlockPos pos, final FluidRenderer.Output output, final BlockState blockState, final FluidState fluidState) {
