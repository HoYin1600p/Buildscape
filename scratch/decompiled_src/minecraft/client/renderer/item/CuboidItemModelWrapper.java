...
public class CuboidItemModelWrapper implements ItemModel {
   ...
   private CuboidItemModelWrapper(final List tints, final QuadCollection quads, final ModelRenderProperties properties, final Matrix4fc transformation) {
      this.tints = tints;
   ...
   private static void validateAtlasUsage(final List quads) {
      Iterator quadIterator = quads.iterator();
