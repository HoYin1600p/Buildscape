...
public class BrewingStandMenu extends AbstractContainerMenu {
   ...
   public BrewingStandMenu(final int containerId, final Inventory inventory, final Container brewingStand, final ContainerData brewingStandData) {
      ...
      this.ingredientSlot = this.addSlot(new BrewingStandMenu.IngredientsSlot(recipeAccess.propertySet(RecipePropertySet.BREWING_REAGENTS), brewingStand, 3, 79, 17));
