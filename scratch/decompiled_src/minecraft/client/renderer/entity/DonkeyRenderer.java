...
public class DonkeyRenderer extends AbstractHorseRenderer {
   ...
   public DonkeyRenderer(final EntityRendererProvider.Context context, final EquipmentClientInfo.LayerType saddleLayer, final ModelLayerLocation saddleModel, final DonkeyRenderer.Type adult, final DonkeyRenderer.Type baby) {
   ...
   public static enum Type {
      ...
      private static DonkeyRenderer.Type[] $values() {
         return new DonkeyRenderer.Type[]{DONKEY, DONKEY_BABY, MULE, MULE_BABY};
      }
   }
}
