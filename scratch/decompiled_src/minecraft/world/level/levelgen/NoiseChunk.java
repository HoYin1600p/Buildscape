...
public class NoiseChunk implements DensityFunction.FunctionContext, DensityFunction.ContextProvider {
   ...
   private Blender.BlendingOutput lastBlendingOutput = new Blender.BlendingOutput(1.0F, 0.0F);
   ...
   public NoiseChunk(final int cellCountXZ, final RandomState randomState, final int chunkMinBlockX, final int chunkMinBlockZ, final NoiseSettings noiseSettings, final @Nullable Beardifier beardifier, final NoiseGeneratorSettings settings, final Aquifer.FluidPicker globalFluidPicker, final Blender blender) {
      ...
      builder.add((NoiseChunk.BlockStateFiller)(context) -> this.aquifer.computeSubstance(context, (double)fullNoiseValue.compute(context)));
   ...
   private DensityFunction wrapNew(final DensityFunction function) {
      ...
      switch (function.typeSwitch<invokedynamic>(function, var3)) {
         case 0:
            ...
            MarkerFunction.Type var13 = var19;
            var18 = var4;
            ...
            DensityFunction var14 = var21;
            switch (var13) {
               case Interpolated:
                  return new NoiseChunk.NoiseInterpolator(var14);
               case FlatCache:
                  return new NoiseChunk.FlatCache(var14, true);
               case Cache2D:
                  return new NoiseChunk.Cache2D(var14);
               case CacheOnce:
                  return new NoiseChunk.CacheOnce(var14);
               case CacheAllInCell:
                  return new NoiseChunk.CacheAllInCell(var14);
               case BlendDensity:
                  return (DensityFunction)(!this.blender.isEmpty() ? new NoiseChunk.BlendDensity(var14) : var14);
               default:
                  throw new MatchException((String)null, (Throwable)null);
            }
         case 1:
            DensityFunctions.HolderHolder var7 = (DensityFunctions.HolderHolder)function;
            DensityFunctions.HolderHolder var15 = var7;

            try {
               var17 = var15.function();
            ...
            Holder var9 = var17;
            return (DensityFunction)var9.value();
         case 2:
            return (DensityFunction)Objects.requireNonNullElse(this.blendAlpha, function);
         case 3:
            return (DensityFunction)Objects.requireNonNullElse(this.blendOffset, function);
         case 4:
            return (DensityFunction)Objects.requireNonNullElse(this.beardifier, function);
         default:
            return function;
      }
   ...
   private class BlendDensity implements NoiseChunk.NoiseChunkDensityFunction {
   ...
   private static class Cache2D implements NoiseChunk.NoiseChunkDensityFunction {
   ...
   private class CacheAllInCell implements NoiseChunk.NoiseChunkDensityFunction {
   ...
   private class CacheOnce implements NoiseChunk.NoiseChunkDensityFunction {
      private final DensityFunction function;
      ...
      public void fillArray(final float[] output, final DensityFunction.ContextProvider contextProvider) {
         if (this.lastArray != null && this.lastArrayCounter == NoiseChunk.this.arrayInterpolationCounter) {
            ...
            if (this.lastArray != null && this.lastArray.length == output.length) {
               ...
               this.lastArray = (float[])output.clone();
            }
   ...
   private class FlatCache implements NoiseChunk.NoiseChunkDensityFunction {
      private final DensityFunction noiseFiller;
      private final float[] values;
