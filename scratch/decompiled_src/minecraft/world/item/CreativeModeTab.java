...
public class CreativeModeTab {
   ...
   private Collection displayItems = ItemStackLinkedSet.createTypeAndComponentsSet();
   private Set displayItemsSearchTab = ItemStackLinkedSet.createTypeAndComponentsSet();
   private final Supplier iconGenerator;
   private final CreativeModeTab.DisplayItemsGenerator displayItemsGenerator;

   private CreativeModeTab(final CreativeModeTab.Row row, final int column, final CreativeModeTab.Type type, final Component displayName, final Supplier iconGenerator, final CreativeModeTab.DisplayItemsGenerator displayItemsGenerator) {
      this.row = row;
      this.column = column;
   ...
   public static class Builder {
      ...
      public CreativeModeTab.Builder icon(final Supplier iconGenerator) {
         this.iconGenerator = iconGenerator;
         return this;
      }
   ...
   protected interface Output {
      ...
      default void acceptAll(final Collection stacks, final CreativeModeTab.TabVisibility tabVisibility) {
