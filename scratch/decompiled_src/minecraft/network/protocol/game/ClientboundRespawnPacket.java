...
public record ClientboundRespawnPacket(CommonPlayerSpawnInfo commonPlayerSpawnInfo, byte dataToKeep) implements Packet {
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(CommonPlayerSpawnInfo.STREAM_CODEC, ClientboundRespawnPacket::commonPlayerSpawnInfo, ByteBufCodecs.BYTE, ClientboundRespawnPacket::dataToKeep, ClientboundRespawnPacket::new);
