...
public abstract class GameTestInstance {
   public static final Codec DIRECT_CODEC = BuiltInRegistries.TEST_INSTANCE_TYPE.byNameCodec().dispatch(GameTestInstance::codec, (i) -> i);
   ...
   protected Component describeInfo() {
      return this.descriptionRow("test_instance.description.structure", this.info.structure().toString()).append(this.descriptionRow("test_instance.description.batch", ((Holder)this.info.environment()).getRegisteredName())).append(this.descriptionRow("test_instance.description.dimension", this.info.dimension().identifier().toString()));
   }
