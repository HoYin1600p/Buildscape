...
public class TransferableSelectionList extends ObjectSelectionList {
   ...
   public boolean keyPressed(final KeyEvent event) {
      return this.getSelected() != null ? ((TransferableSelectionList.Entry)this.getSelected()).keyPressed(event) : super.keyPressed(event);
   }

   public void updateList(final Stream entries, final PackSelectionModel.@Nullable EntryBase transferredEntry) {
      this.clearEntries();
      Component header = Component.empty().append(this.title).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.BOLD);
      this.addEntry(new TransferableSelectionList.HeaderEntry(this, this.minecraft.font, header), (int)(9.0F * 1.5F));
   ...
   public class HeaderEntry extends TransferableSelectionList.Entry {
      ...
      public HeaderEntry(final TransferableSelectionList this$0, final Font font, final Component text) {
