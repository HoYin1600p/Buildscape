...
public class Bootstrap {
   ...
   private static void checkTranslations(final Language language, final Iterable registry, final Function descriptionGetter, final Set output) {
      registry.forEach((t) -> {
   ...
   private static void checkGameruleTranslations(final Language language, final Set missing) {
   ...
   public static Set getMissingTranslations(final Language language) {
