...
public class HoglinAi {
   ...
   static boolean isPosNearNearestRepellent(final Hoglin body, final BlockPos pos) {
      Optional repellentPos = body.getBrain().getMemory(MemoryModuleType.NEAREST_REPELLENT);
      return repellentPos.isPresent() && ((BlockPos)repellentPos.get()).closerThan(pos, 8.0D);
   }
