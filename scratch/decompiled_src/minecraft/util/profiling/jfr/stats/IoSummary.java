...
public final class IoSummary {
   ...
   public static record CountAndSize(long totalCount, long totalSize) {
      private static final Comparator SIZE_THEN_COUNT = Comparator.comparing(IoSummary.CountAndSize::totalSize).thenComparing(IoSummary.CountAndSize::totalCount).reversed();
