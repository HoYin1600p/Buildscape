...
public class ThreadedLevelLightEngine extends LevelLightEngine implements AutoCloseable {
   ...
   public void updateSectionStatus(final SectionPos pos, final boolean sectionEmpty) {
      this.addTask(pos.x(), pos.z(), () -> 0, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name((Runnable)(() -> super.updateSectionStatus(pos, sectionEmpty)), () -> "updateSectionStatus " + String.valueOf(pos) + " " + sectionEmpty));
   }
   ...
   public void setLightEnabled(final ChunkPos pos, final boolean enable) {
      this.addTask(pos.x(), pos.z(), ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name((Runnable)(() -> super.setLightEnabled(pos, enable)), () -> "enableLight " + String.valueOf(pos) + " " + enable));
   }
