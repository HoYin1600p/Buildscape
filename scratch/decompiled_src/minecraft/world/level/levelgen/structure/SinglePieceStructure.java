...
public abstract class SinglePieceStructure extends Structure {
   ...
   protected SinglePieceStructure(final SinglePieceStructure.PieceConstructor constructor, final int width, final int depth, final Structure.StructureSettings settings) {
      super(settings);
