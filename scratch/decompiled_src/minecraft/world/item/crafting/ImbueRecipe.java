...
public class ImbueRecipe extends NormalCraftingRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Recipe.CommonInfo.STREAM_CODEC, (o) -> o.commonInfo, CraftingRecipe.CraftingBookInfo.STREAM_CODEC, (o) -> o.bookInfo, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.source, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.material, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, ImbueRecipe::new);
