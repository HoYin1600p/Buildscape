...
public class VanillaHusbandryAdvancements extends AdvancementSubProvider {
   public static final List BREEDABLE_ANIMALS = List.of(EntityTypes.HORSE, EntityTypes.DONKEY, EntityTypes.MULE, EntityTypes.SHEEP, EntityTypes.COW, EntityTypes.MOOSHROOM, EntityTypes.PIG, EntityTypes.CHICKEN, EntityTypes.WOLF, EntityTypes.OCELOT, EntityTypes.RABBIT, EntityTypes.LLAMA, EntityTypes.CAT, EntityTypes.PANDA, EntityTypes.FOX, EntityTypes.BEE, EntityTypes.HOGLIN, EntityTypes.STRIDER, EntityTypes.GOAT, EntityTypes.AXOLOTL, EntityTypes.CAMEL, EntityTypes.ARMADILLO, EntityTypes.NAUTILUS);
   public static final List INDIRECTLY_BREEDABLE_ANIMALS = List.of(EntityTypes.TURTLE, EntityTypes.FROG, EntityTypes.SNIFFER);
   ...
   private static final Comparator HOLDER_KEY_COMPARATOR = Comparator.comparing((e) -> e.key().identifier());
   private final HolderGetter entityTypes;
   private final HolderGetter items;
   private final HolderGetter blocks;
   private final HolderGetter enchantments;

   public VanillaHusbandryAdvancements(final BootstrapContext output) {
      super(output);
   ...
   public void generate() {
      ...
      this.addFood(Advancement.Builder.advancement()).parent(plantSeed).display(Items.APPLE, Component.translatable("advancements.husbandry.balanced_diet.title"), Component.translatable("advancements.husbandry.balanced_diet.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).save(this.output, "husbandry/balanced_diet");
      ...
      AdvancementHolder tameAnAnimal = Advancement.Builder.advancement().parent(root).display(Items.LEAD, Component.translatable("advancements.husbandry.tame_an_animal.title"), Component.translatable("advancements.husbandry.tame_an_animal.description"), (Identifier)null, AdvancementType.TASK, true, true, false).addCriterion("tamed_animal", TameAnimalTrigger.TriggerInstance.tamedAnimal()).save(this.output, "husbandry/tame_an_animal");
      AdvancementHolder fishyBusiness = this.addFish(Advancement.Builder.advancement()).parent(root).requirements(AdvancementRequirements.Strategy.OR).display(Items.FISHING_ROD, Component.translatable("advancements.husbandry.fishy_business.title"), Component.translatable("advancements.husbandry.fishy_business.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/fishy_business");
      AdvancementHolder tacticalFishing = this.addFishBuckets(Advancement.Builder.advancement()).parent(fishyBusiness).requirements(AdvancementRequirements.Strategy.OR).display(Items.PUFFERFISH_BUCKET, Component.translatable("advancements.husbandry.tactical_fishing.title"), Component.translatable("advancements.husbandry.tactical_fishing.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/tactical_fishing");
      AdvancementHolder theCutestPredetor = Advancement.Builder.advancement().parent(tacticalFishing).requirements(AdvancementRequirements.Strategy.OR).addCriterion(BuiltInRegistries.ITEM.getKey(Items.AXOLOTL_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(this.items, Items.AXOLOTL_BUCKET))).display(Items.AXOLOTL_BUCKET, Component.translatable("advancements.husbandry.axolotl_in_a_bucket.title"), Component.translatable("advancements.husbandry.axolotl_in_a_bucket.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/axolotl_in_a_bucket");
      ...
      this.addCatVariants(Advancement.Builder.advancement()).parent(tameAnAnimal).display(Items.COD, Component.translatable("advancements.husbandry.complete_catalogue.title"), Component.translatable("advancements.husbandry.complete_catalogue.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(this.output, "husbandry/complete_catalogue");
      this.addTamedWolfVariants(Advancement.Builder.advancement()).parent(tameAnAnimal).display(Items.BONE, Component.translatable("advancements.husbandry.whole_pack.title"), Component.translatable("advancements.husbandry.whole_pack.description"), (Identifier)null, AdvancementType.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).save(this.output, "husbandry/whole_pack");
      AdvancementHolder safelyHarvestHoney = Advancement.Builder.advancement().parent(root).addCriterion("safely_harvest_honey", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(this.blocks, BlockTags.BEEHIVES)).setSmokey(true), ItemPredicate.Builder.item().of(this.items, Items.GLASS_BOTTLE))).display(Items.HONEY_BOTTLE, Component.translatable("advancements.husbandry.safely_harvest_honey.title"), Component.translatable("advancements.husbandry.safely_harvest_honey.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/safely_harvest_honey");
      AdvancementHolder waxOn = Advancement.Builder.advancement().parent(safelyHarvestHoney).display(Items.HONEYCOMB, Component.translatable("advancements.husbandry.wax_on.title"), Component.translatable("advancements.husbandry.wax_on.description"), (Identifier)null, AdvancementType.TASK, true, true, false).addCriterion("wax_on", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(this.blocks, ((BiMap)HoneycombItem.WAXABLES.get()).keySet())), ItemPredicate.Builder.item().of(this.items, Items.HONEYCOMB))).save(this.output, "husbandry/wax_on");
      Advancement.Builder.advancement().parent(waxOn).display(Items.STONE_AXE, Component.translatable("advancements.husbandry.wax_off.title"), Component.translatable("advancements.husbandry.wax_off.description"), (Identifier)null, AdvancementType.TASK, true, true, false).addCriterion("wax_off", ItemUsedOnLocationTrigger.TriggerInstance.itemUsedOnBlock(LocationPredicate.Builder.location().setBlock(BlockPredicate.Builder.block().of(this.blocks, ((BiMap)HoneycombItem.WAX_OFF_BY_BLOCK.get()).keySet())), ItemPredicate.Builder.item().of(this.items, WAX_SCRAPING_TOOLS))).save(this.output, "husbandry/wax_off");
      AdvancementHolder tadpoleInABucket = Advancement.Builder.advancement().parent(root).addCriterion(BuiltInRegistries.ITEM.getKey(Items.TADPOLE_BUCKET).getPath(), FilledBucketTrigger.TriggerInstance.filledBucket(ItemPredicate.Builder.item().of(this.items, Items.TADPOLE_BUCKET))).display(Items.TADPOLE_BUCKET, Component.translatable("advancements.husbandry.tadpole_in_a_bucket.title"), Component.translatable("advancements.husbandry.tadpole_in_a_bucket.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/tadpole_in_a_bucket");
      AdvancementHolder allFrogsOnALeash = this.addLeashedFrogVariants(Advancement.Builder.advancement()).parent(tadpoleInABucket).display(Items.LEAD, Component.translatable("advancements.husbandry.leash_all_frog_variants.title"), Component.translatable("advancements.husbandry.leash_all_frog_variants.description"), (Identifier)null, AdvancementType.TASK, true, true, false).save(this.output, "husbandry/leash_all_frog_variants");
   ...
   private Stream sortedVariants(final ResourceKey registryKey) {
   ...
   private Advancement.Builder addBreedable(final Advancement.Builder advancement, final Stream breedable, final Stream indirectlyBreedable) {
