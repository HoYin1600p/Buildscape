...
public class StructureTemplatePool {
   ...
   public static final Codec CODEC = (Codec)Util.make(RegistryCodecs.holder(Registries.TEMPLATE_POOL, DIRECT_CODEC), CODEC_REFERENCE::setValue);
   ...
   public StructureTemplatePool(final Holder fallback, final List templates, final StructureTemplatePool.Projection projection) {
   ...
   public static enum Projection implements StringRepresentable {
      ...
      public static final StringRepresentable.EnumCodec CODEC = StringRepresentable.fromEnum(StructureTemplatePool.Projection::values);
