...
public class ShapelessRecipe extends NormalCraftingRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Recipe.CommonInfo.STREAM_CODEC, (o) -> o.commonInfo, CraftingRecipe.CraftingBookInfo.STREAM_CODEC, (o) -> o.bookInfo, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, Ingredient.CONTENTS_STREAM_CODEC.apply(ByteBufCodecs.list()), (o) -> o.ingredients, ShapelessRecipe::new);
