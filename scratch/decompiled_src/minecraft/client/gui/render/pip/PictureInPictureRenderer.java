...
public abstract class PictureInPictureRenderer implements AutoCloseable {
   ...
   public void prepare(final PictureInPictureRenderState renderState, final GuiRenderState guiRenderState, final FeatureRenderDispatcher featureRenderDispatcher, final int guiScale) {
   ...
   protected abstract void renderToTexture(PictureInPictureRenderState renderState, PoseStack poseStack, SubmitNodeCollector submitNodeCollector);
