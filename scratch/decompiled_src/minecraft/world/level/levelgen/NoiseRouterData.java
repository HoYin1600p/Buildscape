...
public class NoiseRouterData {
   ...
   private static final ResourceKey ORE_VEIN_MASK = createKey("overworld/ore_vein/mask");
   private static final ResourceKey ORE_VEIN_TOGGLE = createKey("overworld/ore_vein/toggle");
   private static final ResourceKey ORE_VEIN_RICHNESS = createKey("overworld/ore_vein/richness");
   private static final ResourceKey ORE_VEIN_COPPER_DENSITY = createKey("overworld/ore_vein/copper_density");
   private static final ResourceKey ORE_VEIN_IRON_DENSITY = createKey("overworld/ore_vein/iron_density");
   private static final ResourceKey ORE_VEIN_GAP = createKey("overworld/ore_vein/gap");
   ...
   public static Holder bootstrap(final BootstrapContext context) {
      ...
      context.register(BASE_3D_NOISE_OVERWORLD, new BlendedNoise(0.25D, 0.125D, 80.0D, 160.0D, 8.0D));
      context.register(BASE_3D_NOISE_NETHER, new BlendedNoise(0.25D, 0.375D, 80.0D, 60.0D, 8.0D));
      context.register(BASE_3D_NOISE_END, new BlendedNoise(0.25D, 0.25D, 80.0D, 160.0D, 4.0D));
      registerAndWrap(context, (ResourceKey)OVERWORLD_FUNCTIONS.temperature(), DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.TEMPERATURE)));
      registerAndWrap(context, (ResourceKey)LARGE_OVERWORLD_FUNCTIONS.temperature(), DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.TEMPERATURE_LARGE)));
      registerAndWrap(context, (ResourceKey)OVERWORLD_FUNCTIONS.vegetation(), DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.VEGETATION)));
      registerAndWrap(context, (ResourceKey)LARGE_OVERWORLD_FUNCTIONS.vegetation(), DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.VEGETATION_LARGE)));
      DensityFunction continents = registerAndWrap(context, (ResourceKey)OVERWORLD_FUNCTIONS.continents(), DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.CONTINENTALNESS))));
      DensityFunction erosion = registerAndWrap(context, (ResourceKey)OVERWORLD_FUNCTIONS.erosion(), DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.EROSION))));
      DensityFunction ridge = registerAndWrap(context, RIDGES, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.RIDGE))));
      context.register(RIDGES_FOLDED, peaksAndValleys(ridge));
      DensityFunction jaggedNoise = DensityFunctions.noise(noises.getOrThrow(Noises.JAGGED), 1500.0D, 0.0D);
      registerTerrainNoises(context, functions, noises, jaggedNoise, continents, erosion, OVERWORLD_FUNCTIONS, false);
      DensityFunction continentsLarge = registerAndWrap(context, (ResourceKey)LARGE_OVERWORLD_FUNCTIONS.continents(), DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.CONTINENTALNESS_LARGE))));
      DensityFunction erosionLarge = registerAndWrap(context, (ResourceKey)LARGE_OVERWORLD_FUNCTIONS.erosion(), DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(shiftX, shiftZ, 0.25D, noises.getOrThrow(Noises.EROSION_LARGE))));
      ...
      context.register(SPAGHETTI_2D_THICKNESS_MODULATOR, DensityFunctions.cacheOnce(DensityFunctions.mappedNoise(noises.getOrThrow(Noises.SPAGHETTI_2D_THICKNESS), 2.0D, 1.0D, -0.6F, -1.3F)));
   ...
   private static void registerTerrainNoises(final BootstrapContext context, final HolderGetter functions, final HolderGetter noises, final DensityFunction jaggedNoise, final DensityFunction continentsFunction, final DensityFunction erosionFunction, final OverworldFunctionSet names, final boolean amplified) {
      ...
      DensityFunction offset = registerAndWrap(context, (ResourceKey)names.offset(), splineWithBlending(DensityFunctions.add(DensityFunctions.constant(-0.50375F), DensityFunctions.spline(TerrainProvider.overworldOffset(continents, erosion, ridges, amplified))), DensityFunctions.blendOffset()));
      DensityFunction factor = registerAndWrap(context, (ResourceKey)names.factor(), splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(continents, erosion, weirdness, ridges, amplified)), BLENDING_FACTOR));
      DensityFunction depth = registerAndWrap(context, (ResourceKey)names.depth(), offsetToDepth(offset));
      DensityFunction unscaledJaggedness = registerAndWrap(context, (ResourceKey)names.jaggedness(), splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(continents, erosion, weirdness, ridges, amplified)), BLENDING_JAGGEDNESS));
      ...
      DensityFunction slopedCheese = registerAndWrap(context, (ResourceKey)names.slopedCheese(), DensityFunctions.cacheOnce(DensityFunctions.add(initialDensity, getFunction(functions, BASE_3D_NOISE_OVERWORLD))));
      context.register((ResourceKey)names.preliminarySurfaceLevel(), preliminarySurfaceLevel(offset, factor, amplified));
      ...
      context.register((ResourceKey)names.finalDensity(), DensityFunctions.add(DensityFunctions.min(postProcess(slideOverworld(amplified, caves)), getFunction(functions, NOODLE)), DensityFunctions.beardifier()));
   }
   ...
   private static DensityFunction entrances(final HolderGetter functions, final HolderGetter noises) {
      DensityFunction spaghetti3DRarityModulator = DensityFunctions.cacheOnce(DensityFunctions.noise(noises.getOrThrow(Noises.SPAGHETTI_3D_RARITY), 2.0D, 1.0D));
      ...
      DensityFunction bigEntranceNoiseSource = DensityFunctions.noise(noises.getOrThrow(Noises.CAVE_ENTRANCE), 0.75D, 0.5D);
   ...
   private static DensityFunction noodle(final HolderGetter functions, final HolderGetter noises) {
      ...
      int noodleMinY = -60;
      int noodleMaxY = 320;
      DensityFunction noodleToggle = yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.NOODLE), 1.0D, 1.0D), -60, 320, -1);
      DensityFunction noodleThickness = yLimitedInterpolatable(y, DensityFunctions.mappedNoise(noises.getOrThrow(Noises.NOODLE_THICKNESS), 1.0D, 1.0D, -0.05F, -0.1F), -60, 320, 0);
      double noodleRidgeFrequency = 2.6666666666666665D;
      DensityFunction noodleRidgeA = yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.NOODLE_RIDGE_A), 2.6666666666666665D, 2.6666666666666665D), -60, 320, 0);
      DensityFunction noodleRidgeB = yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.NOODLE_RIDGE_B), 2.6666666666666665D, 2.6666666666666665D), -60, 320, 0);
   ...
   private static DensityFunction pillars(final HolderGetter noises) {
      double xzFrequency = 25.0D;
      double yFrequency = 0.3D;
      DensityFunction pillarNoiseSource = DensityFunctions.noise(noises.getOrThrow(Noises.PILLAR), 25.0D, 0.3D);
   ...
   private static DensityFunction spaghetti2D(final HolderGetter functions, final HolderGetter noises) {
      DensityFunction spaghetti2DRarityModulator = DensityFunctions.noise(noises.getOrThrow(Noises.SPAGHETTI_2D_MODULATOR), 2.0D, 1.0D);
      ...
      DensityFunction spaghetti2DElevationModulator = DensityFunctions.mappedNoise(noises.getOrThrow(Noises.SPAGHETTI_2D_ELEVATION), 0.0D, (float)Math.floorDiv(-64, 8), 8.0F);
   ...
   private static DensityFunction underground(final HolderGetter functions, final HolderGetter noises, final DensityFunction slopedCheese) {
      ...
      DensityFunction spaghettiRoughnessFunction = getFunction(functions, SPAGHETTI_ROUGHNESS_FUNCTION);
      DensityFunction layerNoiseSource = DensityFunctions.noise(noises.getOrThrow(Noises.CAVE_LAYER), 8.0D);
      DensityFunction layerizedCavernsFunction = layerNoiseSource.square().mul(4.0F);
      DensityFunction cheese = DensityFunctions.noise(noises.getOrThrow(Noises.CAVE_CHEESE), 0.6666666666666666D);
   ...
   protected static NoiseRouter overworld(final HolderGetter functions, final OverworldFunctionSet functionNames) {
      OverworldFunctionSet functionSet = functionNames.map((key) -> getFunction(functions, key));
      return new NoiseRouter((DensityFunction)functionSet.temperature(), (DensityFunction)functionSet.vegetation(), (DensityFunction)functionSet.continents(), (DensityFunction)functionSet.erosion(), (DensityFunction)functionSet.depth(), getFunction(functions, RIDGES), (DensityFunction)functionSet.preliminarySurfaceLevel(), (DensityFunction)functionSet.finalDensity());
   }

   protected static Aquifer.Config overworldAquifers(final HolderGetter functions, final HolderGetter noises, final OverworldFunctionSet names) {
      DensityFunction barrierNoise = DensityFunctions.noise(noises.getOrThrow(Noises.AQUIFER_BARRIER), 0.5D);
      DensityFunction fluidLevelFloodednessNoise = DensityFunctions.noise(noises.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_FLOODEDNESS), 0.67D);
      DensityFunction fluidLevelSpreadNoise = DensityFunctions.noise(noises.getOrThrow(Noises.AQUIFER_FLUID_LEVEL_SPREAD), 0.7142857142857143D);
      DensityFunction lavaNoise = DensityFunctions.noise(noises.getOrThrow(Noises.AQUIFER_LAVA));
      DensityFunction exclusion = OverworldBiomeBuilder.deepDarkRegion(getFunction(functions, (ResourceKey)names.erosion()), getFunction(functions, (ResourceKey)names.depth()));
      return new Aquifer.Config(barrierNoise, fluidLevelFloodednessNoise, fluidLevelSpreadNoise, lavaNoise, exclusion, getFunction(functions, (ResourceKey)names.preliminarySurfaceLevel()));
   }

   private static void registerOreVeins(final BootstrapContext context) {
      HolderGetter functions = context.lookup(Registries.DENSITY_FUNCTION);
      HolderGetter noises = context.lookup(Registries.NOISE);
      DensityFunction y = getFunction(functions, Y);
      ...
      DensityFunction veinToggle = registerAndWrap(context, ORE_VEIN_TOGGLE, yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.ORE_VEININESS), 1.5D, 1.5D), interpolatedVeinMinY, interpolatedVeinMaxY, 0));
   ...
   protected static List overworldOreVeins(final HolderGetter functions) {
   ...
   private static DensityFunction createBaseOreVeinMask(final HolderGetter noises, final DensityFunction y, final DensityFunction toggle, final int minY, final int maxY) {
      float oreRidgeFrequency = 4.0F;
      int noVein = 1;
      DensityFunction veinA = yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.ORE_VEIN_A), 4.0D, 4.0D), minY, maxY, 1).abs();
      DensityFunction veinB = yLimitedInterpolatable(y, DensityFunctions.noise(noises.getOrThrow(Noises.ORE_VEIN_B), 4.0D, 4.0D), minY, maxY, 1).abs();
   ...
   protected static NoiseRouter nether(final HolderGetter functions, final HolderGetter noises) {
      DensityFunction temperature = DensityFunctions.shiftedNoise2d(DensityFunctions.zero(), DensityFunctions.zero(), 0.25D, noises.getOrThrow(Noises.TEMPERATURE_NETHER));
      DensityFunction vegetation = DensityFunctions.shiftedNoise2d(DensityFunctions.zero(), DensityFunctions.zero(), 0.25D, noises.getOrThrow(Noises.VEGETATION_NETHER));
   ...
   protected static NoiseRouter caves(final HolderGetter functions) {
   ...
   protected static final class QuantizedSpaghettiRarity {
      public static DensityFunction wrapRarity2d(final DensityFunction input, final Holder noise) {
      ...
      public static DensityFunction wrapRarity3d(final DensityFunction input, final Holder noise) {
      ...
      private static DensityFunction noiseFunctionForRarity(final Holder noise, final float rarity) {
         return DensityFunctions.noise(noise, 1.0D / (double)rarity, 1.0D / (double)rarity).mul(rarity);
      }
   }
}
