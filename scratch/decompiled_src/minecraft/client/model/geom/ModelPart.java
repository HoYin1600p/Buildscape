...
public final class ModelPart {
   ...
   public static record Polygon(ModelPart.Vertex[] vertices, Vector3fc normal) {
      public Polygon(final ModelPart.Vertex[] vertices, final float u0, final float v0, final float u1, final float v1, final float xTexSize, final float yTexSize, final boolean mirror, final Direction facing) {
