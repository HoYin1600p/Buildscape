...
public class Octree {
   ...
   private class Branch implements Octree.Node {
      ...
      private static int getNodeIndex(final Octree.AxisSorting sorting, final boolean xDiffsOppositeSides, final boolean yDiffsOppositeSides, final boolean zDiffsOppositeSides) {
         int index = 0;
      ...
      public void visitNodes(final Octree.OctreeVisitor visitor, boolean skipFrustumCheck, final Frustum frustum, final int depth, final int closeDistance, boolean isClose) {
   ...
   private final class Leaf implements Octree.Node {
      ...
      public void visitNodes(final Octree.OctreeVisitor visitor, final boolean skipFrustumCheck, final Frustum frustum, final int depth, final int closeDistance, boolean isClose) {
