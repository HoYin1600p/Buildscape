...
public class SetSpawnCommand {
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_SET = CommandResponseTracker.messages((player, var1, respawnData) -> Component.translatable("commands.spawnpoint.success.single", respawnData.pos().getX(), respawnData.pos().getY(), respawnData.pos().getZ(), respawnData.yaw(), respawnData.pitch(), Component.translationArg(respawnData.dimension().identifier()), player.getDisplayName()), (playerCount, var1, respawnData) -> Component.translatable("commands.spawnpoint.success.multiple", respawnData.pos().getX(), respawnData.pos().getY(), respawnData.pos().getZ(), respawnData.yaw(), respawnData.pitch(), Component.translationArg(respawnData.dimension().identifier()), playerCount));
   ...
   private static int setSpawn(final CommandSourceStack source, final Collection targets, final BlockPos pos, final Coordinates rotation) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      ResourceKey dimension = source.getLevel().dimension();
