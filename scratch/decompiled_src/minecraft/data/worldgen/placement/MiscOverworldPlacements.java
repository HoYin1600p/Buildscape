...
public class MiscOverworldPlacements {
   ...
   public static final ResourceKey SULFUR_POOL = PlacementUtils.createKey("sulfur_pool");
   ...
   public static void bootstrap(final BootstrapContext context) {
      ...
      Holder iceSpike = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICE_SPIKE);
      Holder icePatch = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICE_PATCH);
      Holder forestRock = configuredFeatures.getOrThrow(MiscOverworldFeatures.FOREST_ROCK);
      Holder icebergPacked = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICEBERG_PACKED);
      Holder icebergBlue = configuredFeatures.getOrThrow(MiscOverworldFeatures.ICEBERG_BLUE);
      Holder blueIce = configuredFeatures.getOrThrow(MiscOverworldFeatures.BLUE_ICE);
      Holder lakeLava = configuredFeatures.getOrThrow(MiscOverworldFeatures.LAKE_LAVA);
      Holder sulfurPool = configuredFeatures.getOrThrow(MiscOverworldFeatures.SULFUR_POOL);
      Holder diskClay = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_CLAY);
      Holder diskGravel = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_GRAVEL);
      Holder diskSand = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_SAND);
      Holder diskGrass = configuredFeatures.getOrThrow(MiscOverworldFeatures.DISK_GRASS);
      Holder freezeTopLayer = configuredFeatures.getOrThrow(MiscOverworldFeatures.FREEZE_TOP_LAYER);
      Holder voidStartPlatform = configuredFeatures.getOrThrow(MiscOverworldFeatures.VOID_START_PLATFORM);
      Holder desertWell = configuredFeatures.getOrThrow(MiscOverworldFeatures.DESERT_WELL);
      Holder springLavaOverworld = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_LAVA_OVERWORLD);
      Holder springLavaFrozen = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_LAVA_FROZEN);
      Holder springWater = configuredFeatures.getOrThrow(MiscOverworldFeatures.SPRING_WATER);
