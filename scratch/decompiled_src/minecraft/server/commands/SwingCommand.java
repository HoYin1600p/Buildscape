...
public class SwingCommand {
   ...
   private static final CommandResponseTracker.Messages RESPONSE_SWING = CommandResponseTracker.messages(ERROR_NO_LIVING_ENTITY, (entity, var1) -> Component.translatable("commands.swing.success.single", entity.getDisplayName()), (entityCount, var1) -> Component.translatable("commands.swing.success.multiple", entityCount));
   ...
   private static LiteralArgumentBuilder handSwing(final String name, final InteractionHand hand) {
   ...
   private static int swing(final CommandSourceStack source, final Collection targets, final InteractionHand hand, final SwingAnimationType animationType, final int duration) throws CommandSyntaxException {
