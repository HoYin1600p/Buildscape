...
public class EndPlacements {
   ...
   public static void bootstrap(final BootstrapContext context) {
      ...
      Holder endPlatform = configuredFeatures.getOrThrow(EndFeatures.END_PLATFORM);
      Holder endSpike = configuredFeatures.getOrThrow(EndFeatures.END_SPIKE);
      Holder endGatewayReturn = configuredFeatures.getOrThrow(EndFeatures.END_GATEWAY_RETURN);
      Holder chorusPlant = configuredFeatures.getOrThrow(EndFeatures.CHORUS_PLANT);
      Holder endIsland = configuredFeatures.getOrThrow(EndFeatures.END_ISLAND);
