...
public class DiscoveryService {
   public static DiscoveryService.DiscoverResponse discover(final List schemaRegistry) {
      List methods = new ArrayList(BuiltInRegistries.INCOMING_RPC_METHOD.size() + BuiltInRegistries.OUTGOING_RPC_METHOD.size());
   ...
   public static record DiscoverComponents(Map schemas) {
      ...
      private static MapCodec typedSchema() {
         return RecordCodecBuilder.mapCodec((i) -> i.group(Codec.unboundedMap(Codec.STRING, Schema.CODEC).fieldOf("schemas").forGetter(DiscoveryService.DiscoverComponents::schemas)).apply(i, DiscoveryService.DiscoverComponents::new));
      }
   }

   public static record DiscoverInfo(String title, String version) {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Codec.STRING.fieldOf("title").forGetter(DiscoveryService.DiscoverInfo::title), Codec.STRING.fieldOf("version").forGetter(DiscoveryService.DiscoverInfo::version)).apply(i, DiscoveryService.DiscoverInfo::new));
   }

   public static record DiscoverResponse(String jsonRpcProtocolVersion, DiscoveryService.DiscoverInfo discoverInfo, List methods, DiscoveryService.DiscoverComponents components) {
