...
public class HexColorArgument implements ArgumentType {
   ...
   public Integer parse(final StringReader reader) throws CommandSyntaxException {
      ...
      switch (colorString.length()) {
         case 3:
            var10000 = ARGB.color(duplicateDigit(Integer.parseInt(colorString, 0, 1, 16)), duplicateDigit(Integer.parseInt(colorString, 1, 2, 16)), duplicateDigit(Integer.parseInt(colorString, 2, 3, 16)));
            break;
         case 6:
            var10000 = ARGB.color(Integer.parseInt(colorString, 0, 2, 16), Integer.parseInt(colorString, 2, 4, 16), Integer.parseInt(colorString, 4, 6, 16));
            break;
         default:
            throw ERROR_INVALID_HEX.createWithContext(reader, colorString);
      }
