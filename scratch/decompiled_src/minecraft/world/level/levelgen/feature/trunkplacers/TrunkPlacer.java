...
public abstract class TrunkPlacer {
   public static final Codec CODEC = BuiltInRegistries.TRUNK_PLACER_TYPE.byNameCodec().dispatch(TrunkPlacer::type, TrunkPlacerType::codec);
   ...
   public abstract List placeTrunk(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final int treeHeight, final BlockPos origin, final TreeFeature tree);
   ...
   protected static void placeBelowTrunkBlock(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final BlockPos pos, final TreeFeature tree) {
   ...
   protected boolean placeLog(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final BlockPos pos, final TreeFeature tree) {
      return this.placeLog(level, trunkSetter, random, pos, tree, Function.identity());
   }

   protected boolean placeLog(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final BlockPos pos, final TreeFeature tree, final Function stateModifier) {
   ...
   protected void placeLogIfFree(final WorldGenLevel level, final BiConsumer trunkSetter, final RandomSource random, final BlockPos.MutableBlockPos pos, final TreeFeature tree) {
