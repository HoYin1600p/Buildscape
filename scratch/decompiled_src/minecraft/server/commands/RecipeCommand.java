...
public class RecipeCommand {
   ...
   private static final Predicate LEARNABLE_RECIPE = (r) -> !r.isSpecial();
   private static final CommandResponseTracker.Messages RESPONSE_GIVE = CommandResponseTracker.messages(ERROR_GIVE_FAILED, (player, totalValue) -> Component.translatable("commands.recipe.give.success.single", totalValue, player.getDisplayName()), (playerCount, totalValue) -> Component.translatable("commands.recipe.give.success.multiple", totalValue, playerCount));
   private static final CommandResponseTracker.Messages RESPONSE_TAKE = CommandResponseTracker.messages(ERROR_TAKE_FAILED::create, (player, totalValue) -> Component.translatable("commands.recipe.take.success.single", totalValue, player.getDisplayName()), (playerCount, totalValue) -> Component.translatable("commands.recipe.take.success.multiple", totalValue, playerCount));
