...
public class ChatReportScreen extends AbstractReportScreen {
   ...
   protected void addContent() {
      this.selectMessagesButton = (Button)this.layout.addChild(Button.builder(SELECT_CHAT_MESSAGE, (b) -> this.minecraft.gui.setScreen(new ChatSelectionScreen(this, this.reportingContext, (ChatReport.Builder)this.reportBuilder, (updatedReport) -> {
