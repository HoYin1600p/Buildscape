...
public class FriendsOverlayScreen extends Screen {
   ...
   private final Set pendingFriendRemovals = new HashSet();
   ...
   private void populateLists(final PlayerSocialManager playerSocialManager) {
      List friends = playerSocialManager.getFriends();
      List incomingRequests = playerSocialManager.getIncomingRequests();
      List outgoingRequests = playerSocialManager.getOutgoingRequests();
      ...
      if (friends.isEmpty()) {
         ...
         List entries = new ArrayList(friends.size());
      ...
      if (totalRequestsCount == 0) {
         ...
         List incomingEntries = new ArrayList(incomingRequests.size());
         ...
         List outgoingEntries = new ArrayList(outgoingRequests.size());
