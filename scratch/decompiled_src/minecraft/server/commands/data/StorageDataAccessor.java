...
public class StorageDataAccessor implements DataAccessor {
   ...
   public static final ArgProvider.Factory PROVIDER = (arg) -> ArgProvider.create("storage", () -> Commands.argument(arg, IdentifierArgument.id()).suggests(SUGGEST_STORAGE), (c) -> new StorageDataAccessor(getGlobalTags(c), IdentifierArgument.getId(c, arg)));
