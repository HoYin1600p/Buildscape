...
public class UnconfiguredPipelineHandler {
   public static UnconfiguredPipelineHandler.InboundConfigurationTask setupInboundProtocol(final ProtocolInfo protocolInfo) {
   ...
   public static UnconfiguredPipelineHandler.OutboundConfigurationTask setupOutboundProtocol(final ProtocolInfo codecData) {
