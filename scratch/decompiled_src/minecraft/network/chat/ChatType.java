...
public record ChatType(ChatTypeDecoration chat, ChatTypeDecoration narration) {
   ...
   public static final StreamCodec DIRECT_STREAM_CODEC = StreamCodec.composite(ChatTypeDecoration.STREAM_CODEC, ChatType::chat, ChatTypeDecoration.STREAM_CODEC, ChatType::narration, ChatType::new);
   public static final StreamCodec STREAM_CODEC = ByteBufCodecs.holder(Registries.CHAT_TYPE, DIRECT_STREAM_CODEC);
   public static final ChatTypeDecoration DEFAULT_CHAT_DECORATION = ChatTypeDecoration.withSender("chat.type.text");
   public static final ResourceKey CHAT = create("chat");
   public static final ResourceKey SAY_COMMAND = create("say_command");
   public static final ResourceKey MSG_COMMAND_INCOMING = create("msg_command_incoming");
   public static final ResourceKey MSG_COMMAND_OUTGOING = create("msg_command_outgoing");
   public static final ResourceKey TEAM_MSG_COMMAND_INCOMING = create("team_msg_command_incoming");
   public static final ResourceKey TEAM_MSG_COMMAND_OUTGOING = create("team_msg_command_outgoing");
   public static final ResourceKey EMOTE_COMMAND = create("emote_command");
   ...
   public static ChatType.Bound bind(final ResourceKey chatType, final Entity entity) {
      return bind(chatType, entity.level().registryAccess(), entity.getDisplayName());
   }

   public static ChatType.Bound bind(final ResourceKey chatType, final CommandSourceStack source) {
      return bind(chatType, source.registryAccess(), source.getDisplayName());
   }

   public static ChatType.Bound bind(final ResourceKey chatType, final RegistryAccess registryAccess, final Component name) {
      Registry registry = registryAccess.lookupOrThrow(Registries.CHAT_TYPE);
   ...
   public static record Bound(Holder chatType, Component name, Optional targetName) {
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ChatType.STREAM_CODEC, ChatType.Bound::chatType, ComponentSerialization.TRUSTED_STREAM_CODEC, ChatType.Bound::name, ComponentSerialization.TRUSTED_OPTIONAL_STREAM_CODEC, ChatType.Bound::targetName, ChatType.Bound::new);
