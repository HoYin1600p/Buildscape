   ...
   private void findNewTarget(final ServerLevel level) {
      if (this.currentPath != null && this.currentPath.isDone()) {
         ...
         if (playerNearestToEgg != null) {
            distSqr = egg.distToCenterSqr(playerNearestToEgg.position()) / 512.0D;
         } else {
            distSqr = 64.0D;
         }

         if (playerNearestToEgg != null && (this.dragon.getRandom().nextInt((int)(distSqr + 2.0D)) == 0 || this.dragon.getRandom().nextInt(crystals + 2) == 0)) {
