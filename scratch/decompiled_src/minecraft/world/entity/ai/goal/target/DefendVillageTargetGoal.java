...
public class DefendVillageTargetGoal extends TargetGoal {
   ...
   public boolean canUse() {
      AABB grow = this.golem.getBoundingBox().inflate(10.0D, 8.0D, 10.0D);
      ServerLevel level = getServerLevel(this.golem);
      List villagers = level.getNearbyEntities(Villager.class, this.attackTargeting, this.golem, grow);
      List players = level.getNearbyPlayers(this.attackTargeting, this.golem, grow);
