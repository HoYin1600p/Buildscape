...
public class Ocelot extends Animal {
   ...
   private Ocelot.@Nullable OcelotAvoidEntityGoal ocelotAvoidPlayersGoal;
   ...
   protected void registerGoals() {
      this.temptGoal = new Ocelot.OcelotTemptGoal(this, 0.6D, (i) -> i.is(ItemTags.OCELOT_FOOD), true);
   ...
   public @Nullable Ocelot getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      return (Ocelot)EntityTypes.OCELOT.create(level, EntitySpawnReason.BREEDING);
   }
