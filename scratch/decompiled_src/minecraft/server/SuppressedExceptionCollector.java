...
public class SuppressedExceptionCollector {
   ...
   public synchronized String dump() {
      ...
      if (!this.entryCounts.isEmpty()) {
         ...
         while(var6.hasNext()) {
            Object2IntMap.Entry e = (Object2IntMap.Entry)var6.next();
            result.append("\t\t\t").append(((SuppressedExceptionCollector.ShortEntry)e.getKey()).location).append(":").append(((SuppressedExceptionCollector.ShortEntry)e.getKey()).cls).append(" x ").append(e.getIntValue()).append("\n");
         }
      }
