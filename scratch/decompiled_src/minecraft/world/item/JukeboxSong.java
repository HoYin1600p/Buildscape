...
public record JukeboxSong(Holder soundEvent, Component description, float lengthInSeconds, int comparatorOutput) {
   ...
   public static final StreamCodec DIRECT_STREAM_CODEC = StreamCodec.composite(SoundEvent.STREAM_CODEC, JukeboxSong::soundEvent, ComponentSerialization.STREAM_CODEC, JukeboxSong::description, ByteBufCodecs.FLOAT, JukeboxSong::lengthInSeconds, ByteBufCodecs.VAR_INT, JukeboxSong::comparatorOutput, JukeboxSong::new);
   public static final Codec CODEC = RegistryCodecs.holder(Registries.JUKEBOX_SONG);
   public static final StreamCodec STREAM_CODEC = ByteBufCodecs.holder(Registries.JUKEBOX_SONG, DIRECT_STREAM_CODEC);
