...
public interface EnvironmentAttributes {
   ...
   EnvironmentAttribute STRAW_BED_RULE = register("gameplay/straw_bed_rule", EnvironmentAttribute.builder(AttributeTypes.BED_RULE).defaultValue(BedRule.DESTROY_ON_LEAVE));
   ...
   EnvironmentAttribute NATURAL_MOB_SPAWNS = register("gameplay/natural_mob_spawns", EnvironmentAttribute.builder(AttributeTypes.MOB_SPAWN_SETTINGS).defaultValue(MobSpawnSettings.EMPTY));
   EnvironmentAttribute CREATURE_WORLD_GEN_SPAWN_PROBABILITY = register("gameplay/creature_world_gen_spawn_probability", EnvironmentAttribute.builder(AttributeTypes.FLOAT).defaultValue(0.1F).valueRange(AttributeRange.UNIT_FLOAT_EPSILON));
   ...
   private static EnvironmentAttribute register(final String id, final EnvironmentAttribute.Builder attributeBuilder) {
      EnvironmentAttribute attribute = attributeBuilder.build();
