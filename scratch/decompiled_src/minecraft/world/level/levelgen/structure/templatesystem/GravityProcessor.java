...
public class GravityProcessor implements StructureProcessor {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Heightmap.Types.CODEC.optionalFieldOf("heightmap", Heightmap.Types.WORLD_SURFACE_WG).forGetter((p) -> p.heightmap), Codec.INT.optionalFieldOf("offset", 0).forGetter((p) -> p.offset)).apply(i, GravityProcessor::new));
