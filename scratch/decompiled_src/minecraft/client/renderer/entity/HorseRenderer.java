...
public final class HorseRenderer extends AbstractHorseRenderer {
   private static final Map LOCATION_BY_VARIANT = Maps.newEnumMap(Map.of(Variant.WHITE, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_white.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_white_baby.png")), Variant.CREAMY, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_creamy.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_creamy_baby.png")), Variant.CHESTNUT, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_chestnut.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_chestnut_baby.png")), Variant.BROWN, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_brown.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_brown_baby.png")), Variant.BLACK, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_black.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_black_baby.png")), Variant.GRAY, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_gray.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_gray_baby.png")), Variant.DARK_BROWN, new HorseRenderer.HorseTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_darkbrown.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_darkbrown_baby.png"))));
