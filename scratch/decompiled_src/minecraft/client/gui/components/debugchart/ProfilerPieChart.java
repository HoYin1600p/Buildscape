...
public class ProfilerPieChart {
   ...
   public void extractRenderState(final GuiGraphicsExtractor graphics, final int scaledScreenWidth, final int scaledScreenHeight) {
      if (this.profilerPieChartResults != null) {
         ...
         List currentNodeNameLines = this.splitNodeName(currentNodeName, topTextMaxWidth, topTextMaxWidth - 10);
   ...
   private List splitNodeName(final String nodeName, final int firstLineMaxWidth, final int maxWidth) {
