...
public class TestFinder implements TestInstanceFinder, TestPosFinder {
   ...
   public static class Builder {
      ...
      private TestFinder build(final CommandSourceStack source, final TestInstanceFinder testInstanceFinder, final TestPosFinder testPosFinder) {
         List selectedTests = testInstanceFinder.findTests().toList();
         return new TestFinder(source, ((Supplier)this.testFinderWrapper.apply(selectedTests::stream))::get, () -> (Stream)((Supplier)this.structureBlockPosFinderWrapper.apply(testPosFinder::findTestPos)).get());
      }
