...
public class BossBarCommands {
   ...
   public static final SuggestionProvider SUGGEST_BOSS_BAR = (c, b) -> SharedSuggestionProvider.suggestResource(((CommandSourceStack)c.getSource()).getServer().getCustomBossEvents().getIds(), b);
   ...
   private static int listBars(final CommandSourceStack source) {
      Collection events = source.getServer().getCustomBossEvents().getEvents();
      if (events.isEmpty()) {
