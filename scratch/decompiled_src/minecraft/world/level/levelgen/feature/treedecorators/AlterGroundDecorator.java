...
public class AlterGroundDecorator extends TreeDecorator {
   public static final MapCodec CODEC = BlockStateProvider.CODEC.fieldOf("provider").xmap(AlterGroundDecorator::new, (d) -> d.provider);
   ...
   public void place(final TreeDecorator.Context context) {
      List blockPositions = TreeFeature.getLowestTrunkOrRootOfTree(context);
