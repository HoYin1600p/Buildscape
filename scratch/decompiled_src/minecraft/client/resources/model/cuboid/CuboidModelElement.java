...
public record CuboidModelElement(Vector3fc from, Vector3fc to, Map faces, @Nullable CuboidRotation rotation, @Nullable Direction shadeDirectionOverride, int lightEmission) {
   ...
   public CuboidModelElement(final Vector3fc from, final Vector3fc to, final Map faces) {
   ...
   protected static class Deserializer implements JsonDeserializer {
      ...
      public CuboidModelElement deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context) throws JsonParseException {
         ...
         Map faces = this.getFaces(context, object);
      ...
      private Map getFaces(final JsonDeserializationContext context, final JsonObject object) {
         Map faces = this.filterNullFromFaces(context, object);
         if (faces.isEmpty()) {
