...
public class LootPredicates {
   public static final ResourceKey TOOL_CAN_SILK_TOUCH = createKey("tool/can_silk_touch");
   public static final ResourceKey TOOL_CAN_SHEAR = createKey("tool/can_shear");
   public static final ResourceKey FAST_FURNACE = createKey("block/fast_cooking");
