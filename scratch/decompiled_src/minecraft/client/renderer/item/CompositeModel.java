...
public class CompositeModel implements ItemModel {
   ...
   public static record Unbaked(List models, Optional transformation) implements ItemModel.Unbaked {
      public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(ItemModels.CODEC.listOf().fieldOf("models").forGetter(CompositeModel.Unbaked::models), Transformation.EXTENDED_CODEC.optionalFieldOf("transformation").forGetter(CompositeModel.Unbaked::transformation)).apply(i, CompositeModel.Unbaked::new));
