...
public class TryLaySpawnOnFluidNearLand {
   public static BehaviorControl create(final Block spawnBlock) {
      return BehaviorBuilder.create((i) -> i.group(i.absent(MemoryModuleType.ATTACK_TARGET), i.present(MemoryModuleType.WALK_TARGET), i.present(MemoryModuleType.IS_PREGNANT)).apply(i, (attackTarget, walkTarget, pregnant) -> (level, body, timestamp) -> {
