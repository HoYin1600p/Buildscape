...
public class WorkAtComposter extends WorkAtPoi {
   private static final List COMPOSTABLE_ITEMS = ImmutableList.of(Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS);

   protected void useWorkstation(final ServerLevel level, final Villager body) {
      Optional jobSiteMemory = body.getBrain().getMemory(MemoryModuleType.JOB_SITE);
