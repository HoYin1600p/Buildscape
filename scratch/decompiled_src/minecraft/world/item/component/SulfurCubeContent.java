...
public record SulfurCubeContent(ItemStackTemplate absorbedBlockItemStack) implements TooltipProvider {
   public static final Codec CODEC = ItemStackTemplate.CODEC.xmap(SulfurCubeContent::new, SulfurCubeContent::absorbedBlockItemStack);
   public static final StreamCodec STREAM_CODEC = ItemStackTemplate.STREAM_CODEC.map(SulfurCubeContent::new, SulfurCubeContent::absorbedBlockItemStack);
