...
public class VanillaNetherAdvancements extends AdvancementSubProvider {
   ...
   public VanillaNetherAdvancements(final BootstrapContext output) {
      super(output);
