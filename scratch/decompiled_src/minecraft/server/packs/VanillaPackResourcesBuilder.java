...
public class VanillaPackResourcesBuilder {
   ...
   private final List layeredBuilders = new ArrayList();
   ...
   public VanillaPackResourcesBuilder exposeNamespace(final String... namespaces) {
      List namespaceList = List.of(namespaces);
