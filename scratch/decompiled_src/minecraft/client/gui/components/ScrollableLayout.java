...
public class ScrollableLayout implements Layout {
   ...
   public void arrangeElements() {
      ...
      switch (this.reserveStrategy.ordinal()) {
         case 0:
            var10000 = this.container.scrollbarReserve();
            break;
         case 1:
            var10000 = 2 * this.container.scrollbarReserve();
            break;
         default:
   ...
   public static enum ReserveStrategy {
      ...
      // $FF: synthetic method
      private static ScrollableLayout.ReserveStrategy[] $values() {
         return new ScrollableLayout.ReserveStrategy[]{RIGHT, BOTH};
      }
   }
}
