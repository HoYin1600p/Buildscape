...
public abstract class Button extends AbstractButton {
   ...
   protected Button(final int x, final int y, final int width, final int height, final Component message, final Button.OnPress onPress, final Button.CreateNarration createNarration) {
   ...
   public static class Plain extends Button {
      protected Plain(final int x, final int y, final int width, final int height, final Component message, final Button.OnPress onPress, final Button.CreateNarration createNarration) {
