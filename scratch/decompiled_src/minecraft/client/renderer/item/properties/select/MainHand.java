...
public record MainHand() implements SelectItemModelProperty {
   public static final Codec VALUE_CODEC = HumanoidArm.CODEC;
   public static final SelectItemModelProperty.Type TYPE = SelectItemModelProperty.Type.create(MapCodec.unit(new MainHand()), VALUE_CODEC);
