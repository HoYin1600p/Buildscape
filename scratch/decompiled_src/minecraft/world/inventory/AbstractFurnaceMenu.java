...
public abstract class AbstractFurnaceMenu extends RecipeBookMenu {
   ...
   protected AbstractFurnaceMenu(final MenuType menuType, final ResourceKey allowedInputs, final RecipeBookType recipeBookType, final int containerId, final Inventory inventory) {
      this(menuType, allowedInputs, recipeBookType, containerId, inventory, new SimpleContainer(3), new SimpleContainerData(4));
   }

   protected AbstractFurnaceMenu(final MenuType menuType, final ResourceKey allowedInputs, final RecipeBookType recipeBookType, final int containerId, final Inventory inventory, final Container container, final ContainerData data) {
   ...
   public RecipeBookMenu.PostPlaceAction handlePlacement(final boolean useMaxItems, final boolean allowDroppingItemsToClear, final RecipeHolder recipe, final ServerLevel level, final Inventory inventory) {
      final List slotsToClear = List.of(this.getSlot(0), this.getSlot(2));
