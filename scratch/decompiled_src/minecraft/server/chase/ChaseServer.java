...
public class ChaseServer {
   ...
   private void runSender() {
      ...
      while(this.wantsToRun) {
         if (!this.clientSockets.isEmpty()) {
            ...
            List closed = (List)this.clientSockets.stream().filter(Socket::isClosed).collect(Collectors.toList());
   ...
   private ChaseServer.@Nullable PlayerPosition getPlayerPosition() {
      ...
      if (players.isEmpty()) {
         ...
         return dimensionName == null ? null : new ChaseServer.PlayerPosition(dimensionName, player.getX(), player.getY(), player.getZ(), player.getYRot(), player.getXRot());
      }
   }
