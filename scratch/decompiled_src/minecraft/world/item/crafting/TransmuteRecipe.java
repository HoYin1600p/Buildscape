...
public class TransmuteRecipe extends NormalCraftingRecipe {
   ...
   public static final Codec MATERIAL_COUNT_BOUNDS = MinMaxBounds.Ints.CODEC.validate(MinMaxBounds.validateContainedInRange(FULL_RANGE_MATERIAL_COUNT));
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Recipe.CommonInfo.STREAM_CODEC, (o) -> o.commonInfo, CraftingRecipe.CraftingBookInfo.STREAM_CODEC, (o) -> o.bookInfo, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.input, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.material, MinMaxBounds.Ints.STREAM_CODEC, (o) -> o.materialCount, TransmuteResult.STREAM_CODEC, (o) -> o.result, ByteBufCodecs.BOOL, (o) -> o.addMaterialCountToResult, TransmuteRecipe::new);
   ...
   public List display() {
      ...
      List ingredientSlots = new ArrayList();
   ...
   private SlotDisplay stackDisplay(final Holder item, final int resultCount) {
   ...
   protected PlacementInfo createPlacementInfo() {
      int maxMaterialCount = this.maxMaterialCount();
      List ingredients = new ArrayList(1 + maxMaterialCount);
