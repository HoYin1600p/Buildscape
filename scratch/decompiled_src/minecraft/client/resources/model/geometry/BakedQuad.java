...
public record BakedQuad(Vector3fc position0, Vector3fc position1, Vector3fc position2, Vector3fc position3, long packedUV0, long packedUV1, long packedUV2, long packedUV3, Direction direction, BakedQuad.MaterialInfo materialInfo) {
   ...
   public static record MaterialInfo(TextureAtlasSprite sprite, ChunkSectionLayer layer, RenderType itemRenderType, RenderType itemGlintRenderType, RenderType itemGlintSpecialRenderType, int tintIndex, @Nullable Direction shadeDirectionOverride, int lightEmission) {
      public static BakedQuad.MaterialInfo of(final Material.Baked material, final Transparency transparency, final int tintIndex, final @Nullable Direction shadeDirectionOverride, final int lightEmission) {
         ...
         return new BakedQuad.MaterialInfo(material.sprite(), layer, itemRenderType, itemGlintRenderType, itemGlintSpecialRenderType, tintIndex, shadeDirectionOverride, lightEmission);
      }
