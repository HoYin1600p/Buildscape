...
public record SuspiciousStewEffects(List effects) implements ConsumableListener, TooltipProvider {
   ...
   public static final Codec CODEC = SuspiciousStewEffects.Entry.CODEC.listOf().xmap(SuspiciousStewEffects::new, SuspiciousStewEffects::effects);
   public static final StreamCodec STREAM_CODEC = SuspiciousStewEffects.Entry.STREAM_CODEC.apply(ByteBufCodecs.list()).map(SuspiciousStewEffects::new, SuspiciousStewEffects::effects);
   ...
   public void addToTooltip(final Item.TooltipContext context, final Consumer consumer, final TooltipFlag flag, final DataComponentGetter components) {
      if (flag.isCreative()) {
         List effectInstances = new ArrayList();
   ...
   public static record Entry(Holder effect, int duration) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(MobEffect.CODEC.fieldOf("id").forGetter(SuspiciousStewEffects.Entry::effect), Codec.INT.lenientOptionalFieldOf("duration", 160).forGetter(SuspiciousStewEffects.Entry::duration)).apply(i, SuspiciousStewEffects.Entry::new));
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(MobEffect.STREAM_CODEC, SuspiciousStewEffects.Entry::effect, ByteBufCodecs.VAR_INT, SuspiciousStewEffects.Entry::duration, SuspiciousStewEffects.Entry::new);
