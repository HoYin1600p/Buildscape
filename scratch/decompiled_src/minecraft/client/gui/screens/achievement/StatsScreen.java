...
public class StatsScreen extends Screen {
   ...
   public void onStatsUpdated() {
      if (this.isLoading) {
         ...
         this.tabNavigationBar = MenuTabBar.builder(this.tabManager, this.width).addTabs(new StatsScreen.StatisticsTab(GENERAL_BUTTON, new StatsScreen.GeneralStatisticsList(this.minecraft)), new StatsScreen.StatisticsTab(ITEMS_BUTTON, new StatsScreen.ItemStatisticsList(this.minecraft)), new StatsScreen.StatisticsTab(MOBS_BUTTON, new StatsScreen.MobsStatisticsList(this.minecraft))).build();
      ...
      if (this.tabNavigationBar != null) {
         ...
         label20: {
            ...
            if (var4 instanceof StatsScreen.StatisticsTab) {
               StatsScreen.StatisticsTab statsTab = (StatsScreen.StatisticsTab)var4;
   ...
   // $FF: synthetic method
   static Font access$000(StatsScreen x0) {
      return x0.font;
   }

   // $FF: synthetic method
   static Font access$400(StatsScreen x0) {
      return x0.font;
   }

   // $FF: synthetic method
   static Font access$500(StatsScreen x0) {
      return x0.font;
   }

   // $FF: synthetic method
   static Font access$900(StatsScreen x0) {
      return x0.font;
   }

   // $FF: synthetic method
   static Font access$1200(StatsScreen x0) {
      return x0.font;
   }

   // $FF: synthetic method
   static Font access$1400(StatsScreen x0) {
      return x0.font;
   }
   ...
   private class ItemStatisticsList extends ContainerObjectSelectionList {
      ...
      protected void sortItems(final Comparator comparator) {
         List itemRows = this.getItemRows();
      ...
      private class HeaderEntry extends StatsScreen.ItemStatisticsList.Entry {
         ...
         private class StatSortButton extends ImageButton {
            ...
            private StatSortButton(final StatsScreen.ItemStatisticsList.HeaderEntry this$2, final int column, final Identifier sprite) {
      ...
      private class ItemRow extends StatsScreen.ItemStatisticsList.Entry {
         ...
         public void extractContent(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final boolean hovered, final float a) {
            ...
            for(int col = 0; col < itemStatsList.itemColumns.size(); ++col) {
               this.extractStat(graphics, ((StatType)itemStatsList.itemColumns.get(col)).get(this.item), this.getContentX() + ItemStatisticsList.this.getColumnX(col + itemStatsList.blockColumns.size()), this.getContentYMiddle() - 9 / 2, index % 2 == 0);
            }
