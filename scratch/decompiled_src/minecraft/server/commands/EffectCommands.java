...
public class EffectCommands {
   ...
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_GIVE = CommandResponseTracker.messages(ERROR_GIVE_FAILED, (entity, var1, effect, duration) -> Component.translatable("commands.effect.give.success.single", effect.getDisplayName(), entity.getDisplayName(), duration / 20), (entityCount, var1, effect, duration) -> Component.translatable("commands.effect.give.success.multiple", effect.getDisplayName(), entityCount, duration / 20));
   private static final CommandResponseTracker.Messages RESPONSE_CLEAR_ALL = CommandResponseTracker.messages(ERROR_CLEAR_EVERYTHING_FAILED, (entity, var1) -> Component.translatable("commands.effect.clear.everything.success.single", entity.getDisplayName()), (entityCount, var1) -> Component.translatable("commands.effect.clear.everything.success.multiple", entityCount));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_CLEAR_SINGLE = CommandResponseTracker.messages(ERROR_CLEAR_SPECIFIC_FAILED, (entity, var1, effect) -> Component.translatable("commands.effect.clear.specific.success.single", effect.getDisplayName(), entity.getDisplayName()), (entityCount, var1, effect) -> Component.translatable("commands.effect.clear.specific.success.multiple", effect.getDisplayName(), entityCount));
