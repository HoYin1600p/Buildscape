...
public class ScoreboardCommand {
   ...
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_ENABLE = CommandResponseTracker.messages(ERROR_TRIGGER_ALREADY_ENABLED, (holder, var1, objective) -> Component.translatable("commands.scoreboard.players.enable.success.single", objective.getFormattedDisplayName(), holder.getFeedbackDisplayName()), (holderCount, var1, objective) -> Component.translatable("commands.scoreboard.players.enable.success.multiple", objective.getFormattedDisplayName(), holderCount));
   private static final CommandResponseTracker.Messages RESPONSE_SCORE_RESET_ALL = CommandResponseTracker.messages((holder, var1) -> Component.translatable("commands.scoreboard.players.reset.all.single", holder.getFeedbackDisplayName()), (holderCount, var1) -> Component.translatable("commands.scoreboard.players.reset.all.multiple", holderCount));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_SCORE_RESET = CommandResponseTracker.messages((holder, var1, objective) -> Component.translatable("commands.scoreboard.players.reset.specific.single", objective.getFormattedDisplayName(), holder.getFeedbackDisplayName()), (holderCount, var1, objective) -> Component.translatable("commands.scoreboard.players.reset.specific.multiple", objective.getFormattedDisplayName(), holderCount));
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_SCORE_SET = CommandResponseTracker.messages((holder, var1, objective, value) -> Component.translatable("commands.scoreboard.players.set.success.single", objective.getFormattedDisplayName(), holder.getFeedbackDisplayName(), value), (holderCount, var1, objective, value) -> Component.translatable("commands.scoreboard.players.set.success.multiple", objective.getFormattedDisplayName(), holderCount, value));
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_SCORE_ADD = CommandResponseTracker.messages((holder, totalValue, objective, value) -> Component.translatable("commands.scoreboard.players.add.success.single", value, objective.getFormattedDisplayName(), holder.getFeedbackDisplayName(), totalValue), (holderCount, var1, objective, value) -> Component.translatable("commands.scoreboard.players.add.success.multiple", value, objective.getFormattedDisplayName(), holderCount));
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_SCORE_REMOVE = CommandResponseTracker.messages((holder, totalValue, objective, value) -> Component.translatable("commands.scoreboard.players.remove.success.single", value, objective.getFormattedDisplayName(), holder.getFeedbackDisplayName(), totalValue), (holderCount, var1, objective, value) -> Component.translatable("commands.scoreboard.players.remove.success.multiple", value, objective.getFormattedDisplayName(), holderCount));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_SCORE_OPERATION = CommandResponseTracker.messages((holder, totalValue, targetObjective) -> Component.translatable("commands.scoreboard.players.operation.success.single", targetObjective.getFormattedDisplayName(), holder.getFeedbackDisplayName(), totalValue), (holderCount, var1, targetObjective) -> Component.translatable("commands.scoreboard.players.operation.success.multiple", targetObjective.getFormattedDisplayName(), holderCount));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_NUMBER_FORMAT_CLEAR = CommandResponseTracker.messages((holder, var1, objective) -> Component.translatable("commands.scoreboard.players.display.numberFormat.clear.success.single", holder.getFeedbackDisplayName(), objective.getFormattedDisplayName()), (holderCount, var1, objective) -> Component.translatable("commands.scoreboard.players.display.numberFormat.clear.success.multiple", holderCount, objective.getFormattedDisplayName()));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_NUMBER_FORMAT_SET = CommandResponseTracker.messages((holder, var1, objective) -> Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.single", holder.getFeedbackDisplayName(), objective.getFormattedDisplayName()), (holderCount, var1, objective) -> Component.translatable("commands.scoreboard.players.display.numberFormat.set.success.multiple", holderCount, objective.getFormattedDisplayName()));
   private static final CommandResponseTracker.MessagesWithArg RESPONSE_DISPLAY_CLEAR = CommandResponseTracker.messages((holder, var1, objective) -> Component.translatable("commands.scoreboard.players.display.name.clear.success.single", holder.getFeedbackDisplayName(), objective.getFormattedDisplayName()), (holderCount, var1, objective) -> Component.translatable("commands.scoreboard.players.display.name.clear.success.multiple", holderCount, objective.getFormattedDisplayName()));
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_DISPLAY_SET = CommandResponseTracker.messages((holder, var1, objective, display) -> Component.translatable("commands.scoreboard.players.display.name.set.success.single", display, holder.getFeedbackDisplayName(), objective.getFormattedDisplayName()), (holderCount, var1, objective, display) -> Component.translatable("commands.scoreboard.players.display.name.set.success.multiple", display, holderCount, objective.getFormattedDisplayName()));
   ...
   private static ArgumentBuilder addNumberFormats(final CommandBuildContext context, final ArgumentBuilder top, final ScoreboardCommand.NumberFormatCommandExecutor callback) {
   ...
   private static LiteralArgumentBuilder createRenderTypeModify() {
      LiteralArgumentBuilder result = Commands.literal("rendertype");
   ...
   private static int enableTrigger(final CommandSourceStack source, final Collection targets, final Objective objective) throws CommandSyntaxException {
      if (objective.getCriteria() != ObjectiveCriteria.TRIGGER) {
   ...
   private static int resetScores(final CommandSourceStack source, final Collection targets) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int resetScore(final CommandSourceStack source, final Collection targets, final Objective objective) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int setScore(final CommandSourceStack source, final Collection targets, final Objective objective, final int value) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int setScoreDisplay(final CommandSourceStack source, final Collection targets, final Objective objective, final @Nullable Component display) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
      ...
      return display == null ? tracker.sendFeedback(source, true, RESPONSE_DISPLAY_CLEAR, objective) : tracker.sendFeedback(source, true, RESPONSE_DISPLAY_SET, objective, display);
   }

   private static int setScoreNumberFormat(final CommandSourceStack source, final Collection targets, final Objective objective, final @Nullable NumberFormat numberFormat) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
      ...
      return numberFormat == null ? tracker.sendFeedback(source, true, RESPONSE_NUMBER_FORMAT_CLEAR, objective) : tracker.sendFeedback(source, true, RESPONSE_NUMBER_FORMAT_SET, objective);
   }

   private static int addScore(final CommandSourceStack source, final Collection targets, final Objective objective, final int value) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int removeScore(final CommandSourceStack source, final Collection targets, final Objective objective, final int value) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int listTrackedPlayers(final CommandSourceStack source) {
      Collection entities = source.getServer().getScoreboard().getTrackedPlayers();
      if (entities.isEmpty()) {
   ...
   private static int listTrackedPlayerScores(final CommandSourceStack source, final ScoreHolder entity) {
      Object2IntMap scores = source.getServer().getScoreboard().listPlayerScores(entity);
      if (scores.isEmpty()) {
   ...
   private static int listObjectives(final CommandSourceStack source) {
      Collection objectives = source.getServer().getScoreboard().getObjectives();
