...
public class ReloadableServerResources {
   ...
   private static final CompletableFuture DATA_RELOAD_INITIAL_TASK = CompletableFuture.completedFuture(Unit.INSTANCE);
   ...
   private ReloadableServerResources(final ReloadableServerRegistries.LoadResult loadingContext, final FeatureFlagSet enabledFeatures, final Commands.CommandSelection commandSelection, final List postponedTags, final PermissionSet functionCompilationPermissions, final List newComponents) {
