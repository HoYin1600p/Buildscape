...
public abstract class CachedParseState implements ParseState {
   ...
   private final CachedParseState.Silent silent = new CachedParseState.Silent();
   ...
   public @Nullable Object parse(final NamedRule rule) {
      ...
      if (entryIndex != -1) {
         CachedParseState.CacheEntry value = positionCache.getValue(entryIndex);
         if (value != null) {
      ...
      Object result = (T)rule.value().parse(this);
      CachedParseState.CacheEntry entry;
      if (result == null) {
   ...
   private static record CacheEntry(@Nullable Object value, int markAfterParse) {
      ...
      public static CachedParseState.CacheEntry negativeEntry() {
         return NEGATIVE;
      }
   }
   ...
   private static class PositionCache {
      ...
      public CachedParseState.@Nullable CacheEntry getValue(final int keyIndex) {
