...
public enum ChatRestriction {
   CHAT_AND_COMMANDS_DISABLED_BY_OPTIONS(Component.translatable("chat_restriction.chat_and_commands_disabled_by_options"), Optional.of(ChatRestriction.Action.GO_TO_CHAT_SETTINGS)) {
      public void modifyPermissions(final Set permissionSet) {
   ...
   private ChatRestriction(final Component display, final Optional action) {
   ...
   public static record Action(Component title, BiConsumer runnable) {
      public static final ChatRestriction.Action GO_TO_ACCOUNT = new ChatRestriction.Action(Component.translatable("chat_restriction.disabled_by_profile.action"), (minecraft, screen) -> ConfirmLinkScreen.confirmLinkNow(screen, CommonLinks.ACCOUNT_SETTINGS, true));
      public static final ChatRestriction.Action GO_TO_CHAT_SETTINGS = new ChatRestriction.Action(Component.translatable("chat_restriction.chat_disabled_by_options.action"), (minecraft, screen) -> minecraft.gui.setScreen(new ChatOptionsScreen(screen, minecraft.options)));
   }
}
