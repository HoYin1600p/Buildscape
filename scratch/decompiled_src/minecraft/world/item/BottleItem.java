...
public class BottleItem extends Item {
   ...
   public InteractionResult use(final Level level, final Player player, final InteractionHand hand) {
      List clouds = level.getEntitiesOfClass(AreaEffectCloud.class, player.getBoundingBox().inflate(2.0D), (input) -> input.isAlive() && input.getOwner() instanceof EnderDragon);
