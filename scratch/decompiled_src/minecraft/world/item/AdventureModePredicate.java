...
public class AdventureModePredicate {
   ...
   public static final Codec CODEC = ExtraCodecs.compactListCodec(BlockPredicate.CODEC, ExtraCodecs.nonEmptyList(BlockPredicate.CODEC.listOf())).xmap(AdventureModePredicate::new, (p) -> p.predicates);
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(BlockPredicate.STREAM_CODEC.apply(ByteBufCodecs.list()), (predicate) -> predicate.predicates, AdventureModePredicate::new);
