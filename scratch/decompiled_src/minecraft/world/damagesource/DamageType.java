...
public record DamageType(String msgId, DamageScaling scaling, float exhaustion, DamageEffects effects, DeathMessageType deathMessageType) {
   ...
   public static final Codec CODEC = RegistryCodecs.holder(Registries.DAMAGE_TYPE);
   public static final StreamCodec STREAM_CODEC = ByteBufCodecs.holderRegistry(Registries.DAMAGE_TYPE);
