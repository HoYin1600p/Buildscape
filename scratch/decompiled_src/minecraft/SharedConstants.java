...
public class SharedConstants {
   ...
   /** @deprecated */
   @Deprecated
   public static final int WORLD_VERSION = 5010;
   /** @deprecated */
   @Deprecated
   ...
   /** @deprecated */
   @Deprecated
   public static final int SNAPSHOT_NETWORK_PROTOCOL_VERSION = 330;
   ...
   /** @deprecated */
   @Deprecated
   public static final int DATA_PACK_FORMAT_MAJOR = 116;
   /** @deprecated */
   @Deprecated
