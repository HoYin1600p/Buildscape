...
public class ParticleEngine {
   private static final List RENDER_ORDER = List.of(ParticleRenderType.SINGLE_QUADS, ParticleRenderType.ITEM_PICKUP, ParticleRenderType.ELDER_GUARDIANS);
   ...
   public void add(final Particle p) {
      Optional limit = p.getParticleLimit();
      if (limit.isPresent()) {
   ...
   public String countParticles() {
      ...
      for(Map.Entry group : this.particles.entrySet()) {
