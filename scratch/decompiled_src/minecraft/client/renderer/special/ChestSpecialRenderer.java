...
public class ChestSpecialRenderer implements NoDataSpecialModelRenderer {
   ...
   public static final MultiblockChestResources REGULAR = createDefaultTextures("normal");
   public static final MultiblockChestResources TRAPPED = createDefaultTextures("trapped");
   public static final MultiblockChestResources CHRISTMAS = createDefaultTextures("christmas");
   public static final WeatheringCopperCollection.ByState COPPER = new WeatheringCopperCollection.ByState(createDefaultTextures("copper"), createDefaultTextures("copper_exposed"), createDefaultTextures("copper_weathered"), createDefaultTextures("copper_oxidized"));
   ...
   private static MultiblockChestResources createDefaultTextures(final String prefix) {
      return new MultiblockChestResources(Identifier.withDefaultNamespace(prefix), Identifier.withDefaultNamespace(prefix + "_left"), Identifier.withDefaultNamespace(prefix + "_right"));
   }
   ...
   public void submit(final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector, final int lightCoords, final int overlayCoords, final boolean hasFoil, final int outlineColor) {
      submitNodeCollector.submitModel(this.model, Float.valueOf(this.openness), poseStack, lightCoords, overlayCoords, -1, this.sprite, this.sprites, outlineColor);
   }
