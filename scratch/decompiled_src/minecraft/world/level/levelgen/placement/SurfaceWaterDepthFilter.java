...
public record SurfaceWaterDepthFilter(int maxWaterDepth) implements PlacementFilter {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Codec.INT.fieldOf("max_water_depth").forGetter(SurfaceWaterDepthFilter::maxWaterDepth)).apply(i, SurfaceWaterDepthFilter::new));
