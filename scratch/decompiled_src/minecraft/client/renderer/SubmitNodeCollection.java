...
public class SubmitNodeCollection implements OrderedSubmitNodeCollector {
   ...
   public final FeatureRenderPhase translucentBlocksAndItems;
   public final FeatureRenderPhase translucentModels;
   ...
   public void submitModel(final Model model, final Object state, final PoseStack poseStack, final RenderType renderType, final int lightCoords, final int overlayCoords, final int tintedColor, final @Nullable UvMapping uvMapping, final int outlineColor) {
      PoseStack.Pose pose = poseStack.last().copy();
      if (!renderType.isOutline()) {
         ModelFeatureRenderer.Submit submit = new ModelFeatureRenderer.Submit(renderType, pose, model, state, lightCoords, overlayCoords, tintedColor, uvMapping, (PoseStack.Pose)null);
   ...
   public void submitCrumblingOverlay(final Model model, final Object state, final PoseStack poseStack, final RenderType renderType, final int lightCoords, final int overlayCoords, final int tintedColor, final ModelFeatureRenderer.CrumblingOverlay crumblingOverlay) {
   ...
   public void submitBlockModel(final PoseStack poseStack, final RenderType renderType, final List modelParts, final int[] tintLayers, final int lightCoords, final int overlayCoords, final int outlineColor) {
      PoseStack.Pose pose = poseStack.last().copy();
      if (!renderType.isOutline()) {
   ...
   public void submitBreakingBlockModel(final PoseStack poseStack, final List parts, final int progress, final boolean isBlockTranslucent) {
      PoseStack.Pose pose = poseStack.last().copy();
      List destroyTypes = Minecraft.getInstance().gameRenderer.useImprovedTransparency() && isBlockTranslucent ? ModelBakery.DESTROY_TYPES_OIT : ModelBakery.DESTROY_TYPES;
