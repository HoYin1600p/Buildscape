...
public class TransferCommand {
   ...
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_TRANSFER = CommandResponseTracker.messages(ERROR_NO_PLAYERS, (player, var1, hostname, port) -> Component.translatable("commands.transfer.success.single", player.getDisplayName(), hostname, port), (playerCount, totalValue, hostname, port) -> Component.translatable("commands.transfer.success.multiple", playerCount, hostname, port));
