...
public class SmithingScreen extends ItemCombinerScreen {
   ...
   private static final List EMPTY_SLOT_SMITHING_TEMPLATES = List.of(EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM, EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE);
   ...
   public void containerTick() {
      super.containerTick();
      Optional template = this.getTemplateItem();
   ...
   private void extractOnboardingTooltips(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY) {
      Optional tooltip = Optional.empty();
