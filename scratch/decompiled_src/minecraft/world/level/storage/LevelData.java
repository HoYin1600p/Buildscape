...
public interface LevelData {
   ...
   public static record RespawnData(GlobalPos globalPos, float yaw, float pitch) {
      ...
      public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(GlobalPos.MAP_CODEC.forGetter(LevelData.RespawnData::globalPos), Codec.floatRange(-180.0F, 180.0F).fieldOf("yaw").forGetter(LevelData.RespawnData::yaw), Codec.floatRange(-90.0F, 90.0F).fieldOf("pitch").forGetter(LevelData.RespawnData::pitch)).apply(i, LevelData.RespawnData::new));
      public static final Codec CODEC = MAP_CODEC.codec();
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(GlobalPos.STREAM_CODEC, LevelData.RespawnData::globalPos, ByteBufCodecs.FLOAT, LevelData.RespawnData::yaw, ByteBufCodecs.FLOAT, LevelData.RespawnData::pitch, LevelData.RespawnData::new);

      public static LevelData.RespawnData of(final ResourceKey dimension, final BlockPos pos, final float yaw, final float pitch) {
