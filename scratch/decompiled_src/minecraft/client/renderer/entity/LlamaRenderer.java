...
public class LlamaRenderer extends AgeableMobRenderer {
   ...
   public Identifier getTextureLocation(final LlamaRenderState state) {
      Map textures = state.isBaby ? BABY_TEXTURES : TEXTURES;
