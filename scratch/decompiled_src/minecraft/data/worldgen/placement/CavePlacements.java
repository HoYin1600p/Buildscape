...
public class CavePlacements {
   ...
   public static final ResourceKey SULFUR_SPIKE_CLUSTER = PlacementUtils.createKey("sulfur_spike_cluster");
   ...
   public static final ResourceKey SULFUR_SPIKE = PlacementUtils.createKey("sulfur_spike");
   ...
   public static final ResourceKey ROOTED_SULFUR_SPRING = PlacementUtils.createKey("rooted_sulfur_spring");
   ...
   public static void bootstrap(final BootstrapContext context) {
      ...
      Holder monsterRoom = configuredFeatures.getOrThrow(CaveFeatures.MONSTER_ROOM);
      Holder fossilCoal = configuredFeatures.getOrThrow(CaveFeatures.FOSSIL_COAL);
      Holder fossilDiamonds = configuredFeatures.getOrThrow(CaveFeatures.FOSSIL_DIAMONDS);
      Holder dripstoneCluster = configuredFeatures.getOrThrow(CaveFeatures.DRIPSTONE_CLUSTER);
      Holder sulfurSpikeCluster = configuredFeatures.getOrThrow(CaveFeatures.SULFUR_SPIKE_CLUSTER);
      Holder largeDripstone = configuredFeatures.getOrThrow(CaveFeatures.LARGE_DRIPSTONE);
      Holder pointedDripstone = configuredFeatures.getOrThrow(CaveFeatures.POINTED_DRIPSTONE);
      Holder sulfurSpike = configuredFeatures.getOrThrow(CaveFeatures.SULFUR_SPIKE);
      Holder underwaterMagma = configuredFeatures.getOrThrow(CaveFeatures.UNDERWATER_MAGMA);
      Holder glowLichen = configuredFeatures.getOrThrow(CaveFeatures.GLOW_LICHEN);
      Holder rootedAzaleaTree = configuredFeatures.getOrThrow(CaveFeatures.ROOTED_AZALEA_TREE);
      Holder rootedSulfurSpring = configuredFeatures.getOrThrow(CaveFeatures.ROOTED_SULFUR_SPRING);
      Holder caveVine = configuredFeatures.getOrThrow(CaveFeatures.CAVE_VINE);
      Holder mossPatch = configuredFeatures.getOrThrow(CaveFeatures.MOSS_PATCH);
      Holder lushCavesClay = configuredFeatures.getOrThrow(CaveFeatures.LUSH_CAVES_CLAY);
      Holder mossPatchCeiling = configuredFeatures.getOrThrow(CaveFeatures.MOSS_PATCH_CEILING);
      Holder sporeBlossom = configuredFeatures.getOrThrow(CaveFeatures.SPORE_BLOSSOM);
      Holder vines = configuredFeatures.getOrThrow(VegetationFeatures.VINES);
      Holder amethystGeode = configuredFeatures.getOrThrow(CaveFeatures.AMETHYST_GEODE);
      Holder sculkPatchDeepDark = configuredFeatures.getOrThrow(CaveFeatures.SCULK_PATCH_DEEP_DARK);
      Holder sculkPatchAncientCity = configuredFeatures.getOrThrow(CaveFeatures.SCULK_PATCH_ANCIENT_CITY);
      Holder sculkVein = configuredFeatures.getOrThrow(CaveFeatures.SCULK_VEIN);
