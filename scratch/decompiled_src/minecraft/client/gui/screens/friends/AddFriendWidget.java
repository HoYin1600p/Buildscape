...
class AddFriendWidget extends AbstractContainerWidget {
   ...
   AddFriendWidget(final int width, final Runnable afterSend) {
      ...
      this.profileNameButton = new PlainTextButton(this, 0, 0, profileNameWidth, 9, profileNameComponent, (var2) -> this.minecraft.keyboardHandler.setClipboard(profileName), this.minecraft.font) {
         {
   ...
   private static boolean contains(final List players, final String playerName) {
   ...
   static enum State {
      ...
      // $FF: synthetic method
      private static AddFriendWidget.State[] $values() {
         return new AddFriendWidget.State[]{EMPTY_INPUT, READY, SENDING, DISABLED};
      }
   }
}
