...
public class Checkbox extends AbstractButton {
   ...
   private Checkbox(final int x, final int y, final int maxWidth, final Component message, final Font font, final boolean selected, final Checkbox.OnValueChange onValueChange) {
   ...
   public static class Builder {
      ...
      private @Nullable OptionInstance option = null;
      ...
      public Checkbox.Builder selected(final OptionInstance option) {
         this.option = option;
