...
public class CollectingNeighborUpdater implements NeighborUpdater {
   ...
   private static record FullNeighborUpdate(BlockState state, BlockPos pos, Block block, @Nullable Orientation orientation, boolean movedByPiston) implements CollectingNeighborUpdater.NeighborUpdates {
   ...
   private static record SimpleNeighborUpdate(BlockPos pos, Block block, @Nullable Orientation orientation) implements CollectingNeighborUpdater.NeighborUpdates {
      public boolean runNext(final Level level) {
