...
public interface CollisionGetter extends BlockGetter {
   ...
   default boolean isUnobstructed(final BlockState state, final BlockPos pos, final CollisionContext context) {
      ...
      return shape.isEmpty() || this.isUnobstructed((Entity)null, shape.move(pos));
   }
   ...
   default Iterable getCollisions(final @Nullable Entity source, final AABB box) {
      List entityCollisions = this.getEntityCollisions(source, box);
   ...
   default Iterable getBlockCollisionsFromContext(final CollisionContext source, final AABB box) {
   ...
   default boolean collidesWithSuffocatingBlock(final @Nullable Entity source, final AABB box) {
      BlockCollisions blockCollisions = new BlockCollisions(this, source, box, true, (p, shape) -> shape);
   ...
   default Optional findSupportingBlock(final Entity source, final AABB box) {
      ...
      BlockCollisions blockCollisions = new BlockCollisions(this, source, box, false, (posx, shape) -> posx);
