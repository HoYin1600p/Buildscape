...
public record ChunkPyramid(ImmutableList steps) {
   ...
   public static class Builder {
      ...
      public ChunkPyramid.Builder step(final ChunkStatus status, final UnaryOperator operator) {
