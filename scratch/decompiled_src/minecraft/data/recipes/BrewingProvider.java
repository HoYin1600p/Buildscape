...
public abstract class BrewingProvider {
   ...
   private final List containerTransformations = new ArrayList();
   private final Set potions = new HashSet();
   ...
   protected void buildMix(final Holder input, final Item reagent, final Holder output) {
   ...
   protected void buildStartMix(final Item reagent, final Holder output) {
   ...
   protected void buildTransformations() {
      for(BrewingProvider.ContainerTransformation transformation : this.containerTransformations) {
         for(Holder potion : this.potions) {
