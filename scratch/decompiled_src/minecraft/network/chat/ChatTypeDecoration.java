...
public record ChatTypeDecoration(String translationKey, List parameters, Style style) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.STRING_UTF8, ChatTypeDecoration::translationKey, ChatTypeDecoration.Parameter.STREAM_CODEC.apply(ByteBufCodecs.list()), ChatTypeDecoration::parameters, Style.Serializer.TRUSTED_STREAM_CODEC, ChatTypeDecoration::style, ChatTypeDecoration::new);
   ...
   public static enum Parameter implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(ChatTypeDecoration.Parameter::values);
