...
public class NetherFossilStructure extends Structure {
   ...
   public Optional findGenerationPoint(final Structure.GenerationContext context) {
      ...
      if (y <= seaLevel) {
         ...
         return Optional.of(new Structure.GenerationStub(position, (Consumer)((builder) -> NetherFossilPieces.addPieces(context.structureTemplateManager(), builder, random, position))));
      }
   }
