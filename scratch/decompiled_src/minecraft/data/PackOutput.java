...
public class PackOutput {
   ...
   public PackOutput.PathProvider createRegistryElementsPathProvider(final ResourceKey registryKey) {
      return this.createPathProvider(PackOutput.Target.DATA_PACK, Registries.elementsDirPath(registryKey));
   }

   public PackOutput.PathProvider createRegistryTagsPathProvider(final ResourceKey registryKey) {
      return this.createPathProvider(PackOutput.Target.DATA_PACK, Registries.tagsDirPath(registryKey));
   }

   public PackOutput.PathProvider createRegistryComponentPathProvider(final ResourceKey registryKey) {
