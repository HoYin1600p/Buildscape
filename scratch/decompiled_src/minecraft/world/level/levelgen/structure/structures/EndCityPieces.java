...
public class EndCityPieces {
   ...
   private static final EndCityPieces.SectionGenerator HOUSE_TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(final StructureTemplateManager structureTemplateManager, final int genDepth, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final List pieces, final RandomSource random) {
         if (genDepth > 8) {
            return false;
         } else {
            Rotation rotation = parent.placeSettings().getRotation();
            EndCityPieces.EndCityPiece lastPiece = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, parent, offset, "base_floor", rotation, true));
   ...
   private static final List TOWER_BRIDGES = List.of(Pair.of(Rotation.NONE, new BlockPos(1, -1, 0)), Pair.of(Rotation.CLOCKWISE_90, new BlockPos(6, -1, 1)), Pair.of(Rotation.COUNTERCLOCKWISE_90, new BlockPos(0, -1, 5)), Pair.of(Rotation.CLOCKWISE_180, new BlockPos(5, -1, 6)));
   private static final EndCityPieces.SectionGenerator TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(final StructureTemplateManager structureTemplateManager, final int genDepth, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final List pieces, final RandomSource random) {
         Rotation rotation = parent.placeSettings().getRotation();
         EndCityPieces.EndCityPiece lastPiece = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, parent, new BlockPos(3 + random.nextInt(2), -3, 3 + random.nextInt(2)), "tower_base", rotation, true));
         ...
         if (bridgePiece != null) {
            for(Pair bridge : EndCityPieces.TOWER_BRIDGES) {
               if (random.nextBoolean()) {
                  EndCityPieces.EndCityPiece bridgeStart = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, bridgePiece, (BlockPos)bridge.getSecond(), "bridge_end", rotation.getRotated((Rotation)bridge.getFirst()), true));
   ...
   private static final EndCityPieces.SectionGenerator TOWER_BRIDGE_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(final StructureTemplateManager structureTemplateManager, final int genDepth, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final List pieces, final RandomSource random) {
         ...
         EndCityPieces.EndCityPiece lastPiece = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, parent, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
   ...
   private static final List FAT_TOWER_BRIDGES = List.of(Pair.of(Rotation.NONE, new BlockPos(4, -1, 0)), Pair.of(Rotation.CLOCKWISE_90, new BlockPos(12, -1, 4)), Pair.of(Rotation.COUNTERCLOCKWISE_90, new BlockPos(0, -1, 8)), Pair.of(Rotation.CLOCKWISE_180, new BlockPos(8, -1, 12)));
   private static final EndCityPieces.SectionGenerator FAT_TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
      ...
      public boolean generate(final StructureTemplateManager structureTemplateManager, final int genDepth, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final List pieces, final RandomSource random) {
         Rotation rotation = parent.placeSettings().getRotation();
         EndCityPieces.EndCityPiece lastPiece = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, parent, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
         ...
         for(int i = 0; i < 2 && random.nextInt(3) != 0; ++i) {
            ...
            for(Pair bridge : EndCityPieces.FAT_TOWER_BRIDGES) {
               if (random.nextBoolean()) {
                  EndCityPieces.EndCityPiece bridgeStart = EndCityPieces.addHelper(pieces, EndCityPieces.addPiece(structureTemplateManager, lastPiece, (BlockPos)bridge.getSecond(), "bridge_end", rotation.getRotated((Rotation)bridge.getFirst()), true));
                  EndCityPieces.recursiveChildren(structureTemplateManager, EndCityPieces.TOWER_BRIDGE_GENERATOR, genDepth + 1, bridgeStart, (BlockPos)null, pieces, random);
               }
            }
         }
   ...
   private static EndCityPieces.EndCityPiece addPiece(final StructureTemplateManager structureTemplateManager, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final String templateName, final Rotation rotation, final boolean overwrite) {
   ...
   private static EndCityPieces.EndCityPiece addHelper(final List pieces, final EndCityPieces.EndCityPiece piece) {
      pieces.add(piece);
      return piece;
   }

   private static boolean recursiveChildren(final StructureTemplateManager structureTemplateManager, final EndCityPieces.SectionGenerator generator, final int genDepth, final EndCityPieces.EndCityPiece parent, final BlockPos offset, final List pieces, final RandomSource random) {
      if (genDepth > 8) {
         return false;
      } else {
         List childPieces = new ArrayList();
      ...
      protected void handleDataMarker(final String markerId, final BlockPos position, final ServerLevelAccessor level, final RandomSource random, final BoundingBox chunkBB) {
         if (markerId.startsWith("Chest")) {
            ...
            if (markerId.startsWith("Sentry")) {
               Shulker sentry = (Shulker)EntityTypes.SHULKER.create(level.getLevel(), EntitySpawnReason.STRUCTURE);
               if (sentry != null) {
                  sentry.setPos((double)position.getX() + 0.5D, (double)position.getY(), (double)position.getZ() + 0.5D);
   ...
   private interface SectionGenerator {
      ...
      boolean generate(StructureTemplateManager structureTemplateManager, int genDepth, EndCityPieces.EndCityPiece parent, BlockPos offset, List pieces, RandomSource random);
   }
}
