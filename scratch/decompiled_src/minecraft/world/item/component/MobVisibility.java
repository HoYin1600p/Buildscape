...
public record MobVisibility(HolderSet targetingEntityTypes, float visibility) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.holderSet(Registries.ENTITY_TYPE), MobVisibility::targetingEntityTypes, ByteBufCodecs.FLOAT, MobVisibility::visibility, MobVisibility::new);
}
