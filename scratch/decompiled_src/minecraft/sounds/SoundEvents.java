...
public class SoundEvents {
   ...
   public static final Holder.Reference AXE_STRIP = registerForHolder("item.axe.strip");
   public static final Holder.Reference AXE_SCRAPE = registerForHolder("item.axe.scrape");
   public static final Holder.Reference AXE_WAX_OFF = registerForHolder("item.axe.wax_off");
   ...
   public static final Holder.Reference CAT_AMBIENT_BABY = registerForHolder("entity.baby_cat.ambient");
   public static final Holder.Reference CAT_STRAY_AMBIENT_BABY = registerForHolder("entity.baby_cat.stray_ambient");
   public static final Holder.Reference CAT_DEATH_BABY = registerForHolder("entity.baby_cat.death");
   public static final Holder.Reference CAT_EAT_BABY = registerForHolder("entity.baby_cat.eat");
   public static final Holder.Reference CAT_HISS_BABY = registerForHolder("entity.baby_cat.hiss");
   public static final Holder.Reference CAT_BEG_FOR_FOOD_BABY = registerForHolder("entity.baby_cat.beg_for_food");
   public static final Holder.Reference CAT_HURT_BABY = registerForHolder("entity.baby_cat.hurt");
   public static final Holder.Reference CAT_PURR_BABY = registerForHolder("entity.baby_cat.purr");
   public static final Holder.Reference CAT_PURREOW_BABY = registerForHolder("entity.baby_cat.purreow");
   public static final Map CAT_SOUNDS = registerCatSoundVariants();
   ...
   public static final Holder.Reference CHICKEN_AMBIENT_BABY = registerForHolder("entity.baby_chicken.ambient");
   public static final Holder.Reference CHICKEN_DEATH_BABY = registerForHolder("entity.baby_chicken.death");
   public static final SoundEvent CHICKEN_EGG = register("entity.chicken.egg");
   public static final Holder.Reference CHICKEN_HURT_BABY = registerForHolder("entity.baby_chicken.hurt");
   public static final Holder.Reference CHICKEN_STEP = registerForHolder("entity.chicken.step");
   public static final Holder.Reference CHICKEN_STEP_BABY = registerForHolder("entity.baby_chicken.step");
   public static final Map CHICKEN_SOUNDS = registerChickenSoundVariants();
   ...
   public static final Map COW_SOUNDS = registerCowSoundVariants();
   ...
   public static final Holder.Reference HOE_TILL = registerForHolder("item.hoe.till");
   ...
   public static final Holder.Reference MUSIC_DISC_BOUNCE = registerForHolder("music_disc.bounce");
   ...
   public static final Holder.Reference MUSIC_BIOME_SULFUR_CAVES = registerForHolder("music.overworld.sulfur_caves");
   ...
   public static final Holder.Reference NOTE_BLOCK_TRUMPET = registerForHolder("block.note_block.trumpet");
   public static final Holder.Reference NOTE_BLOCK_TRUMPET_EXPOSED = registerForHolder("block.note_block.trumpet_exposed");
   public static final Holder.Reference NOTE_BLOCK_TRUMPET_OXIDIZED = registerForHolder("block.note_block.trumpet_oxidized");
   public static final Holder.Reference NOTE_BLOCK_TRUMPET_WEATHERED = registerForHolder("block.note_block.trumpet_weathered");
   ...
   public static final Holder.Reference PIG_STEP = registerForHolder("entity.pig.step");
   public static final Holder.Reference PIG_STEP_BABY = registerForHolder("entity.baby_pig.step");
   public static final Holder.Reference PIG_AMBIENT_BABY = registerForHolder("entity.baby_pig.ambient");
   public static final Holder.Reference PIG_EAT_BABY = registerForHolder("entity.baby_pig.eat");
   public static final Holder.Reference PIG_HURT_BABY = registerForHolder("entity.baby_pig.hurt");
   public static final Holder.Reference PIG_DEATH_BABY = registerForHolder("entity.baby_pig.death");
   public static final Map PIG_SOUNDS = registerPigSoundVariants();
   ...
   public static final Holder.Reference SHOVEL_FLATTEN = registerForHolder("item.shovel.flatten");
   ...
   public static final Holder SULFUR_CUBE_REGULAR_HIT = registerForHolder("entity.sulfur_cube.regular.hit");
   public static final Holder SULFUR_CUBE_REGULAR_PUSH = registerForHolder("entity.sulfur_cube.regular.push");
   public static final Holder SULFUR_CUBE_BOUNCY_HIT = registerForHolder("entity.sulfur_cube.bouncy.hit");
   public static final Holder SULFUR_CUBE_BOUNCY_PUSH = registerForHolder("entity.sulfur_cube.bouncy.push");
   public static final Holder SULFUR_CUBE_SLOW_BOUNCY_HIT = registerForHolder("entity.sulfur_cube.slow_bouncy.hit");
   public static final Holder SULFUR_CUBE_SLOW_BOUNCY_PUSH = registerForHolder("entity.sulfur_cube.slow_bouncy.push");
   public static final Holder SULFUR_CUBE_SLOW_FLAT_HIT = registerForHolder("entity.sulfur_cube.slow_flat.hit");
   public static final Holder SULFUR_CUBE_SLOW_FLAT_PUSH = registerForHolder("entity.sulfur_cube.slow_flat.push");
   public static final Holder SULFUR_CUBE_FAST_FLAT_HIT = registerForHolder("entity.sulfur_cube.fast_flat.hit");
   public static final Holder SULFUR_CUBE_FAST_FLAT_PUSH = registerForHolder("entity.sulfur_cube.fast_flat.push");
   public static final Holder SULFUR_CUBE_LIGHT_HIT = registerForHolder("entity.sulfur_cube.light.hit");
   public static final Holder SULFUR_CUBE_LIGHT_PUSH = registerForHolder("entity.sulfur_cube.light.push");
   public static final Holder SULFUR_CUBE_FAST_SLIDING_HIT = registerForHolder("entity.sulfur_cube.fast_sliding.hit");
   public static final Holder SULFUR_CUBE_FAST_SLIDING_PUSH = registerForHolder("entity.sulfur_cube.fast_sliding.push");
   public static final Holder SULFUR_CUBE_SLOW_SLIDING_HIT = registerForHolder("entity.sulfur_cube.slow_sliding.hit");
   public static final Holder SULFUR_CUBE_SLOW_SLIDING_PUSH = registerForHolder("entity.sulfur_cube.slow_sliding.push");
   public static final Holder SULFUR_CUBE_STICKY_HIT = registerForHolder("entity.sulfur_cube.sticky.hit");
   public static final Holder SULFUR_CUBE_STICKY_PUSH = registerForHolder("entity.sulfur_cube.sticky.push");
   public static final Holder SULFUR_CUBE_HIGH_RESISTANCE_HIT = registerForHolder("entity.sulfur_cube.high_resistance.hit");
   public static final Holder SULFUR_CUBE_HIGH_RESISTANCE_PUSH = registerForHolder("entity.sulfur_cube.high_resistance.push");
   public static final Holder SULFUR_CUBE_EXPLOSIVE_HIT = registerForHolder("entity.sulfur_cube.explosive.hit");
   public static final Holder SULFUR_CUBE_EXPLOSIVE_PUSH = registerForHolder("entity.sulfur_cube.explosive.push");
   public static final Holder SULFUR_CUBE_HOT_HIT = registerForHolder("entity.sulfur_cube.hot.hit");
   public static final Holder SULFUR_CUBE_HOT_PUSH = registerForHolder("entity.sulfur_cube.hot.push");
   ...
   public static final Holder.Reference POPLAR_LEAVES_AMBIENT = registerForHolder("block.poplar_leaves.ambient");
   ...
   private static Map registerChickenSoundVariants() {
   ...
   private static Map registerCowSoundVariants() {
   ...
   private static Map registerPigSoundVariants() {
   ...
   private static Map registerCatSoundVariants() {
