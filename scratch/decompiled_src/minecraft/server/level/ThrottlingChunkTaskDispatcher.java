...
public class ThrottlingChunkTaskDispatcher extends ChunkTaskDispatcher {
   ...
   public String getDebugStatus() {
      return this.executorSchedulerName + "=[" + (String)this.chunkPositionsInExecution.longStream().mapToObj((key) -> key + ":" + String.valueOf(ChunkPos.unpack(key))).collect(Collectors.joining(",")) + "], s=" + this.sleeping;
   }
}
