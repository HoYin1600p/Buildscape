...
public class TutorialToast implements Toast {
   ...
   public TutorialToast(final Font font, final TutorialToast.Icons icon, final Component title, final @Nullable Component message, final boolean progressable, final int timeToDisplayMs) {
      this.icon = icon;
