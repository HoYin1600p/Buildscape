...
public record SingleBlockPillarFeature(BlockStateProvider block, BlockPredicate canReplace, Direction direction, float chanceToContinue, Optional capFeature) implements Feature {
