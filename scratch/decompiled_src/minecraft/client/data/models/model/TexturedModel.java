...
public class TexturedModel {
   ...
   private static TexturedModel.Provider createDefault(final Function mapping, final ModelTemplate template) {
   ...
   public interface Provider {
      ...
      default TexturedModel.Provider updateTexture(final Consumer mutator) {
