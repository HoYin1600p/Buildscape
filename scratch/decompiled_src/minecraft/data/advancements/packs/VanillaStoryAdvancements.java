...
public class VanillaStoryAdvancements extends AdvancementSubProvider {
   ...
   public VanillaStoryAdvancements(final BootstrapContext output) {
      super(output);
