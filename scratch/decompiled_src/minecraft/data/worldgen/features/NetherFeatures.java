...
public class NetherFeatures {
   ...
   public static final ResourceKey NYLIUM_BONEMEAL = FeatureUtils.createKey("nylium_bonemeal");
   ...
   public static final ResourceKey CRIMSON_ROOTS = FeatureUtils.createKey("crimson_roots");
   ...
   public static final ResourceKey FIRE = FeatureUtils.createKey("patch_fire");
   public static final ResourceKey SOUL_FIRE = FeatureUtils.createKey("patch_soul_fire");
