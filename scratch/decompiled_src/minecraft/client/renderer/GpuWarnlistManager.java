...
public class GpuWarnlistManager extends SimplePreparableReloadListener {
   ...
   protected GpuWarnlistManager.Preparations prepare(final ResourceManager manager, final ProfilerFiller profiler) {
      List rendererPatterns = Lists.newArrayList();
      List versionPatterns = Lists.newArrayList();
      List vendorPatterns = Lists.newArrayList();
   ...
   protected static final class Preparations {
      ...
      private static String matchAny(final List patterns, final String input) {
         List allMatches = Lists.newArrayList();
