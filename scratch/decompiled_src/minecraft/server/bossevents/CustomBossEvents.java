...
public class CustomBossEvents extends SavedData {
   private static final Codec EVENTS_CODEC = Codec.unboundedMap(Identifier.CODEC, CustomBossEvent.Packed.CODEC);
   private static final Codec CODEC = EVENTS_CODEC.xmap((events) -> {
   ...
   public static final SavedDataType TYPE = new SavedDataType(Identifier.withDefaultNamespace("custom_boss_events"), CustomBossEvents::new, CODEC, DataFixTypes.SAVED_DATA_CUSTOM_BOSS_EVENTS);
