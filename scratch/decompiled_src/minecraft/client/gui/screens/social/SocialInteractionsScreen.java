   ...
   private void showPage(final SocialInteractionsScreen.Page page) {
      ...
      switch (page.ordinal()) {
         case 0:
            ...
            Collection onlinePlayerIds = this.minecraft.player.connection.getOnlinePlayerIds();
         ...
         case 1:
            ...
            Set hiddenPlayers = this.minecraft.getPlayerSocialManager().getHiddenPlayers();
         ...
         case 2:
            ...
            Set blockedPlayers = (Set)this.minecraft.player.connection.getOnlinePlayerIds().stream().filter(socialManager::isBlocked).collect(Collectors.toSet());
