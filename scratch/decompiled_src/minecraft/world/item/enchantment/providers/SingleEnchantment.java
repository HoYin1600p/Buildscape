...
public record SingleEnchantment(Holder enchantment, IntProvider level) implements EnchantmentProvider {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Enchantment.CODEC.fieldOf("enchantment").forGetter(SingleEnchantment::enchantment), IntProviders.CODEC.fieldOf("level").forGetter(SingleEnchantment::level)).apply(i, SingleEnchantment::new));
