...
public class RenderType {
   ...
   public PreparedRenderType prepare() {
      ...
      List textures = this.state.prepareTextures(minecraft.getTextureManager(), RenderSystem.getSamplerCache(), minecraft.gameRenderer.overlayTexture().getTextureView(), minecraft.gameRenderer.lightmap());
   ...
   private GpuBufferSlice writeDynamicTransforms(final Matrix4f modelViewMatrix) {
      Consumer modelViewModifier = this.state.layeringTransform.getModifier();
