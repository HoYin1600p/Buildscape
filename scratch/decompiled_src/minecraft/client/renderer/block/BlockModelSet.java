...
public class BlockModelSet {
   ...
   private final Map blockModelByStateCache = new HashMap();

   public BlockModelSet(final BlockStateModelSet fallback, final Map blockModelByState, final BlockColors blockColors) {
   ...
   private BlockModel createFallbackModel(final BlockState blockState) {
      List tints = this.blockColors.getTintSources(blockState);
