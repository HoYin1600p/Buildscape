...
public class BitStorageAlignFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type blockStateType = DSL.named(References.BLOCK_STATE.typeName(), DSL.remainderType());
      OpticFinder paletteFinder = DSL.fieldFinder("Palette", DSL.list(blockStateType));
