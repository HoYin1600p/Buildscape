...
public class FireworkStarFadeRecipe extends CustomRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.target, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.dye, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, FireworkStarFadeRecipe::new);
