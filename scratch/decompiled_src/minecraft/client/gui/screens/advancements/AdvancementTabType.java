...
public enum AdvancementTabType {
   ...
   private AdvancementTabType(final AdvancementTabType.Sprites selectedSprites, final AdvancementTabType.Sprites unselectedSprites, final int width, final int height, final int max) {
   ...
   public int getX(final int index) {
      ...
      switch (this.ordinal()) {
         case 0:
            var10000 = (this.width + 4) * index;
            break;
         case 1:
            var10000 = (this.width + 4) * index;
            break;
         case 2:
            var10000 = -this.width + 4;
            break;
         case 3:
            var10000 = 248;
            break;
   ...
   public int getY(final int index) {
      ...
      switch (this.ordinal()) {
         case 0:
            var10000 = -this.height + 4;
            break;
         case 1:
            var10000 = 136;
            break;
         case 2:
            var10000 = this.height * index;
            break;
         case 3:
            var10000 = this.height * index;
            break;
