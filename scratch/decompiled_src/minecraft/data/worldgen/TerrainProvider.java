...
public class TerrainProvider {
   ...
   public static CubicSpline overworldOffset(final BoundedFloatFunction continents, final BoundedFloatFunction erosion, final BoundedFloatFunction ridges, final boolean amplified) {
      ...
      CubicSpline beachSpline = buildErosionOffsetSpline(erosion, ridges, -0.15F, 0.0F, 0.0F, 0.1F, 0.0F, -0.03F, false, false, offsetTransformer);
      CubicSpline lowSpline = buildErosionOffsetSpline(erosion, ridges, -0.1F, 0.03F, 0.1F, 0.1F, 0.01F, -0.03F, false, false, offsetTransformer);
      CubicSpline midSpline = buildErosionOffsetSpline(erosion, ridges, -0.1F, 0.03F, 0.1F, 0.7F, 0.01F, -0.03F, true, true, offsetTransformer);
      CubicSpline highSpline = buildErosionOffsetSpline(erosion, ridges, -0.05F, 0.03F, 0.1F, 1.0F, 0.01F, 0.01F, true, true, offsetTransformer);
   ...
   private static CubicSpline buildErosionJaggednessSpline(final BoundedFloatFunction erosion, final BoundedFloatFunction weirdness, final BoundedFloatFunction ridges, final float jaggednessFactorAtPeakRidgeAndErosionIndex0, final float jaggednessFactorAtPeakRidgeAndErosionIndex1, final float jaggednessFactorAtHighRidgeAndErosionIndex0, final float jaggednessFactorAtHighRidgeAndErosionIndex1, final Float2FloatFunction jaggednessTransformer) {
      float erosionIndex1Middle = -0.5775F;
      CubicSpline ridgeJaggednessSplineAtErosion0 = buildRidgeJaggednessSpline(weirdness, ridges, jaggednessFactorAtPeakRidgeAndErosionIndex0, jaggednessFactorAtHighRidgeAndErosionIndex0, jaggednessTransformer);
      CubicSpline ridgeJaggednessSplineAtErosion1 = buildRidgeJaggednessSpline(weirdness, ridges, jaggednessFactorAtPeakRidgeAndErosionIndex1, jaggednessFactorAtHighRidgeAndErosionIndex1, jaggednessTransformer);
   ...
   private static CubicSpline buildRidgeJaggednessSpline(final BoundedFloatFunction weirdness, final BoundedFloatFunction ridges, final float jaggednessFactorAtPeakRidge, final float jaggednessFactorAtHighRidge, final Float2FloatFunction jaggednessTransformer) {
      ...
      CubicSpline.Builder ridgeSpline = CubicSpline.builder(ridges, jaggednessTransformer);
   ...
   private static CubicSpline buildWeirdnessJaggednessSpline(final BoundedFloatFunction weirdness, final float jaggednessFactor, final Float2FloatFunction jaggednessTransformer) {
   ...
   private static CubicSpline getErosionFactor(final BoundedFloatFunction erosion, final BoundedFloatFunction weirdness, final BoundedFloatFunction ridges, final float baseValue, final boolean shatteredTerrain, final Float2FloatFunction factorTransformer) {
   ...
   private static CubicSpline buildMountainRidgeSplineWithPoints(final BoundedFloatFunction ridges, final float modulation, final boolean saddle, final Float2FloatFunction offsetTransformer) {
   ...
   public static CubicSpline buildErosionOffsetSpline(final BoundedFloatFunction erosion, final BoundedFloatFunction ridges, final float lowValley, final float hill, final float tallHill, final float mountainFactor, final float plain, final float swamp, final boolean includeExtremeHills, final boolean saddle, final Float2FloatFunction offsetTransformer) {
      ...
      float plateau = 0.5F;
      CubicSpline veryLowErosionMountains = buildMountainRidgeSplineWithPoints(ridges, Mth.lerp(mountainFactor, 0.6F, 1.5F), saddle, offsetTransformer);
      CubicSpline lowErosionMountains = buildMountainRidgeSplineWithPoints(ridges, Mth.lerp(mountainFactor, 0.6F, 1.0F), saddle, offsetTransformer);
      CubicSpline mountains = buildMountainRidgeSplineWithPoints(ridges, mountainFactor, saddle, offsetTransformer);
      CubicSpline widePlateau = ridgeSpline(ridges, lowValley - 0.15F, 0.5F * mountainFactor, Mth.lerp(0.5F, 0.5F, 0.5F) * mountainFactor, 0.5F * mountainFactor, 0.6F * mountainFactor, 0.5F, offsetTransformer);
      CubicSpline narrowPlateau = ridgeSpline(ridges, lowValley, plain * mountainFactor, hill * mountainFactor, 0.5F * mountainFactor, 0.6F * mountainFactor, 0.5F, offsetTransformer);
      CubicSpline plains = ridgeSpline(ridges, lowValley, plain, plain, hill, tallHill, 0.5F, offsetTransformer);
      CubicSpline plainsFarInland = ridgeSpline(ridges, lowValley, plain, plain, hill, tallHill, 0.5F, offsetTransformer);
      ...
      CubicSpline swamps = ridgeSpline(ridges, -0.02F, swamp, swamp, hill, tallHill, 0.0F, offsetTransformer);
      CubicSpline.Builder builder = CubicSpline.builder(erosion, offsetTransformer).addPoint(-0.85F, veryLowErosionMountains).addPoint(-0.7F, lowErosionMountains).addPoint(-0.4F, mountains).addPoint(-0.35F, widePlateau).addPoint(-0.1F, narrowPlateau).addPoint(0.2F, plains);
   ...
   private static CubicSpline ridgeSpline(final BoundedFloatFunction ridges, final float valley, final float low, final float mid, final float high, final float peaks, final float minValleySteepness, final Float2FloatFunction offsetTransformer) {
