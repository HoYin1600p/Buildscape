...
public enum GraphicsPreset implements StringRepresentable {
   ...
   public void apply(final Minecraft minecraft) {
      ...
      switch (this.ordinal()) {
         case 0:
            ...
            set(screen, minecraft.options.entityDistanceScaling(), 0.75D);
         ...
         case 1:
            ...
            set(screen, minecraft.options.entityDistanceScaling(), 1.0D);
         ...
         case 2:
            ...
            set(screen, minecraft.options.mipmapLevels(), 4);
            set(screen, minecraft.options.entityShadows(), true);
            set(screen, minecraft.options.entityDistanceScaling(), 1.25D);
            set(screen, minecraft.options.menuBackgroundBlurriness(), 5);
   ...
   private static void set(final @Nullable OptionsSubScreen screen, final OptionInstance option, final Object value) {
      if (option.get() != value) {
         option.set(value);
         if (screen != null) {
