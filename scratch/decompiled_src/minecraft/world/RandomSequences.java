...
public class RandomSequences extends SavedData {
   ...
   public static final SavedDataType TYPE = new SavedDataType(Identifier.withDefaultNamespace("random_sequences"), RandomSequences::new, CODEC, DataFixTypes.SAVED_DATA_RANDOM_SEQUENCES);
   private int salt;
   ...
   private class DirtyMarkingRandomSource implements RandomSource {
      ...
      public boolean equals(final Object obj) {
         if (this == obj) {
            ...
            RandomSequences.DirtyMarkingRandomSource other = (RandomSequences.DirtyMarkingRandomSource)obj;
