...
public class BeaconScreen extends AbstractContainerScreen {
   ...
   private void addBeaconButton(final AbstractWidget beaconButton) {
      ...
      this.beaconButtons.add((BeaconScreen.BeaconButton)beaconButton);
   }
   ...
   protected void init() {
      ...
      for(int tier = 0; tier <= 2; ++tier) {
         ...
         for(int c = 0; c < count; ++c) {
            Holder effect = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(tier)).get(c);
            BeaconScreen.BeaconPowerButton beaconPowerButton = new BeaconScreen.BeaconPowerButton(this.leftPos + 76 + c * 24 - totalWidth / 2, this.topPos + 22 + tier * 25, effect, true, tier);
      ...
      for(int c = 0; c < count - 1; ++c) {
         Holder effect = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(3)).get(c);
         BeaconScreen.BeaconPowerButton beaconPowerButton = new BeaconScreen.BeaconPowerButton(this.leftPos + 167 + c * 24 - totalWidth / 2, this.topPos + 47, effect, false, 3);
         beaconPowerButton.active = false;
         this.addBeaconButton(beaconPowerButton);
      }

      Holder dummyEffect = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(0)).get(0);
      BeaconScreen.BeaconPowerButton beaconPowerButton = new BeaconScreen.BeaconUpgradePowerButton(this.leftPos + 167 + (count - 1) * 24 - totalWidth / 2, this.topPos + 47, dummyEffect);
