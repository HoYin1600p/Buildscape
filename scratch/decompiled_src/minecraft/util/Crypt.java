...
public class Crypt {
   ...
   public static final Codec PUBLIC_KEY_CODEC = Codec.STRING.comapFlatMap((rsaString) -> {
      try {
   ...
   public static final Codec PRIVATE_KEY_CODEC = Codec.STRING.comapFlatMap((rsaString) -> {
      try {
   ...
   private static Key rsaStringToKey(String input, final String header, final String footer, final Crypt.ByteArrayToKeyFunction byteArrayToKey) throws CryptException {
