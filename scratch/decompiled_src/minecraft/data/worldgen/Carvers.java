...
public interface Carvers {
   ResourceKey CAVE = createKey("cave");
   ResourceKey CAVE_EXTRA_UNDERGROUND = createKey("cave_extra_underground");
   ResourceKey CANYON = createKey("canyon");
   ResourceKey NETHER_CAVE = createKey("nether_cave");
