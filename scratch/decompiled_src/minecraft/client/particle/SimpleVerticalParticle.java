...
public class SimpleVerticalParticle extends SingleQuadParticle {
   ...
   public static record PauseMobGrowthProvider(SpriteSet sprite) implements ParticleProvider {
   ...
   public static record ResetMobGrowthProvider(SpriteSet sprite) implements ParticleProvider {
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
