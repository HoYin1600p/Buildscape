...
public final class UUIDUtil {
   public static final Codec CODEC = Codec.INT_STREAM.comapFlatMap((list) -> Util.fixedSize(list, 4).map(UUIDUtil::uuidFromIntArray), (uuid) -> Arrays.stream(uuidToIntArray(uuid)));
   public static final Codec CODEC_SET = Codec.list(CODEC).xmap(Sets::newHashSet, Lists::newArrayList);
   public static final Codec CODEC_LINKED_SET = Codec.list(CODEC).xmap(Sets::newLinkedHashSet, Lists::newArrayList);
   public static final Codec STRING_CODEC = Codec.STRING.comapFlatMap((s) -> {
      try {
   ...
   public static final Codec AUTHLIB_CODEC = Codec.withAlternative(Codec.STRING.comapFlatMap((s) -> {
      try {
   ...
   public static final Codec LENIENT_CODEC = Codec.withAlternative(CODEC, STRING_CODEC);
