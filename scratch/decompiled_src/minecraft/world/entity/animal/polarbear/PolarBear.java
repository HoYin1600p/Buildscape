...
public class PolarBear extends Animal implements NeutralMob {
   ...
   public @Nullable AgeableMob getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      return (AgeableMob)EntityTypes.POLAR_BEAR.create(level, EntitySpawnReason.BREEDING);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new PanicGoal(this, 2.0D, (bear) -> bear.isBaby() ? DamageTypeTags.PANIC_CAUSES : DamageTypeTags.PANIC_ENVIRONMENTAL_CAUSES));
   ...
   private class PolarBearAttackPlayersGoal extends NearestAttackableTargetGoal {
      ...
      public boolean canUse() {
         if (PolarBear.this.isBaby()) {
            ...
            if (super.canUse()) {
               for(PolarBear bear : PolarBear.this.level().getEntitiesOfClass(PolarBear.class, PolarBear.this.getBoundingBox().inflate(8.0D, 4.0D, 8.0D))) {
                  if (bear.isBaby()) {
                     return true;
                  }
               }
