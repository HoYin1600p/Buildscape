...
Think Outside the Box                       | Craft Cardboard Block                              | <---X--->                            | <---X--->
Bookworm                                    | Obtain a Big Book                                  | <---X--->                            | <---X--->
Light Reading                               | Obtain a Glowing Big Book                          | <---X--->                            | <---X--->
Shear Genius                                | Obtain a Wallpaper Block                           | <---X--->                            | <---X--->
The Entire Catalogue                        | Obtain all 16 Colors of Wallpaper                  | <---X--->                            | <---X--->
The Homemaker Cometh                        | Interact with a Wandering Homemaker                | <---X--->                            | <---X--->
It's Beginning to Look a Lot Like Christmas | Interact with the Festive Wandering Homemaker      | <---X--->                            | <---X--->
Pocket Full of Blocks                       | Obtain the Builder's Pouch                         | <---X--->                            | <---X--->
String Theory                               | Obtain a Spool                                     | <---X--->                            | <---X--->
String Me Along                             | Obtain every Spool color                           | <---X--->                            | <---X--->
Brick by Brick                              | Place a Stained Brick                              | <---X--->                            | <---X--->
Support System                              | Place 4 Pillars of same Type                       | <---X--->                            | <---X--->
That's a Tall Order                         | Build a Pillar at least 50 blocks tall             | <---X--->                            | <---X--->
Can I Interest You in a Jar?                | Craft a Jar                                        | <---X--->                            | <---X--->
I Vented                                    | Place 10 Hollow Logs                               | <---X--->                            | <---X--->
