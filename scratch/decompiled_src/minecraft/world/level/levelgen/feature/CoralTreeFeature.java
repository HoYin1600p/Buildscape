...
public record CoralTreeFeature(Holder feature) implements Feature {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(PlacedFeature.CODEC.fieldOf("feature").forGetter(CoralTreeFeature::feature)).apply(i, CoralTreeFeature::new));
