...
public class OptionsList extends ContainerObjectSelectionList {
   ...
   protected static class Entry extends OptionsList.AbstractEntry {
      ...
      public static OptionsList.Entry big(final AbstractWidget widget, final Screen screen) {
         widget.setWidth(310);
         return new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(widget, (OptionInstance)null)), screen);
      }
      ...
      public static OptionsList.Entry small(final AbstractWidget leftWidget, final @Nullable AbstractWidget rightWidget, final Screen screen) {
         return rightWidget == null ? new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(leftWidget)), screen) : new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(leftWidget), new OptionsList.OptionInstanceWidget(rightWidget)), screen);
      }

      public static OptionsList.Entry small(final AbstractWidget leftWidget, final OptionInstance leftWidgetOptionInstance, final @Nullable AbstractWidget rightWidget, final Screen screen) {
         return rightWidget == null ? new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(leftWidget, leftWidgetOptionInstance)), screen) : new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(leftWidget, leftWidgetOptionInstance), new OptionsList.OptionInstanceWidget(rightWidget)), screen);
      }

      public static OptionsList.Entry small(final Options options, final OptionInstance optionA, final @Nullable OptionInstance optionB, final OptionsSubScreen screen) {
         AbstractWidget buttonA = optionA.createButton(options);
         return optionB == null ? new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(buttonA, optionA)), screen) : new OptionsList.Entry(List.of(new OptionsList.OptionInstanceWidget(buttonA, optionA), new OptionsList.OptionInstanceWidget(optionB.createButton(options), optionB)), screen);
      }
