...
public class BlockEntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public BlockEntityRenderDispatcher(final Font font, final Supplier entityModelSet, final BlockModelResolver blockModelResolver, final ItemModelResolver itemModelResolver, final EntityRenderDispatcher entityRenderer, final SpriteGetter sprites, final PlayerSkinRenderCache playerSkinRenderCache) {
   ...
   public @Nullable BlockEntityRenderState tryExtractRenderState(final BlockEntity blockEntity, final float partialTicks, final ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress, final boolean isGloballyRendered) {
      BlockEntityRenderer renderer = this.getRenderer(blockEntity);
      if (renderer == null) {
         return null;
         ...
         if (isGloballyRendered != renderer.shouldRenderOffScreen()) {
            ...
            BlockEntityRenderState state = (S)renderer.createRenderState();
