...
public class ClearInventoryCommands {
   ...
   private static final CommandResponseTracker.Messages RESPONSE_TEST = CommandResponseTracker.messages((player, totalValue) -> Component.translatable("commands.clear.test.single", totalValue, player.getDisplayName()), (playerCount, totalValue) -> Component.translatable("commands.clear.test.multiple", totalValue, playerCount));
   private static final CommandResponseTracker.Messages RESPONSE_CLEAR = CommandResponseTracker.messages((player, totalValue) -> Component.translatable("commands.clear.success.single", totalValue, player.getDisplayName()), (playerCount, totalValue) -> Component.translatable("commands.clear.success.multiple", totalValue, playerCount));
   private static final CommandResponseTracker.Dispatch ERROR_DISPATCH = new CommandResponseTracker.Dispatch((player, var1) -> ERROR_SINGLE.create(player.getDisplayName()), (playerCount, var1) -> ERROR_MULTIPLE.create(playerCount));
