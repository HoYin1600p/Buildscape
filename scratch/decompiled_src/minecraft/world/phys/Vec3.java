...
public class Vec3 implements Position {
   public static final Codec CODEC = Codec.DOUBLE.listOf().comapFlatMap((input) -> Util.fixedSize(input, 3).map((doubles) -> new Vec3(doubles.get(0), doubles.get(1), doubles.get(2))), (pos) -> List.of(pos.x(), pos.y(), pos.z()));
   ...
   public static final StreamCodec LP_STREAM_CODEC = StreamCodec.of(LpVec3::write, LpVec3::read);
   ...
   public static Vec3 atCenterOfWithY(final Vec3i pos, final double y) {
      return new Vec3((double)pos.getX() + 0.5D, y, (double)pos.getZ() + 0.5D);
   }
