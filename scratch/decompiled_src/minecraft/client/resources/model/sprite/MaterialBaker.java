...
public class MaterialBaker {
   ...
   private final Multimap missingSprites = Multimaps.synchronizedMultimap(HashMultimap.create());
   private final Multimap missingReferences = Multimaps.synchronizedMultimap(HashMultimap.create());
   private final Map bakedMaterials = new ConcurrentHashMap();
   private final Function bakerFunction = this::bake;
