...
public class CatSoundVariants {
   public static final ResourceKey CLASSIC = createKey(CatSoundVariants.SoundSet.CLASSIC);
   public static final ResourceKey ROYAL = createKey(CatSoundVariants.SoundSet.ROYAL);

   private static ResourceKey createKey(final CatSoundVariants.SoundSet catSoundVariant) {
   ...
   private static void register(final BootstrapContext context, final ResourceKey key, final CatSoundVariants.SoundSet CatSoundVariant) {
   ...
   public static enum SoundSet {
      ...
      // $FF: synthetic method
      private static CatSoundVariants.SoundSet[] $values() {
         return new CatSoundVariants.SoundSet[]{CLASSIC, ROYAL};
      }
   }
}
