...
public class EntityDataAccessor implements DataAccessor {
   ...
   public static final ArgProvider.Factory PROVIDER = (arg) -> ArgProvider.create("entity", () -> Commands.argument(arg, EntityArgument.entity()), (c) -> new EntityDataAccessor(EntityArgument.getEntity(c, arg)));
