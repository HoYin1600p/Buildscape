...
public class MenuTabBar extends TabNavigationBar {
   ...
   public MenuTabBar(final int x, final int y, final int width, final int height, final TabManager tabManager, final ImmutableList tabButtons, final ImmutableList tabs) {
