...
public class FlatLayerInfo {
   public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(Codec.intRange(0, DimensionType.Y_SIZE).fieldOf("height").forGetter(FlatLayerInfo::getHeight), BuiltInRegistries.BLOCK.holderByNameCodec().fieldOf("block").forGetter((l) -> l.block)).apply(i, FlatLayerInfo::new));
   ...
   public FlatLayerInfo(final int height, final Holder block) {
      this.height = height;
      this.block = block;
   }
