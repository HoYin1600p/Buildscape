...
public class MushroomCowRenderer extends AgeableMobRenderer {
   ...
   private static final Map TEXTURES = (Map)Util.make(Maps.newHashMap(), (map) -> {
      map.put(MushroomCow.Variant.BROWN, new MushroomCowRenderer.MushroomCowTexture(Identifier.withDefaultNamespace("textures/entity/cow/mooshroom_brown.png"), Identifier.withDefaultNamespace("textures/entity/cow/mooshroom_brown_baby.png")));
      map.put(MushroomCow.Variant.RED, new MushroomCowRenderer.MushroomCowTexture(Identifier.withDefaultNamespace("textures/entity/cow/mooshroom_red.png"), Identifier.withDefaultNamespace("textures/entity/cow/mooshroom_red_baby.png")));
   });
   ...
   public Identifier getTextureLocation(final MushroomCowRenderState state) {
      return state.isBaby ? ((MushroomCowRenderer.MushroomCowTexture)TEXTURES.get(state.variant)).baby : ((MushroomCowRenderer.MushroomCowTexture)TEXTURES.get(state.variant)).adult;
   }
