...
public class PlacementUtils {
   ...
   public static PlacementModifier countExtra(final int count, final float chance, final int extra) {
      ...
      if (Math.abs(weight - (float)((int)weight)) > 1.0E-5F) {
         ...
         WeightedList distribution = WeightedList.builder().add(ConstantInt.of(count), (int)weight - 1).add(ConstantInt.of(count + extra), 1).build();
   ...
   public static Holder inlinePlaced(final Holder feature, final List placementModifiers) {
      return Holder.direct(new PlacedFeature(feature, placementModifiers));
   }

   public static Holder inlinePlaced(final Holder feature, final PlacementModifier... placementModifiers) {
      return inlinePlaced(feature, List.of(placementModifiers));
   }

   public static Holder inlinePlaced(final Feature feature, final PlacementModifier... placementModifiers) {
      return inlinePlaced(Holder.direct(feature), placementModifiers);
   }

   public static Holder inlinePlaced(final Feature feature, final List placementModifiers) {
      return inlinePlaced(Holder.direct(feature), placementModifiers);
   }
}
