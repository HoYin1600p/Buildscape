...
public interface TestEnvironmentDefinition {
   ...
   Codec CODEC = RegistryCodecs.holder(Registries.TEST_ENVIRONMENT, DIRECT_CODEC);
   ...
   static MapCodec bootstrap(final Registry registry) {
      ...
      return (MapCodec)Registry.register(registry, "weather", TestEnvironmentDefinition.Weather.CODEC);
   }
   ...
   static TestEnvironmentDefinition.Activation activate(final TestEnvironmentDefinition environment, final ServerLevel level) {
   ...
   public static record AllOf(List definitions) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(TestEnvironmentDefinition.CODEC.listOf().fieldOf("definitions").forGetter(TestEnvironmentDefinition.AllOf::definitions)).apply(i, TestEnvironmentDefinition.AllOf::new));
   ...
   public static record ClockTime(Holder clock, int time) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(WorldClock.CODEC.fieldOf("clock").forGetter(TestEnvironmentDefinition.ClockTime::clock), ExtraCodecs.NON_NEGATIVE_INT.fieldOf("time").forGetter(TestEnvironmentDefinition.ClockTime::time)).apply(i, TestEnvironmentDefinition.ClockTime::new));
   ...
   public static record Functions(Optional setupFunction, Optional teardownFunction) implements TestEnvironmentDefinition {
      ...
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Identifier.CODEC.optionalFieldOf("setup").forGetter(TestEnvironmentDefinition.Functions::setupFunction), Identifier.CODEC.optionalFieldOf("teardown").forGetter(TestEnvironmentDefinition.Functions::teardownFunction)).apply(i, TestEnvironmentDefinition.Functions::new));
      ...
      private static void run(final ServerLevel level, final Identifier functionId) {
         ...
         Optional function = functions.get(functionId);
   ...
   public static record SetDifficulty(Difficulty difficulty) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Difficulty.CODEC.fieldOf("difficulty").forGetter(TestEnvironmentDefinition.SetDifficulty::difficulty)).apply(i, TestEnvironmentDefinition.SetDifficulty::new));
   ...
   public static record SetGameRules(GameRuleMap gameRulesMap) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(GameRuleMap.CODEC.fieldOf("rules").forGetter(TestEnvironmentDefinition.SetGameRules::gameRulesMap)).apply(i, TestEnvironmentDefinition.SetGameRules::new));
   ...
   public static record Timelines(List timelines) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Timeline.CODEC.listOf().fieldOf("timelines").forGetter(TestEnvironmentDefinition.Timelines::timelines)).apply(i, TestEnvironmentDefinition.Timelines::new));
      ...
      public EnvironmentAttributeSystem setup(final ServerLevel level) {
         ...
         for(Holder timeline : this.timelines) {
   ...
   public static record Weather(TestEnvironmentDefinition.Weather.Type weather) implements TestEnvironmentDefinition {
      public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(TestEnvironmentDefinition.Weather.Type.CODEC.fieldOf("weather").forGetter(TestEnvironmentDefinition.Weather::weather)).apply(i, TestEnvironmentDefinition.Weather::new));
      ...
      public static enum Type implements StringRepresentable {
         ...
         public static final Codec CODEC = StringRepresentable.fromEnum(TestEnvironmentDefinition.Weather.Type::values);
