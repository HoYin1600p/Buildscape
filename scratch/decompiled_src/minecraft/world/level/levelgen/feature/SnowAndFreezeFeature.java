...
public record SnowAndFreezeFeature() implements Feature {
   public static final MapCodec CODEC = MapCodec.unit(SnowAndFreezeFeature::new);
         ...
         for(int dz = 0; dz < 16; ++dz) {
            ...
            if (biome.shouldSnow(level, topPos)) {
               ...
               if (belowState.hasProperty(SnowyBlock.SNOWY)) {
                  level.setBlock(belowPos, (BlockState)belowState.setValue(SnowyBlock.SNOWY, Boolean.valueOf(true)), 2);
               }
            }
         }
      }
