...
public class LoadedBlockModels {
   ...
   private final Map unbakedModels;
   private final EntityModelSet entityModelSet;
   private final SpriteGetter sprites;
   private final PlayerSkinRenderCache playerSkinRenderCache;

   public LoadedBlockModels(final Map unbakedModels, final EntityModelSet entityModelSet, final SpriteGetter sprites, final PlayerSkinRenderCache playerSkinRenderCache) {
   ...
   public CompletableFuture bake(final Function bakedBlockStateModels, final BlockStateModel missingModel, final Executor executor) {
