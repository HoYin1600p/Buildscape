...
public class TreeFeatures {
   ...
   public static final ResourceKey RED_POPLAR = FeatureUtils.createKey("red_poplar");
   public static final ResourceKey ORANGE_POPLAR = FeatureUtils.createKey("orange_poplar");
   public static final ResourceKey YELLOW_POPLAR = FeatureUtils.createKey("yellow_poplar");
   public static final ResourceKey RED_POPLAR_LEAF_LITTER = FeatureUtils.createKey("red_poplar_leaf_litter");
   public static final ResourceKey ORANGE_POPLAR_LEAF_LITTER = FeatureUtils.createKey("orange_poplar_leaf_litter");
   public static final ResourceKey YELLOW_POPLAR_LEAF_LITTER = FeatureUtils.createKey("yellow_poplar_leaf_litter");
   ...
   public static final ResourceKey FALLEN_POPLAR_TREE = FeatureUtils.createKey("fallen_poplar_tree");
