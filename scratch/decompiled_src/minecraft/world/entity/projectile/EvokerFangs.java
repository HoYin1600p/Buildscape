         ...
         if (this.clientSideAttackStarted) {
            ...
            if (this.lifeTicks == 14) {
               for(int i = 0; i < 12; ++i) {
                  ...
                  double xd = (this.random.nextDouble() * 2.0D - 1.0D) * 0.3D;
                  double yd = 0.3D + this.random.nextDouble() * 0.3D;
                  double zd = (this.random.nextDouble() * 2.0D - 1.0D) * 0.3D;
                  this.level().addParticle(ParticleTypes.CRIT, x, y + 1.0D, z, xd, yd, zd);
               }
            }
         }
