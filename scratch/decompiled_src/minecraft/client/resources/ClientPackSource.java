...
public class ClientPackSource extends BuiltInPackSource {
   ...
   private static final Map SPECIAL_PACK_NAMES = Map.of("programmer_art", Component.translatable("resourcePack.programmer_art.name"), "high_contrast", Component.translatable("resourcePack.high_contrast.name"));
