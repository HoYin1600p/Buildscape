...
public class BlockModelLighter {
   ...
   private static final ThreadLocal CACHE = ThreadLocal.withInitial(BlockModelLighter.Cache::new);
   ...
   private void prepareQuadShape(final BlockAndTintGetter level, final BlockState state, final BlockPos pos, final BakedQuad quad, final boolean ambientOcclusion) {
      ...
      switch (quad.direction()) {
         case DOWN:
            var10001 = minY == maxY && (minY < 1.0E-4F || state.isCollisionShapeFullBlock(level, pos));
            break;
         case UP:
            var10001 = minY == maxY && (maxY > 0.9999F || state.isCollisionShapeFullBlock(level, pos));
            break;
         case NORTH:
            var10001 = minZ == maxZ && (minZ < 1.0E-4F || state.isCollisionShapeFullBlock(level, pos));
            break;
         case SOUTH:
            var10001 = minZ == maxZ && (maxZ > 0.9999F || state.isCollisionShapeFullBlock(level, pos));
            break;
         case WEST:
            var10001 = minX == maxX && (minX < 1.0E-4F || state.isCollisionShapeFullBlock(level, pos));
            break;
         case EAST:
            var10001 = minX == maxX && (maxX > 0.9999F || state.isCollisionShapeFullBlock(level, pos));
            break;
         default:
            throw new MatchException((String)null, (Throwable)null);
      }
   ...
   private static enum AdjacencyInfo {
      DOWN(new Direction[]{Direction.WEST, Direction.EAST, Direction.NORTH, Direction.SOUTH}, 0.5F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.SOUTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.SOUTH}),
      UP(new Direction[]{Direction.EAST, Direction.WEST, Direction.NORTH, Direction.SOUTH}, 1.0F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.SOUTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.SOUTH}),
      NORTH(new Direction[]{Direction.UP, Direction.DOWN, Direction.EAST, Direction.WEST}, 0.8F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_WEST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_EAST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_EAST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_WEST}),
      SOUTH(new Direction[]{Direction.WEST, Direction.EAST, Direction.DOWN, Direction.UP}, 0.8F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.WEST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_WEST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.WEST, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.WEST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.EAST}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_EAST, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.EAST, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.EAST}),
      WEST(new Direction[]{Direction.UP, Direction.DOWN, Direction.NORTH, Direction.SOUTH}, 0.6F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.SOUTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.SOUTH}),
      EAST(new Direction[]{Direction.DOWN, Direction.UP, Direction.NORTH, Direction.SOUTH}, 0.6F, true, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.SOUTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.FLIP_DOWN, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.DOWN, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.NORTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_NORTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.NORTH}, new BlockModelLighter.SizeInfo[]{BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.SOUTH, BlockModelLighter.SizeInfo.FLIP_UP, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.FLIP_SOUTH, BlockModelLighter.SizeInfo.UP, BlockModelLighter.SizeInfo.SOUTH});
      ...
      private static final BlockModelLighter.AdjacencyInfo[] BY_FACING = (BlockModelLighter.AdjacencyInfo[])Util.make(new BlockModelLighter.AdjacencyInfo[6], (map) -> {
      ...
      private AdjacencyInfo(final Direction[] corners, final float shadeWeight, final boolean doNonCubicWeight, final BlockModelLighter.SizeInfo[] vert0Weights, final BlockModelLighter.SizeInfo[] vert1Weights, final BlockModelLighter.SizeInfo[] vert2Weights, final BlockModelLighter.SizeInfo[] vert3Weights) {
      ...
      // $FF: synthetic method
      private static BlockModelLighter.AdjacencyInfo[] $values() {
         return new BlockModelLighter.AdjacencyInfo[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};
      }
   }
   ...
   private static enum AmbientVertexRemap {
      ...
      private static final BlockModelLighter.AmbientVertexRemap[] BY_FACING = (BlockModelLighter.AmbientVertexRemap[])Util.make(new BlockModelLighter.AmbientVertexRemap[6], (map) -> {
         map[Direction.DOWN.get3DDataValue()] = DOWN;
         map[Direction.UP.get3DDataValue()] = UP;
         map[Direction.NORTH.get3DDataValue()] = NORTH;
         map[Direction.SOUTH.get3DDataValue()] = SOUTH;
      ...
      // $FF: synthetic method
      private static BlockModelLighter.AmbientVertexRemap[] $values() {
         return new BlockModelLighter.AmbientVertexRemap[]{DOWN, UP, NORTH, SOUTH, WEST, EAST};
      }
   }
   ...
   private static enum SizeInfo {
      ...
      // $FF: synthetic method
      private static BlockModelLighter.SizeInfo[] $values() {
         return new BlockModelLighter.SizeInfo[]{DOWN, UP, NORTH, SOUTH, WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST};
      }
   }
}
