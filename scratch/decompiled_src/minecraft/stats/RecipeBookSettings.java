...
public final class RecipeBookSettings {
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(RecipeBookSettings.TypeSettings.STREAM_CODEC, (o) -> o.crafting, RecipeBookSettings.TypeSettings.STREAM_CODEC, (o) -> o.furnace, RecipeBookSettings.TypeSettings.STREAM_CODEC, (o) -> o.blastFurnace, RecipeBookSettings.TypeSettings.STREAM_CODEC, (o) -> o.smoker, RecipeBookSettings::new);
   ...
   private RecipeBookSettings(final RecipeBookSettings.TypeSettings crafting, final RecipeBookSettings.TypeSettings furnace, final RecipeBookSettings.TypeSettings blastFurnace, final RecipeBookSettings.TypeSettings smoker) {
   ...
   public static record TypeSettings(boolean open, boolean filtering) {
      ...
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.BOOL, RecipeBookSettings.TypeSettings::open, ByteBufCodecs.BOOL, RecipeBookSettings.TypeSettings::filtering, RecipeBookSettings.TypeSettings::new);
      ...
      private static MapCodec codec(final String openFieldName, final String filteringFieldName) {
         return RecordCodecBuilder.mapCodec((i) -> i.group(Codec.BOOL.optionalFieldOf(openFieldName, false).forGetter(RecipeBookSettings.TypeSettings::open), Codec.BOOL.optionalFieldOf(filteringFieldName, false).forGetter(RecipeBookSettings.TypeSettings::filtering)).apply(i, RecipeBookSettings.TypeSettings::new));
      }
   }
}
