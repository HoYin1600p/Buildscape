...
public class ReportReasonSelectionScreen extends Screen {
   ...
   protected void init() {
      ...
      this.reasonSelectionList = (ReportReasonSelectionScreen.ReasonSelectionList)content.addChild(new ReportReasonSelectionScreen.ReasonSelectionList(this.minecraft));
      ReportReasonSelectionScreen.ReasonSelectionList.Entry selectedEntry = (ReportReasonSelectionScreen.ReasonSelectionList.Entry)Optionull.map(this.currentlySelectedReason, this.reasonSelectionList::findEntry);
      ...
      footer.addChild(Button.builder(CommonComponents.GUI_DONE, (button) -> {
         ReportReasonSelectionScreen.ReasonSelectionList.Entry selected = (ReportReasonSelectionScreen.ReasonSelectionList.Entry)this.reasonSelectionList.getSelected();
         if (selected != null) {
   ...
   public void extractRenderState(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
      ...
      ReportReasonSelectionScreen.ReasonSelectionList.Entry selectedEntry = (ReportReasonSelectionScreen.ReasonSelectionList.Entry)this.reasonSelectionList.getSelected();
   ...
   // $FF: synthetic method
   static Font access$000(ReportReasonSelectionScreen x0) {
      return x0.font;
   }
   ...
   public class ReasonSelectionList extends ObjectSelectionList {
      ...
      public ReportReasonSelectionScreen.ReasonSelectionList.@Nullable Entry findEntry(final ReportReason reason) {
         return (ReportReasonSelectionScreen.ReasonSelectionList.Entry)this.children().stream().filter((entry) -> entry.reason == reason).findFirst().orElse((Object)null);
      }
