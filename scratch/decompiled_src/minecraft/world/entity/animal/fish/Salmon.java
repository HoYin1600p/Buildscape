...
public class Salmon extends AbstractSchoolingFish {
   ...
   private static final EntityDataAccessor DATA_TYPE = SynchedEntityData.defineId(Salmon.class, EntityDataSerializers.INT);
   ...
   public static enum Variant implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(Salmon.Variant::values);
      private static final IntFunction BY_ID = ByIdMap.continuous(Salmon.Variant::id, values(), ByIdMap.OutOfBoundsStrategy.CLAMP);
      public static final StreamCodec STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, Salmon.Variant::id);
