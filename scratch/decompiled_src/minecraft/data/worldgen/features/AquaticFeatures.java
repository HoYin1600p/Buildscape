...
public class AquaticFeatures {
   ...
   public static final ResourceKey CORAL_BLOCK_DECORATION = FeatureUtils.createKey("coral/block_decoration");
   public static final ResourceKey TUBE_CORAL_BLOCK = FeatureUtils.createKey("coral/tube_block");
   public static final ResourceKey BRAIN_CORAL_BLOCK = FeatureUtils.createKey("coral/brain_block");
   public static final ResourceKey BUBBLE_CORAL_BLOCK = FeatureUtils.createKey("coral/bubble_block");
   public static final ResourceKey FIRE_CORAL_BLOCK = FeatureUtils.createKey("coral/fire_block");
   public static final ResourceKey HORN_CORAL_BLOCK = FeatureUtils.createKey("coral/horn_block");
   ...
   public static void bootstrap(final BootstrapContext context) {
      ...
      HolderGetter features = context.lookup(Registries.FEATURE);
      ...
      Holder.Reference tubeCoralBlock = context.register(TUBE_CORAL_BLOCK, coralBlock(features, blocks.getOrThrow(BlockItemIds.TUBE_CORAL_BLOCK.block())));
      Holder.Reference brainCoralBlock = context.register(BRAIN_CORAL_BLOCK, coralBlock(features, blocks.getOrThrow(BlockItemIds.BRAIN_CORAL_BLOCK.block())));
      Holder.Reference bubbleCoralBlock = context.register(BUBBLE_CORAL_BLOCK, coralBlock(features, blocks.getOrThrow(BlockItemIds.BUBBLE_CORAL_BLOCK.block())));
      Holder.Reference fireCoralBlock = context.register(FIRE_CORAL_BLOCK, coralBlock(features, blocks.getOrThrow(BlockItemIds.FIRE_CORAL_BLOCK.block())));
      Holder.Reference hornCoralBlock = context.register(HORN_CORAL_BLOCK, coralBlock(features, blocks.getOrThrow(BlockItemIds.HORN_CORAL_BLOCK.block())));
   ...
   private static Feature coralBlock(final HolderGetter features, final Holder block) {
      return new OverlayFeature(HolderSet.direct(PlacementUtils.inlinePlaced(new SimpleBlockFeature(BlockStateProvider.simple((Block)block.value()))), PlacementUtils.inlinePlaced(features.getOrThrow(CORAL_BLOCK_DECORATION))));
   }

   private static Holder wallCoral(final HolderGetter blocks, final Direction direction) {
