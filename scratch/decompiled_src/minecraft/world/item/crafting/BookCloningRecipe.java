...
public class BookCloningRecipe extends CustomRecipe {
   ...
   private static final Codec ALLOWED_GENERATION_CODEC = MinMaxBounds.Ints.CODEC.validate(MinMaxBounds.validateContainedInRange(ALLOWED_BOOK_GENERATION_RANGES));
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.source, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.material, MinMaxBounds.Ints.STREAM_CODEC, (o) -> o.allowedGenerations, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, BookCloningRecipe::new);
