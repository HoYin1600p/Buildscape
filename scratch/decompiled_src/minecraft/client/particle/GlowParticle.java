...
public class GlowParticle extends SingleQuadParticle {
   ...
   public static class ElectricSparkProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         GlowParticle glowParticle = new GlowParticle(level, x, y, z, 0.0D, 0.0D, 0.0D, this.sprite);
         glowParticle.setColor(1.0F, 0.9F, 1.0F);
         glowParticle.setParticleSpeed(xAux * 0.25D, yAux * 0.25D, zAux * 0.25D);
         int minLifespan = 2;
         int maxLifespan = 4;
   ...
   public static class GlowSquidProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         GlowParticle glowParticle = new GlowParticle(level, x, y, z, 0.5D - random.nextDouble(), yAux, 0.5D - random.nextDouble(), this.sprite);
         ...
         if (xAux == 0.0D && zAux == 0.0D) {
            glowParticle.xd *= (double)0.1F;
            glowParticle.zd *= (double)0.1F;
         }

         glowParticle.setLifetime((int)(8.0D / (random.nextDouble() * 0.8D + 0.2D)));
         return glowParticle;
      }
   }
   ...
   public static class ScrapeProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         ...
         glowParticle.setParticleSpeed(xAux * 0.01D, yAux * 0.01D, zAux * 0.01D);
         int minLifespan = 10;
         int maxLifespan = 40;
   ...
   public static class WaxOffProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         GlowParticle glowParticle = new GlowParticle(level, x, y, z, 0.0D, 0.0D, 0.0D, this.sprite);
         glowParticle.setColor(1.0F, 0.9F, 1.0F);
         glowParticle.setParticleSpeed(xAux * 0.01D / 2.0D, yAux * 0.01D, zAux * 0.01D / 2.0D);
         int minLifespan = 10;
         int maxLifespan = 40;
         glowParticle.setLifetime(random.nextInt(30) + 10);
         return glowParticle;
