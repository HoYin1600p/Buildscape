...
public class SmithingTransformRecipe extends SimpleSmithingRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Recipe.CommonInfo.STREAM_CODEC, (o) -> o.commonInfo, Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, (o) -> o.template, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.base, Ingredient.OPTIONAL_CONTENTS_STREAM_CODEC, (o) -> o.addition, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, SmithingTransformRecipe::new);
