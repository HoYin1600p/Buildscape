...
public class ChatScreen extends Screen {
   ...
   protected boolean shouldDiscardDraft() {
      return this.exitReason != ChatScreen.ExitReason.INTERRUPTED && (this.exitReason != ChatScreen.ExitReason.INTENTIONAL || !this.minecraft.options.saveChatDrafts().get());
   }
   ...
   public boolean mouseScrolled(final double x, final double y, final double scrollX, double scrollY) {
      scrollY = Mth.clamp(scrollY, -1.0D, 1.0D);
