...
public class AdvancementTree {
   ...
   public void addAll(final Collection advancements) {
      List advancementsToAdd = new ArrayList(advancements);
   ...
   private boolean tryInsert(final AdvancementHolder holder) {
      Optional parentId = holder.value().parent();
      AdvancementNode parentNode = (AdvancementNode)parentId.map(this.nodes::get).orElse((Object)null);
