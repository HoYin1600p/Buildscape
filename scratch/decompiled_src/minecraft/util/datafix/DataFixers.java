...
public class DataFixers {
   ...
   private static void addFixers(final DataFixerBuilder fixerUpper, final FileFixerUpper.Builder fileFixerUpper) {
      ...
      UnaryOperator beehiveRenamer = createRenamer("minecraft:bee_hive", "minecraft:beehive");
      ...
      ImmutableMap waxedCopperRename = ImmutableMap.builder().put("minecraft:waxed_copper", "minecraft:waxed_copper_block").put("minecraft:oxidized_copper_block", "minecraft:oxidized_copper").put("minecraft:weathered_copper_block", "minecraft:weathered_copper").put("minecraft:exposed_copper_block", "minecraft:exposed_copper").build();
      ...
      fixerUpper.addFixer(new EntityVariantFix(v3086, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), (m) -> {
      ...
      fixerUpper.addFixer(new EntityVariantFix(v3087, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), (m) -> {
      ...
      Map renamedCatCriteria = Map.of("minecraft:british", "minecraft:british_shorthair");
      ...
      UnaryOperator grassRenamer = createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
      ...
      UnaryOperator scuteRenamer = createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
      ...
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", (value) -> value == 48.0D ? 16.0D : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", (value) -> value == 48.0D ? 16.0D : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", (value) -> value == 48.0D ? 16.0D : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", (value) -> value == 40.0D ? 16.0D : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", (value) -> value == 16.0D ? 12.0D : value));
      fixerUpper.addFixer(new EntityAttributeBaseValueFix(v4187, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", (value) -> value == 16.0D ? 24.0D : value));
