...
public abstract class BlockMatcher {
   private static final Predicate NO_PREDICATE = (var0) -> true;
   protected final LevelReader level;
   protected Predicate statePredicate = NO_PREDICATE;

   public BlockMatcher(final LevelReader levelReader) {
      this.level = levelReader;
   }

   public BlockMatcher filterState(final Predicate predicate) {
   ...
   protected abstract boolean anyMatched(final Predicate statePredicate);
   ...
   public abstract void forEach(final BiConsumer consumer);
