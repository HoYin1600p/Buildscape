...
public class AnvilMenu extends ItemCombinerMenu {
   ...
   public void createResult() {
      ...
      if (!input.isEmpty() && EnchantmentHelper.canStoreEnchantments(input)) {
         ...
         tax += (long)((Integer)input.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue() + (long)((Integer)addition.getOrDefault(DataComponents.REPAIR_COST, Integer.valueOf(0))).intValue();
