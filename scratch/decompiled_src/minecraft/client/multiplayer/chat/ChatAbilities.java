...
public class ChatAbilities {
   ...
   private final Set restrictionReasons;
   private final PermissionSet permissions;
   private final Predicate visibleMessagesFilter;

   private ChatAbilities(final Set restrictionReasons) {
      this.restrictionReasons = restrictionReasons;
      Set permissionSet = new HashSet(Permissions.CHAT_PERMISSIONS);
   ...
   private static Predicate selectVisibleMessages(final ChatAbilities chatAbilities) {
   ...
   public Predicate visibleMessagesFilter() {
      return this.visibleMessagesFilter;
   }

   public static class Builder {
      private final Set restrictions = new HashSet();
