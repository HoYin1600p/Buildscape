...
public record HeightmapPlacement(Heightmap.Types heightmap) implements PlacementModifier {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Heightmap.Types.CODEC.fieldOf("heightmap").forGetter(HeightmapPlacement::heightmap)).apply(i, HeightmapPlacement::new));
