...
public final class EntitySelector {
   ...
   public static final Predicate CAN_BE_COLLIDED_WITH = NO_SPECTATORS.and((entity) -> entity.canBeCollidedWith((Entity)null));
   public static final Predicate CAN_BE_PICKED = Entity::isPickable;
