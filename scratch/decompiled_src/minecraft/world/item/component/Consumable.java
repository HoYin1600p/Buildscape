...
public record Consumable(float consumeSeconds, ItemUseAnimation animation, Holder sound, boolean hasConsumeParticles, List onConsumeEffects) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.FLOAT, Consumable::consumeSeconds, ItemUseAnimation.STREAM_CODEC, Consumable::animation, SoundEvent.STREAM_CODEC, Consumable::sound, ByteBufCodecs.BOOL, Consumable::hasConsumeParticles, ConsumeEffect.STREAM_CODEC.apply(ByteBufCodecs.list()), Consumable::onConsumeEffects, Consumable::new);
   ...
   public void emitParticlesAndSounds(final RandomSource random, final LivingEntity user, final ItemStack itemStack, final int particleCount) {
      ...
      SoundEvent var10000;
      if (user instanceof Consumable.OverrideConsumeSound override) {
   ...
   public static class Builder {
      ...
      private Holder sound = SoundEvents.GENERIC_EAT;
      private boolean hasConsumeParticles = true;
      private final List onConsumeEffects = new ArrayList();
      ...
      public Consumable.Builder sound(final Holder sound) {
         this.sound = sound;
         return this;
      }

      public Consumable.Builder soundAfterConsume(final Holder soundAfterConsume) {
