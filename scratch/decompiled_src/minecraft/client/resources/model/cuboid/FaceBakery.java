...
public class FaceBakery {
   ...
   static CuboidFace.UVs defaultFaceUV(final Vector3fc from, final Vector3fc to, final Direction facing) {
      ...
      switch (facing) {
         case DOWN:
            var10000 = new CuboidFace.UVs(from.x(), 16.0F - to.z(), to.x(), 16.0F - from.z());
            break;
         case UP:
            var10000 = new CuboidFace.UVs(from.x(), from.z(), to.x(), to.z());
            break;
         case NORTH:
            var10000 = new CuboidFace.UVs(16.0F - to.x(), 16.0F - to.y(), 16.0F - from.x(), 16.0F - from.y());
            break;
         case SOUTH:
            var10000 = new CuboidFace.UVs(from.x(), 16.0F - to.y(), to.x(), 16.0F - from.y());
            break;
         case WEST:
            var10000 = new CuboidFace.UVs(from.z(), 16.0F - to.y(), to.z(), 16.0F - from.y());
            break;
         case EAST:
            var10000 = new CuboidFace.UVs(16.0F - to.z(), 16.0F - to.y(), 16.0F - from.z(), 16.0F - from.y());
            break;
         default:
