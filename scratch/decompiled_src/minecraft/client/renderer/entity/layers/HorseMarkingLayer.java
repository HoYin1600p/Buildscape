...
public class HorseMarkingLayer extends RenderLayer {
   ...
   private static final Map LOCATION_BY_MARKINGS = Maps.newEnumMap(Map.of(Markings.NONE, new HorseMarkingLayer.HorseMarkingTextures(INVISIBLE_TEXTURE, INVISIBLE_TEXTURE), Markings.WHITE, new HorseMarkingLayer.HorseMarkingTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_white.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_white_baby.png")), Markings.WHITE_FIELD, new HorseMarkingLayer.HorseMarkingTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_whitefield.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_whitefield_baby.png")), Markings.WHITE_DOTS, new HorseMarkingLayer.HorseMarkingTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_whitedots.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_whitedots_baby.png")), Markings.BLACK_DOTS, new HorseMarkingLayer.HorseMarkingTextures(Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_blackdots.png"), Identifier.withDefaultNamespace("textures/entity/horse/horse_markings_blackdots_baby.png"))));
   ...
   public void submit(final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector, final int lightCoords, final HorseRenderState state, final float yRot, final float xRot) {
      ...
      if (texture != INVISIBLE_TEXTURE && !state.isInvisible) {
         submitNodeCollector.order(1).submitModel(this.getParentModel(), state, poseStack, RenderTypes.entityTranslucent(texture), lightCoords, LivingEntityRenderer.getOverlayCoords(state, 0.0F), state.outlineColor);
      }
   }
