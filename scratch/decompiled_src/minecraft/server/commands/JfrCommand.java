...
public class JfrCommand {
   ...
   private static int stopJfr(final CommandSourceStack source) throws CommandSyntaxException {
      try {
         ...
         Component fileText = Component.literal(savedRecording.toString()).withStyle(ChatFormatting.UNDERLINE).withStyle((style) -> style.withClickEvent(new ClickEvent.CopyToClipboard(clipboardPath.toString())).withHoverEvent(new HoverEvent.ShowText(Component.translatable("chat.copy.click"))));
