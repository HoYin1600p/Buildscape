...
public record ItemCost(Holder item, int count, DataComponentExactPredicate components, ItemStack itemStack) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Item.STREAM_CODEC, ItemCost::item, ByteBufCodecs.VAR_INT, ItemCost::count, DataComponentExactPredicate.STREAM_CODEC, ItemCost::components, ItemCost::new);
