...
public record ItemLore(List lines, List styledLines) implements TooltipProvider {
   ...
   public static final Codec CODEC = ComponentSerialization.CODEC.sizeLimitedListOf(256).xmap(ItemLore::new, ItemLore::lines);
   public static final StreamCodec STREAM_CODEC = ComponentSerialization.STREAM_CODEC.apply(ByteBufCodecs.list(256)).map(ItemLore::new, ItemLore::lines);
   ...
   public ItemLore withLineAdded(final Component component) {
      return new ItemLore(Util.copyAndAdd(this.lines, (Object)component));
   }
