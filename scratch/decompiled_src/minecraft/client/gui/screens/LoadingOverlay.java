...
public class LoadingOverlay extends Overlay {
   ...
   public void extractRenderState(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
      ...
      if (fadeOutAnim >= 1.0F) {
         ...
         int alpha = Mth.ceil(Mth.clamp((double)fadeInAnim, 0.15D, 1.0D) * 255.0D);
         graphics.nextStratum();
         graphics.fill(0, 0, width, height, replaceAlpha(BRAND_BACKGROUND.getAsInt(), alpha));
      ...
      int contentX = (int)((double)graphics.guiWidth() * 0.5D);
      int logoY = (int)((double)graphics.guiHeight() * 0.5D);
      double logoHeight = Math.min((double)graphics.guiWidth() * 0.75D, (double)graphics.guiHeight()) * 0.25D;
      int logoHeightHalf = (int)(logoHeight * 0.5D);
      double contentWidth = logoHeight * 4.0D;
      int logoWidthHalf = (int)(contentWidth * 0.5D);
      ...
      int barY = (int)((double)graphics.guiHeight() * 0.8325D);
