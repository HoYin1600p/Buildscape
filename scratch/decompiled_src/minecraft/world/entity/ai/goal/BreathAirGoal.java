...
public class BreathAirGoal extends Goal {
   ...
   private void findAirPosition() {
      Iterable between = BlockPos.neighborColumn(this.mob.getBlockX(), this.mob.getBlockY(), this.mob.getBlockZ(), this.mob.getBlockY() + 8);
      ...
      if (destinationPos == null) {
         destinationPos = BlockPos.containing(this.mob.getX(), this.mob.getY() + 8.0D, this.mob.getZ());
      }

      this.mob.getNavigation().moveTo((double)destinationPos.getX(), (double)(destinationPos.getY() + 1), (double)destinationPos.getZ(), 1.0D);
   }
