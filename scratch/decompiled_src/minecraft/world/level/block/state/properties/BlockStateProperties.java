...
public class BlockStateProperties {
   ...
   public static final EnumProperty HORIZONTAL_AXIS = EnumProperty.create("axis", Direction.Axis.class, (Enum[])(Direction.Axis.X, Direction.Axis.Z));
   ...
   public static final EnumProperty FACING = EnumProperty.create("facing", Direction.class, Direction.NORTH, Direction.EAST, Direction.SOUTH, Direction.WEST, Direction.UP, Direction.DOWN);
   public static final EnumProperty FACING_HOPPER = EnumProperty.create("facing", Direction.class, (Predicate)((direction) -> direction != Direction.UP));
   public static final EnumProperty HORIZONTAL_FACING = EnumProperty.create("facing", Direction.class, (Predicate)Direction.Plane.HORIZONTAL);
   ...
   public static final EnumProperty ORIENTATION = EnumProperty.create("orientation", FrontAndTop.class);
   ...
   public static final EnumProperty EAST_WALL = EnumProperty.create("east", WallSide.class);
   public static final EnumProperty NORTH_WALL = EnumProperty.create("north", WallSide.class);
   public static final EnumProperty SOUTH_WALL = EnumProperty.create("south", WallSide.class);
   public static final EnumProperty WEST_WALL = EnumProperty.create("west", WallSide.class);
   ...
   public static final EnumProperty SIDE_CHAIN_PART = EnumProperty.create("side_chain", SideChainPart.class);
   public static final EnumProperty RAIL_SHAPE = EnumProperty.create("shape", RailShape.class);
   public static final EnumProperty RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, (Predicate)((railShape) -> railShape != RailShape.NORTH_EAST && railShape != RailShape.NORTH_WEST && railShape != RailShape.SOUTH_EAST && railShape != RailShape.SOUTH_WEST));
   ...
   public static final EnumProperty TILT = EnumProperty.create("tilt", Tilt.class);
   public static final EnumProperty VERTICAL_DIRECTION = EnumProperty.create("vertical_direction", Direction.class, Direction.UP, Direction.DOWN);
   public static final EnumProperty SPELEOTHEM_THICKNESS = EnumProperty.create("thickness", SpeleothemThickness.class);
   public static final EnumProperty SCULK_SENSOR_PHASE = EnumProperty.create("sculk_sensor_phase", SculkSensorPhase.class);
   ...
   public static final EnumProperty TRIAL_SPAWNER_STATE = EnumProperty.create("trial_spawner_state", TrialSpawnerState.class);
   public static final EnumProperty VAULT_STATE = EnumProperty.create("vault_state", VaultState.class);
   public static final EnumProperty CREAKING_HEART_STATE = EnumProperty.create("creaking_heart_state", CreakingHeartState.class);
   public static final BooleanProperty OMINOUS = BooleanProperty.create("ominous");
   public static final EnumProperty TEST_BLOCK_MODE = EnumProperty.create("mode", TestBlockMode.class);
   public static final BooleanProperty MAP = BooleanProperty.create("map");
   public static final EnumProperty COPPER_GOLEM_POSE = EnumProperty.create("copper_golem_pose", CopperGolemStatueBlock.Pose.class);
   public static final EnumProperty POTENT_SULFUR_STATE = EnumProperty.create("potent_sulfur_state", PotentSulfurState.class);
}
