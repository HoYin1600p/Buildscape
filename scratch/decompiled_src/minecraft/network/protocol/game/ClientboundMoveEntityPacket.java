...
public abstract class ClientboundMoveEntityPacket implements MovementPacket {
   ...
   public static class Pos extends ClientboundMoveEntityPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ClientboundMoveEntityPacket.Pos::write, ClientboundMoveEntityPacket.Pos::read);
   ...
   public static class PosRot extends ClientboundMoveEntityPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ClientboundMoveEntityPacket.PosRot::write, ClientboundMoveEntityPacket.PosRot::read);
   ...
   public static class Rot extends ClientboundMoveEntityPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ClientboundMoveEntityPacket.Rot::write, ClientboundMoveEntityPacket.Rot::read);
