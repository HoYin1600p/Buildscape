...
public class EndCubeSpecialRenderer implements NoDataSpecialModelRenderer {
   ...
   public static enum Type implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(EndCubeSpecialRenderer.Type::values);
      ...
      // $FF: synthetic method
      private static EndCubeSpecialRenderer.Type[] $values() {
         return new EndCubeSpecialRenderer.Type[]{PORTAL, GATEWAY};
      }
   }

   public static record Unbaked(EndCubeSpecialRenderer.Type effect) implements NoDataSpecialModelRenderer.Unbaked {
      public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(EndCubeSpecialRenderer.Type.CODEC.fieldOf("effect").forGetter(EndCubeSpecialRenderer.Unbaked::effect)).apply(i, EndCubeSpecialRenderer.Unbaked::new));
      ...
      public SpecialModelRenderer bake(final SpecialModelRenderer.BakingContext context) {
         ...
         switch (this.effect.ordinal()) {
            case 0:
               var10002 = RenderTypes.endPortal();
               break;
            case 1:
               var10002 = RenderTypes.endGateway();
               break;
            default:
