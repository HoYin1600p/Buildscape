...
public class DialogCommand {
   private static final CommandResponseTracker.Messages RESPONSE_SHOW = CommandResponseTracker.messages((player, var1) -> Component.translatable("commands.dialog.show.single", player.getDisplayName()), (playerCount, var1) -> Component.translatable("commands.dialog.show.multiple", playerCount));
   private static final CommandResponseTracker.Messages RESPONSE_CLEAR = CommandResponseTracker.messages((player, var1) -> Component.translatable("commands.dialog.clear.single", player.getDisplayName()), (playerCount, var1) -> Component.translatable("commands.dialog.clear.multiple", playerCount));
   ...
   private static int showDialog(final CommandSourceStack sender, final Collection targets, final Holder dialog) throws CommandSyntaxException {
   ...
   private static int clearDialog(final CommandSourceStack sender, final Collection targets) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
