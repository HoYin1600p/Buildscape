...
public class FileFixOperations {
   ...
   public static ApplyInFolders applyInFolders(final FileRelation applicableFolders, final List operations) {
      return new ApplyInFolders(applicableFolders, operations);
   }

   public static GroupMove groupMove(final Map data, final List move) {
