...
public record SimpleBlockFeature(BlockStateProvider toPlace, boolean scheduleTick) implements Feature {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(BlockStateProvider.CODEC.fieldOf("to_place").forGetter(SimpleBlockFeature::toPlace), Codec.BOOL.optionalFieldOf("schedule_tick", false).forGetter(SimpleBlockFeature::scheduleTick)).apply(i, SimpleBlockFeature::new));
