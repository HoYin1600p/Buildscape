...
public record NoiseBasedCountPlacement(int noiseToCountRatio, double noiseFactor, double noiseOffset) implements RepeatingPlacement {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Codec.INT.fieldOf("noise_to_count_ratio").forGetter(NoiseBasedCountPlacement::noiseToCountRatio), Codec.DOUBLE.fieldOf("noise_factor").forGetter(NoiseBasedCountPlacement::noiseFactor), Codec.DOUBLE.optionalFieldOf("noise_offset", 0.0D).forGetter(NoiseBasedCountPlacement::noiseOffset)).apply(i, NoiseBasedCountPlacement::new));
