...
public class GeodeCrackSettings {
   public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(GeodeFeature.CHANCE_RANGE.optionalFieldOf("generate_crack_chance", 1.0D).forGetter((c) -> c.generateCrackChance), Codec.doubleRange(0.0D, 5.0D).optionalFieldOf("base_crack_size", 2.0D).forGetter((c) -> c.baseCrackSize), Codec.intRange(0, 10).optionalFieldOf("crack_point_offset", 2).forGetter((c) -> c.crackPointOffset)).apply(i, GeodeCrackSettings::new));
