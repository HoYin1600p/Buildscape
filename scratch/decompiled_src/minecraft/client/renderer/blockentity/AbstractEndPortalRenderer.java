...
public abstract class AbstractEndPortalRenderer implements BlockEntityRenderer {
   ...
   private static final Map FACES = Util.makeEnumMap(Direction.class, (direction) -> {
   ...
   private static final List ALL_FACES = List.of(Direction.values());
   ...
   protected static void submitCube(final Collection facesToShow, final RenderType renderType, final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector) {
      submitCube(facesToShow, renderType, poseStack, submitNodeCollector, (vertex) -> {
      });
   }

   private static void submitCube(final Collection facesToShow, final RenderType renderType, final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector, final Consumer vertexDecorator) {
   ...
   public static void getExtents(final Consumer output) {
