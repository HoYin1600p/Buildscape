...
public abstract class HangingEntity extends BlockAttachedEntity {
   private static final EntityDataAccessor DATA_DIRECTION = SynchedEntityData.defineId(HangingEntity.class, EntityDataSerializers.DIRECTION);
   ...
   protected boolean canCoexist(final boolean allowIntersectingSameType) {
      Predicate nonIntersectable = (hangingEntity) -> {
