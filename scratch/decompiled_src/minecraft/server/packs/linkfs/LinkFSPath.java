...
class LinkFSPath implements Path {
   ...
   public boolean startsWith(final Path other) {
      if (other.isAbsolute() != this.isAbsolute()) {
         ...
         if (otherLink.fileSystem != this.fileSystem) {
            ...
            List thisNames = this.pathToRoot();
            List otherNames = otherLink.pathToRoot();
   ...
   LinkFSPath resolveName(final String name) {
      if (isRelativeOrMissing(this.pathContents)) {
         ...
         PathContents child = this.pathContents;
         if (child instanceof PathContents.DirectoryContents) {
            PathContents.DirectoryContents directory = (PathContents.DirectoryContents)child;
