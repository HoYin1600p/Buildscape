...
public class MetricSampler {
   ...
   protected MetricSampler(final String name, final MetricSampler.SamplingPhase samplingPhase, final MetricCategory category, final DoubleSupplier sampler, final @Nullable Runnable beforeTick, final MetricSampler.@Nullable ThresholdTest thresholdTest) {
      this.name = name;
   ...
   public static MetricSampler create(final String name, final MetricCategory category, final DoubleSupplier sampler) {
      return new MetricSampler(name, MetricSampler.SamplingPhase.END_TICK, category, sampler, (Runnable)null, (MetricSampler.ThresholdTest)null);
   }
   ...
   public static MetricSampler createExtractSampler(final String name, final MetricCategory category, final DoubleSupplier sampler) {
      return new MetricSampler(name, MetricSampler.SamplingPhase.EXTRACT, category, sampler, (Runnable)null, (MetricSampler.ThresholdTest)null);
   }

   public static MetricSampler.MetricSamplerBuilder builder(final String metricName, final MetricCategory category, final ToDoubleFunction sampler, final Object context) {
      if (sampler == null) {
   ...
   public static class MetricSamplerBuilder {
      ...
      public MetricSampler.MetricSamplerBuilder withBeforeTick(final Consumer beforeTick) {
         this.beforeTick = () -> beforeTick.accept(this.context);
         return this;
      }

      public MetricSampler.MetricSamplerBuilder withThresholdAlert(final MetricSampler.ThresholdTest thresholdTest) {
         this.thresholdTest = thresholdTest;
         return this;
      }

      public MetricSampler.MetricSamplerBuilder withSamplingPhase(final MetricSampler.SamplingPhase samplingPhase) {
         this.samplingPhase = samplingPhase;
         return this;
      }
   ...
   public static enum SamplingPhase {
      ...
      // $FF: synthetic method
      private static MetricSampler.SamplingPhase[] $values() {
         return new MetricSampler.SamplingPhase[]{EXTRACT, END_TICK};
      }
   }
