...
public class Nautilus extends AbstractNautilus {
   ...
   private static final Brain.Provider BRAIN_PROVIDER = Brain.provider(List.of(MemoryModuleType.ANGRY_AT, MemoryModuleType.ATTACK_TARGET_COOLDOWN), List.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_ADULT, SensorType.NEAREST_PLAYERS, SensorType.HURT_BY, SensorType.NAUTILUS_TEMPTATIONS), (var0) -> NautilusAi.getActivities());
   ...
   public @Nullable Nautilus getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      Nautilus baby = (Nautilus)EntityTypes.NAUTILUS.create(level, EntitySpawnReason.BREEDING);
