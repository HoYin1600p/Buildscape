...
public class HappyGhastAi {
   ...
   private static ActivityData initIdleActivity() {
      return ActivityData.create(Activity.IDLE, ImmutableList.of(Pair.of(1, new FollowTemptation((mob) -> 1.25F, (mob) -> 3.0D, true)), Pair.of(2, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, (mob) -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_PLAYER, true)), Pair.of(3, BabyFollowAdult.create(ADULT_FOLLOW_RANGE, (mob) -> 1.1F, MemoryModuleType.NEAREST_VISIBLE_ADULT, true)), Pair.of(4, new RunOne(ImmutableList.of(Pair.of(RandomStroll.fly(1.0F), 1), Pair.of(SetWalkTargetFromLookTarget.create(1.0F, 3), 1))))));
   }
