...
public class VillagerMakeLove extends Behavior {
   ...
   private boolean isBreedingPossible(final Villager myBody) {
      ...
      Optional breedTarget = brain.getMemory(MemoryModuleType.BREED_TARGET).filter((entity) -> entity.is(EntityTypes.VILLAGER));
