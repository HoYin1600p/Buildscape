...
public class BindGroupLayouts {
   ...
   public static final BindGroupLayout SAMPLER0_SAMPLER2 = BindGroupLayout.builder().withUniform("Sampler0", UniformType.COMBINED_IMAGE_SAMPLER).withUniform("Sampler2", UniformType.COMBINED_IMAGE_SAMPLER).build();
   public static final BindGroupLayout SAMPLER0_SAMPLER1 = BindGroupLayout.builder().withUniform("Sampler0", UniformType.COMBINED_IMAGE_SAMPLER).withUniform("Sampler1", UniformType.COMBINED_IMAGE_SAMPLER).build();
   public static final BindGroupLayout SAMPLER0_SAMPLER1_SAMPLER2 = BindGroupLayout.builder().withUniform("Sampler0", UniformType.COMBINED_IMAGE_SAMPLER).withUniform("Sampler1", UniformType.COMBINED_IMAGE_SAMPLER).withUniform("Sampler2", UniformType.COMBINED_IMAGE_SAMPLER).build();
   ...
   public static final BindGroupLayout DISSOLVE_MASK_SAMPLER = BindGroupLayout.builder().withUniform("DissolveMaskSampler", UniformType.COMBINED_IMAGE_SAMPLER).build();
   ...
   public static final BindGroupLayout CURRENT_SPRITE_NEXT_SPRITE = BindGroupLayout.builder().withUniform("CurrentSprite", UniformType.COMBINED_IMAGE_SAMPLER).withUniform("NextSprite", UniformType.COMBINED_IMAGE_SAMPLER).build();
   ...
   public static final BindGroupLayout DEPTH_BOUNDS_SAMPLER = BindGroupLayout.builder().withUniform("DepthBoundsSampler", UniformType.COMBINED_IMAGE_SAMPLER).build();
