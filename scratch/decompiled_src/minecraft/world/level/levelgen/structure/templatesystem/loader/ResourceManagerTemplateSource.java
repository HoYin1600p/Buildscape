...
public class ResourceManagerTemplateSource extends TemplateSource {
   ...
   public ResourceManagerTemplateSource(final DataFixer fixerUpper, final HolderGetter blockLookup, final ResourceManager resourceManager, final FileToIdConverter fileToIdConverter) {
