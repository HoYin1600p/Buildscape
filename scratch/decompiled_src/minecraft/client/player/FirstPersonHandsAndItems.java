...
public class FirstPersonHandsAndItems {
   ...
   public void extractRenderState(final LocalPlayer player, final float partialTicks, final FirstPersonHandsAndItemsRenderState state) {
      ...
      player.minecraft.getItemModelResolver().updateForTopItem(state.mainHandRenderState, state.mainHandItem, ItemDisplayContext.FIRST_PERSON_RIGHT_HAND, player.level(), player, player.getId() + ItemDisplayContext.FIRST_PERSON_RIGHT_HAND.ordinal());
      player.minecraft.getItemModelResolver().updateForTopItem(state.offHandRenderState, state.offHandItem, ItemDisplayContext.FIRST_PERSON_LEFT_HAND, player.level(), player, player.getId() + ItemDisplayContext.FIRST_PERSON_LEFT_HAND.ordinal());
