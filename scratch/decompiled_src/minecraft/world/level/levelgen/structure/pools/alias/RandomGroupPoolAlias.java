...
public record RandomGroupPoolAlias(WeightedList groups) implements PoolAliasBinding {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(WeightedList.nonEmptyCodec(Codec.list(PoolAliasBinding.CODEC)).fieldOf("groups").forGetter(RandomGroupPoolAlias::groups)).apply(i, RandomGroupPoolAlias::new));
