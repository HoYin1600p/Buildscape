...
public class FluidStateModelSet {
   ...
   private final Map modelByFluid;
   private final FluidModel missingModel;

   public FluidStateModelSet(final Map modelByFluid, final FluidModel missingModel) {
      this.modelByFluid = modelByFluid;
      this.missingModel = missingModel;
   }

   public static Map bake(final MaterialBaker materials) {
