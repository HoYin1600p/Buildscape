...
public class EndFeatures {
   ...
   public static final ResourceKey END_PODIUM_ACTIVE = FeatureUtils.createKey("end_podium_active");
   public static final ResourceKey END_PODIUM_INACTIVE = FeatureUtils.createKey("end_podium_inactive");
