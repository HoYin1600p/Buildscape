...
public class CreativeModeTabs {
   ...
   public static CreativeModeTab bootstrap(final Registry registry) {
      ...
      List gameplayColorOrder = List.of(DyeColor.WHITE, DyeColor.LIGHT_GRAY, DyeColor.GRAY, DyeColor.BLACK, DyeColor.BROWN, DyeColor.RED, DyeColor.ORANGE, DyeColor.YELLOW, DyeColor.LIME, DyeColor.GREEN, DyeColor.CYAN, DyeColor.LIGHT_BLUE, DyeColor.BLUE, DyeColor.PURPLE, DyeColor.MAGENTA, DyeColor.PINK);
      Registry.register(registry, COLORED_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.coloredBlocks")).icon(() -> new ItemStack((ItemLike)Blocks.WOOL.cyan())).displayItems((parameters, coloredBlocks) -> {
      ...
      Registry.register(registry, REDSTONE_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 4).title(Component.translatable("itemGroup.redstone")).icon(() -> new ItemStack(Items.REDSTONE)).displayItems((parameters, redstoneBlocks) -> {
         ...
         redstoneBlocks.accept((ItemLike)Items.WOOL.white());
         ...
         redstoneBlocks.accept((ItemLike)Items.LIGHTNING_ROD.waxed().unaffected());
         ...
         redstoneBlocks.accept((ItemLike)Items.COPPER_CHEST.waxed().unaffected());
      ...
      Registry.register(registry, SEARCH, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 6).title(Component.translatable("itemGroup.search")).icon(() -> new ItemStack(Items.COMPASS)).displayItems((parameters, search) -> {
         Set tempItems = ItemStackLinkedSet.createTypeAndComponentsSet();
      ...
      return (CreativeModeTab)Registry.register(registry, INVENTORY, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 6).title(Component.translatable("itemGroup.inventory")).icon(() -> new ItemStack(Blocks.CHEST)).backgroundTexture(INVENTORY_BACKGROUND).hideTitle().alignedRight().type(CreativeModeTab.Type.INVENTORY).noScrollBar().build());
   }

   private static void registerColoredItems(final CreativeModeTab.Output coloredBlocks, final List gameplayColorOrder, final ColorCollection items) {
      gameplayColorOrder.forEach((color) -> coloredBlocks.accept((ItemLike)items.pick(color)));
   }
   ...
   private static void generateSuspiciousStews(final CreativeModeTab.Output output, final CreativeModeTab.TabVisibility tabVisibility) {
      List effectHolders = SuspiciousEffectHolder.getAllEffectHolders();
      Set stewItems = ItemStackLinkedSet.createTypeAndComponentsSet();
   ...
   private static void generatePresetPaintings(final CreativeModeTab.Output output, final HolderLookup.Provider context, final HolderLookup.RegistryLookup paintings, final Predicate filter, final CreativeModeTab.TabVisibility tabVisibility) {
      RegistryOps ops = context.createSerializationContext(NbtOps.INSTANCE);
   ...
   private static void copperBlockFamilies(final Consumer output) {
