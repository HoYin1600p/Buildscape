...
public class FlyNodeEvaluator extends WalkNodeEvaluator {
   ...
   private Iterable iteratePathfindingStartNodeCandidatePositions(final Mob mob) {
      ...
      boolean isSmallMob = boundingBox.getSize() < 1.0D;
      if (!isSmallMob) {
         ...
         double zPadding = Math.max(0.0D, (double)1.1F - boundingBox.getZsize());
         double xPadding = Math.max(0.0D, (double)1.1F - boundingBox.getXsize());
         double yPadding = Math.max(0.0D, (double)1.1F - boundingBox.getYsize());
