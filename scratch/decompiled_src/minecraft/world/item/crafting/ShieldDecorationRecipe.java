...
public class ShieldDecorationRecipe extends CustomRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.banner, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.target, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, ShieldDecorationRecipe::new);
