...
public class ModelTemplates {
   ...
   public static final ModelTemplate CUBE_BOTTOM_TOP_INDENTED = create("template_cube_bottom_top_indented", TextureSlot.TOP, TextureSlot.BOTTOM, TextureSlot.SIDE);
   ...
   public static final ModelTemplate[] STEMS = (ModelTemplate[])IntStream.range(0, 8).mapToObj((i) -> create("stem_growth" + i, "_stage" + i, TextureSlot.STEM)).toArray((x$0) -> new ModelTemplate[x$0]);
