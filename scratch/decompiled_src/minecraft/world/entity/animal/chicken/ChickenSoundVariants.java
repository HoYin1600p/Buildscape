...
public class ChickenSoundVariants {
   public static final ResourceKey CLASSIC = createKey(ChickenSoundVariants.SoundSet.CLASSIC);
   public static final ResourceKey PICKY = createKey(ChickenSoundVariants.SoundSet.PICKY);

   private static ResourceKey createKey(final ChickenSoundVariants.SoundSet chickenSoundVariant) {
   ...
   private static void register(final BootstrapContext context, final ResourceKey key, final ChickenSoundVariants.SoundSet ChickenSoundVariant) {
   ...
   public static enum SoundSet {
      ...
      // $FF: synthetic method
      private static ChickenSoundVariants.SoundSet[] $values() {
         return new ChickenSoundVariants.SoundSet[]{CLASSIC, PICKY};
      }
   }
}
