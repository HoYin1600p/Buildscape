...
public class UpgradeProgress {
   ...
   public static enum Status {
      ...
      // $FF: synthetic method
      private static UpgradeProgress.Status[] $values() {
         return new UpgradeProgress.Status[]{COUNTING, FAILED, FINISHED, UPGRADING};
      }
   }
   ...
   public static enum Type implements StringRepresentable {
      ...
      // $FF: synthetic method
      private static UpgradeProgress.Type[] $values() {
         return new UpgradeProgress.Type[]{FILES, LEGACY_STRUCTURES, REGIONS};
      }
   }
}
