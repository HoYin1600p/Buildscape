...
public abstract class ServerboundMovePlayerPacket implements Packet {
   ...
   public static class Pos extends ServerboundMovePlayerPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ServerboundMovePlayerPacket.Pos::write, ServerboundMovePlayerPacket.Pos::read);
   ...
   public static class PosRot extends ServerboundMovePlayerPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ServerboundMovePlayerPacket.PosRot::write, ServerboundMovePlayerPacket.PosRot::read);
   ...
   public static class Rot extends ServerboundMovePlayerPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ServerboundMovePlayerPacket.Rot::write, ServerboundMovePlayerPacket.Rot::read);
   ...
   public static class StatusOnly extends ServerboundMovePlayerPacket {
      public static final StreamCodec STREAM_CODEC = Packet.codec(ServerboundMovePlayerPacket.StatusOnly::write, ServerboundMovePlayerPacket.StatusOnly::read);
