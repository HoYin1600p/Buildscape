...
public class BackupConfirmScreen extends Screen {
   ...
   public BackupConfirmScreen(final Runnable onCancel, final BackupConfirmScreen.Listener onProceed, final Component title, final Component description, final boolean promptForCacheErase) {
      this(onCancel, onProceed, title, description, BACKUP_AND_JOIN, promptForCacheErase);
   }

   public BackupConfirmScreen(final Runnable onCancel, final BackupConfirmScreen.Listener onProceed, final Component title, final Component description, final Component confirmation, final boolean promptForCacheErase) {
      super(title);
