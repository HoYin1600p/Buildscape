...
public class BoxBlockMatcher extends BlockMatcher {
   ...
   public BoxBlockMatcher filterState(final Predicate predicate) {
      super.filterState(predicate);
      return this;
   }

   public boolean atLeastMatched(final int n) {
      return BlockScanUtils.findBlocks(this.level, this.from, this.to, this.statePredicate, new BlockStateConsumer(this) {
         private int count;
