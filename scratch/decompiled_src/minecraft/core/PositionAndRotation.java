...
public interface PositionAndRotation {
   StreamCodec STREAM_CODEC = StreamCodec.composite(Vec3.STREAM_CODEC, PositionAndRotation::position, ByteBufCodecs.FLOAT, PositionAndRotation::yRot, ByteBufCodecs.FLOAT, PositionAndRotation::xRot, PositionAndRotation::of);
