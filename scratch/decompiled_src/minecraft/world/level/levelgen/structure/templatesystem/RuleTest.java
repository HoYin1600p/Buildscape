...
public abstract class RuleTest {
   public static final Codec CODEC = BuiltInRegistries.RULE_TEST.byNameCodec().dispatch("predicate_type", RuleTest::getType, RuleTestType::codec);
   ...
   public static RuleTest allOf(final List predicates) {
   ...
   public static RuleTest anyOf(final List predicates) {
