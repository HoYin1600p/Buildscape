...
public class ControlsScreen extends OptionsSubScreen {
   ...
   private static OptionInstance[] options(final Options options) {
      return new OptionInstance[]{options.toggleCrouch(), options.toggleSprint(), options.toggleAttack(), options.toggleUse(), options.autoJump(), options.sprintWindow(), options.operatorItemsTab(), options.quitShortcuts()};
   }
