...
public class LinkFileSystem extends FileSystem {
   ...
   private static LinkFSPath buildPath(final LinkFileSystem.DirectoryEntry entry, final LinkFileSystem fileSystem, final String selfName, final @Nullable LinkFSPath parent) {
   ...
   public static class Builder {
      ...
      public LinkFileSystem.Builder put(final List path, final String name, final Path target) {
      ...
      public LinkFileSystem.Builder put(final List path, final Path target) {
         if (path.isEmpty()) {
