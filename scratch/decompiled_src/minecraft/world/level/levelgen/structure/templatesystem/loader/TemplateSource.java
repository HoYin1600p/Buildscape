...
public abstract class TemplateSource {
   ...
   protected TemplateSource(final DataFixer fixerUpper, final HolderGetter blockLookup) {
      this.fixerUpper = fixerUpper;
      this.blockLookup = blockLookup;
   }

   public abstract Optional load(Identifier id);

   public abstract Stream list();

   protected Optional load(final IoSupplier opener, final boolean asText, final Consumer onError) {
      try {
         InputStream rawInput = (InputStream)opener.get();
