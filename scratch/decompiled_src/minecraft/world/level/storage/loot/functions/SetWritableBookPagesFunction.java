...
public class SetWritableBookPagesFunction extends LootItemConditionalFunction {
   ...
   protected SetWritableBookPagesFunction(Optional condition, final List pages, final ListOperation pageOperation) {
      super(condition);
      this.pages = pages;
   ...
   public WritableBookContent apply(final WritableBookContent original) {
      List newPages = this.pageOperation.apply(original.pages(), this.pages, 100);
