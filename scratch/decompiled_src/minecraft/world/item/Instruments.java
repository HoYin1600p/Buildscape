...
public interface Instruments {
   ...
   static void register(final BootstrapContext context, final ResourceKey key, final Holder soundEvent, final float duration, final float range, final int durabilityDamage) {
