...
public class OnlineOptionsScreen extends OptionsSubScreen {
   ...
   private static final Component SERVERS_HEADER = Component.translatable("options.online.servers.header").withStyle(ChatFormatting.UNDERLINE, ChatFormatting.BOLD);
   private static final Component REALMS_HEADER = Component.translatable("options.online.realms.header").withStyle(ChatFormatting.UNDERLINE, ChatFormatting.BOLD);
   private static final Component FRIENDS_HEADER = Component.translatable("options.online.friends.header").withStyle(ChatFormatting.UNDERLINE, ChatFormatting.BOLD);
   ...
   private @Nullable CycleButton friendsListButton;
   private @Nullable CycleButton allowFriendRequestsButton;
   private @Nullable CycleButton inGameNotificationButton;
   ...
   private static void applyFriendSettings(final Minecraft minecraft, final boolean friendsListEnabled, final boolean allowFriendRequests, final Consumer onResult) {
      PlayerSocialManager playerSocialManager = minecraft.getPlayerSocialManager();
   ...
   protected void addOptions() {
      ...
      OptionInstance inGameNotificationOpt = this.options.inGameNotification();
      ...
      this.inGameNotificationButton = CycleButton.onOffBuilder(inGameNotificationOpt.get()).withTooltip((var0) -> IN_GAME_NOTIFICATIONS_TOOLTIP).create(0, 0, 150, 20, IN_GAME_NOTIFICATIONS_LABEL, (var1, enabled) -> inGameNotificationOpt.set(enabled));
   ...
   private void onFriendsListToggled(final Boolean newValue, final PlayerSocialManager playerSocialManager, final OptionInstance inGameNotificationOpt) {
      if (newValue) {
