...
public class PigSoundVariants {
   public static final ResourceKey CLASSIC = createKey(PigSoundVariants.SoundSet.CLASSIC);
   public static final ResourceKey MINI = createKey(PigSoundVariants.SoundSet.MINI);
   public static final ResourceKey BIG = createKey(PigSoundVariants.SoundSet.BIG);

   private static ResourceKey createKey(final PigSoundVariants.SoundSet pigSoundVariant) {
   ...
   private static void register(final BootstrapContext context, final ResourceKey key, final PigSoundVariants.SoundSet PigSoundVariant) {
   ...
   public static enum SoundSet {
      ...
      // $FF: synthetic method
      private static PigSoundVariants.SoundSet[] $values() {
         return new PigSoundVariants.SoundSet[]{CLASSIC, MINI, BIG};
      }
   }
}
