...
public class DustColorTransitionOptions extends ScalableParticleOptionsBase {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.INT, (o) -> o.fromColor, ByteBufCodecs.INT, (o) -> o.toColor, ByteBufCodecs.FLOAT, ScalableParticleOptionsBase::getScale, DustColorTransitionOptions::new);
