...
public record Equippable(EquipmentSlot slot, Holder equipSound, Optional assetId, Optional cameraOverlay, Optional allowedEntities, boolean dispensable, boolean swappable, boolean damageOnHurt, boolean equipOnInteract, boolean canBeSheared, Holder shearingSound) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(EquipmentSlot.STREAM_CODEC, Equippable::slot, SoundEvent.STREAM_CODEC, Equippable::equipSound, ResourceKey.streamCodec(EquipmentAssets.ROOT_ID).apply(ByteBufCodecs::optional), Equippable::assetId, Identifier.STREAM_CODEC.apply(ByteBufCodecs::optional), Equippable::cameraOverlay, ByteBufCodecs.holderSet(Registries.ENTITY_TYPE).apply(ByteBufCodecs::optional), Equippable::allowedEntities, ByteBufCodecs.BOOL, Equippable::dispensable, ByteBufCodecs.BOOL, Equippable::swappable, ByteBufCodecs.BOOL, Equippable::damageOnHurt, ByteBufCodecs.BOOL, Equippable::equipOnInteract, ByteBufCodecs.BOOL, Equippable::canBeSheared, SoundEvent.STREAM_CODEC, Equippable::shearingSound, Equippable::new);
   ...
   public static class Builder {
      ...
      private Holder equipSound = SoundEvents.ARMOR_EQUIP_GENERIC;
      private Optional assetId = Optional.empty();
      private Optional cameraOverlay = Optional.empty();
      private Optional allowedEntities = Optional.empty();
      private boolean dispensable = true;
      private boolean swappable = true;
      private boolean damageOnHurt = true;
      private boolean equipOnInteract;
      private boolean canBeSheared;
      private Holder shearingSound = BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.SHEARS_SNIP);

      private Builder(final EquipmentSlot slot) {
         this.slot = slot;
      }

      public Equippable.Builder setEquipSound(final Holder equipSound) {
         this.equipSound = equipSound;
         return this;
      }

      public Equippable.Builder setAsset(final ResourceKey assetId) {
      ...
      public Equippable.Builder setAllowedEntities(final HolderSet allowedEntities) {
      ...
      public Equippable.Builder setShearingSound(final Holder shearingSound) {
