...
public record InstrumentComponent(Holder instrument) implements TooltipProvider {
   public static final Codec CODEC = Instrument.CODEC.xmap(InstrumentComponent::new, InstrumentComponent::instrument);
   public static final StreamCodec STREAM_CODEC = Instrument.STREAM_CODEC.map(InstrumentComponent::new, InstrumentComponent::instrument);
