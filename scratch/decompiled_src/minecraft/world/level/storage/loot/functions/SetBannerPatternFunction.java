...
public class SetBannerPatternFunction extends LootItemConditionalFunction {
   ...
   private SetBannerPatternFunction(final Optional condition, final BannerPatternLayers patterns, final boolean append) {
      super(condition);
   ...
   public static class Builder extends LootItemConditionalFunction.Builder {
      ...
      public SetBannerPatternFunction.Builder addPattern(final Holder pattern, final DyeColor color) {
