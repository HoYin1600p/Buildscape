...
public class MessageArgument implements SignedArgument {
   ...
   private static void resolveSignedMessage(final Consumer task, final CommandSourceStack sender, final PlayerChatMessage signedArgument) {
      ...
      CompletableFuture filteredFuture = filterPlainText(sender, signedArgument);
   ...
   public MessageArgument.Message parse(final StringReader reader, final @Nullable Object source) throws CommandSyntaxException {
