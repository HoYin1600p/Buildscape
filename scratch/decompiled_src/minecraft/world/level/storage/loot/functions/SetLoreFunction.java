...
public class SetLoreFunction extends LootItemConditionalFunction {
   ...
   public SetLoreFunction(final Optional condition, final List lore, final ListOperation mode, final Optional resolutionContext) {
      super(condition);
   ...
   private List updateLore(final @Nullable ItemLore itemLore, final LootContext context) {
      if (itemLore == null && this.lore.isEmpty()) {
         ...
         UnaryOperator resolver = SetNameFunction.createResolver(context, (LootContext.EntityTarget)this.resolutionContext.orElse((Object)null));
