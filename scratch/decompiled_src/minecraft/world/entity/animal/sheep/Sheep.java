...
public class Sheep extends Animal implements Shearable {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new TemptGoal(this, 1.1D, (i) -> i.is(ItemTags.SHEEP_FOOD), false));
   ...
   public @Nullable Sheep getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      Sheep sheep = (Sheep)EntityTypes.SHEEP.create(level, EntitySpawnReason.BREEDING);
      if (sheep != null) {
