...
public class FireworkStarRecipe extends CustomRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.map(HashMap::new, FireworkExplosion.Shape.STREAM_CODEC, Ingredient.CONTENTS_STREAM_CODEC), (o) -> o.shapes, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.trail, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.twinkle, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.fuel, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.dye, ItemStackTemplate.STREAM_CODEC, (o) -> o.result, FireworkStarRecipe::new);
