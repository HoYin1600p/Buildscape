...
public class ItemModelGenerators {
   ...
   public static final List TRIM_MATERIAL_MODELS = List.of(new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.QUARTZ, TrimMaterials.QUARTZ), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.IRON, TrimMaterials.IRON), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.NETHERITE, TrimMaterials.NETHERITE), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.REDSTONE, TrimMaterials.REDSTONE), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.COPPER, TrimMaterials.COPPER), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.GOLD, TrimMaterials.GOLD), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.EMERALD, TrimMaterials.EMERALD), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.DIAMOND, TrimMaterials.DIAMOND), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.LAPIS, TrimMaterials.LAPIS), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.AMETHYST, TrimMaterials.AMETHYST), new ItemModelGenerators.TrimMaterialData(TrimMaterials.Palette.RESIN, TrimMaterials.RESIN));
   ...
   private void generateStandardCompassItem(final Item compass) {
      List overrides = this.createCompassModels(compass);
   ...
   private void generateTrimmableArmorSet(final Item helmet, final Item chestplate, final Item leggings, final Item boots, final boolean hasDyedLayer, final Map trimPaletteReplacements) {
   ...
   private void generateTrimmableItem(final Item armor, final Identifier slotTrimPrefix, final boolean hasDyedLayer, final Map trimPaletteReplacements) {
      ...
      List cases = new ArrayList(TRIM_MATERIAL_MODELS.size());
   ...
   public static record TrimMaterialData(TrimMaterials.Palette palette, ResourceKey materialKey) {
   }
}
