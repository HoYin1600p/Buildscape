...
public record BlockDataSource(CompilableString coordinates) implements DataSource {
   public static final Codec BLOCK_POS_CODEC = CompilableString.codec(new CompilableString.CommandParserHelper() {
   ...
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(BLOCK_POS_CODEC.fieldOf("block").forGetter(BlockDataSource::coordinates)).apply(i, BlockDataSource::new));
