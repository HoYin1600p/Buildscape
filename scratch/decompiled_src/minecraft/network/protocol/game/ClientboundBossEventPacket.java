...
public class ClientboundBossEventPacket implements Packet {
   ...
   private ClientboundBossEventPacket(final RegistryFriendlyByteBuf input) {
      ...
      ClientboundBossEventPacket.OperationType type = (ClientboundBossEventPacket.OperationType)input.readEnum(ClientboundBossEventPacket.OperationType.class);
      this.operation = (ClientboundBossEventPacket.Operation)type.reader.decode(input);
   }
