...
public abstract class GradientNoise implements Noise {
   protected static final GradientNoise.Gradient[] GRADIENT = new GradientNoise.Gradient[]{new GradientNoise.Gradient(1, 1, 0), new GradientNoise.Gradient(-1, 1, 0), new GradientNoise.Gradient(1, -1, 0), new GradientNoise.Gradient(-1, -1, 0), new GradientNoise.Gradient(1, 0, 1), new GradientNoise.Gradient(-1, 0, 1), new GradientNoise.Gradient(1, 0, -1), new GradientNoise.Gradient(-1, 0, -1), new GradientNoise.Gradient(0, 1, 1), new GradientNoise.Gradient(0, -1, 1), new GradientNoise.Gradient(0, 1, -1), new GradientNoise.Gradient(0, -1, -1), new GradientNoise.Gradient(1, 1, 0), new GradientNoise.Gradient(0, -1, 1), new GradientNoise.Gradient(-1, 1, 0), new GradientNoise.Gradient(0, -1, -1)};
