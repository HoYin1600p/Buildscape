...
public class MangroveRootPlacer extends RootPlacer {
   ...
   public boolean placeRoots(final WorldGenLevel level, final BiConsumer rootSetter, final RandomSource random, final BlockPos origin, final BlockPos trunkOrigin, final TreeFeature tree) {
      List rootPositions = Lists.newArrayList();
      ...
      for(Direction dir : Direction.Plane.HORIZONTAL) {
         ...
         List positionsInDirection = Lists.newArrayList();
