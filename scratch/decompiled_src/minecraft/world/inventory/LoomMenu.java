...
public class LoomMenu extends AbstractContainerMenu {
   ...
   private List selectablePatterns = List.of();
         ...
         public void onTake(final Player player, final ItemStack carried) {
            ...
            access.execute((level, pos) -> {
               ...
               if (LoomMenu.this.lastSoundTime != gameTime) {
                  level.playSound((Entity)null, pos, SoundEvents.UI_LOOM_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
   ...
   private List getSelectablePatterns(final ItemStack patternStack) {
      if (patternStack.isEmpty()) {
         ...
         HolderSet itemPatterns = (HolderSet)patternStack.get(DataComponents.PROVIDES_BANNER_PATTERNS);
   ...
   public void slotsChanged(final Container container) {
      ...
      if (!bannerStack.isEmpty() && !dyeStack.isEmpty()) {
         ...
         List previousSelectablePatterns = this.selectablePatterns;
         this.selectablePatterns = this.getSelectablePatterns(patternStack);
         Holder patternToDisplay;
         if (this.selectablePatterns.size() == 1) {
            ...
            Holder selectedValue = (Holder)previousSelectablePatterns.get(selectedPattern);
