...
public class OceanMonumentPieces {
   ...
   private static class FitDoubleXRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(final Direction orientation, final OceanMonumentPieces.RoomDefinition definition, final RandomSource random) {
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public MonumentBuilding(final RandomSource random, final int west, final int north, final Direction direction) {
         ...
         List roomDefinitions = this.generateRoomGraph(random);
         ...
         List fitters = Lists.newArrayList();
   ...
   protected abstract static class OceanMonumentPiece extends StructurePiece {
      ...
      protected OceanMonumentPiece(final StructurePieceType type, final int genDepth, final Direction orientation, final OceanMonumentPieces.RoomDefinition roomDefinition, final int roomWidth, final int roomHeight, final int roomDepth) {
      ...
      private static BoundingBox makeBoundingBox(final Direction orientation, final OceanMonumentPieces.RoomDefinition roomDefinition, final int roomWidth, final int roomHeight, final int roomDepth) {
      ...
      protected void spawnElder(final WorldGenLevel level, final BoundingBox chunkBB, final int x, final int y, final int z) {
         ...
         if (chunkBB.isInside(pos)) {
            ElderGuardian elder = (ElderGuardian)EntityTypes.ELDER_GUARDIAN.create(level.getLevel(), EntitySpawnReason.STRUCTURE);
            if (elder != null) {
               elder.heal(elder.getMaxHealth());
               elder.snapTo((double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D, 0.0F, 0.0F);
