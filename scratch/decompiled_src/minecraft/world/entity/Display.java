...
public abstract class Display extends Entity {
   ...
   private static final EntityDataAccessor DATA_TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   private static final EntityDataAccessor DATA_TRANSFORMATION_INTERPOLATION_DURATION_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   private static final EntityDataAccessor DATA_POS_ROT_INTERPOLATION_DURATION_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   private static final EntityDataAccessor DATA_TRANSLATION_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.VECTOR3);
   private static final EntityDataAccessor DATA_SCALE_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.VECTOR3);
   private static final EntityDataAccessor DATA_LEFT_ROTATION_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.QUATERNION);
   private static final EntityDataAccessor DATA_RIGHT_ROTATION_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.QUATERNION);
   private static final EntityDataAccessor DATA_BILLBOARD_RENDER_CONSTRAINTS_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.BYTE);
   private static final EntityDataAccessor DATA_BRIGHTNESS_OVERRIDE_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   private static final EntityDataAccessor DATA_VIEW_RANGE_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.FLOAT);
   private static final EntityDataAccessor DATA_SHADOW_RADIUS_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.FLOAT);
   private static final EntityDataAccessor DATA_SHADOW_STRENGTH_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.FLOAT);
   private static final EntityDataAccessor DATA_WIDTH_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.FLOAT);
   private static final EntityDataAccessor DATA_HEIGHT_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.FLOAT);
   private static final EntityDataAccessor DATA_GLOW_COLOR_OVERRIDE_ID = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   ...
   private Display.RenderState createInterpolatedRenderState(final Display.RenderState previousState, final float progress) {
      ...
      return new Display.RenderState(new Display.TransformationInterpolator(currentTransform, createTransformation(this.entityData)), this.getBillboardConstraints(), this.getPackedBrightnessOverride(), new Display.LinearFloatInterpolator(currentShadowRadius, this.getShadowRadius()), new Display.LinearFloatInterpolator(currentShadowStrength, this.getShadowStrength()), this.getGlowColorOverride());
   }
   ...
   public static enum BillboardConstraints implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(Display.BillboardConstraints::values);
      public static final IntFunction BY_ID = ByIdMap.continuous(Display.BillboardConstraints::getId, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
   ...
   public static class BlockDisplay extends Display {
      ...
      private static final EntityDataAccessor DATA_BLOCK_STATE_ID = SynchedEntityData.defineId(Display.BlockDisplay.class, EntityDataSerializers.BLOCK_STATE);
   ...
   public interface GenericInterpolator {
      static Display.GenericInterpolator constant(final Object value) {
         return (progress) -> value;
      }
   ...
   public static class ItemDisplay extends Display {
      ...
      private static final EntityDataAccessor DATA_ITEM_STACK_ID = SynchedEntityData.defineId(Display.ItemDisplay.class, EntityDataSerializers.ITEM_STACK);
      private static final EntityDataAccessor DATA_ITEM_DISPLAY_ID = SynchedEntityData.defineId(Display.ItemDisplay.class, EntityDataSerializers.BYTE);
   ...
   public static record RenderState(Display.GenericInterpolator transformation, Display.BillboardConstraints billboardConstraints, int brightnessOverride, Display.FloatInterpolator shadowRadius, Display.FloatInterpolator shadowStrength, int glowColorOverride) {
   }
   ...
   public static class TextDisplay extends Display {
      ...
      private static final EntityDataAccessor DATA_TEXT_ID = SynchedEntityData.defineId(Display.TextDisplay.class, EntityDataSerializers.COMPONENT);
      private static final EntityDataAccessor DATA_LINE_WIDTH_ID = SynchedEntityData.defineId(Display.TextDisplay.class, EntityDataSerializers.INT);
      private static final EntityDataAccessor DATA_BACKGROUND_COLOR_ID = SynchedEntityData.defineId(Display.TextDisplay.class, EntityDataSerializers.INT);
      private static final EntityDataAccessor DATA_TEXT_OPACITY_ID = SynchedEntityData.defineId(Display.TextDisplay.class, EntityDataSerializers.BYTE);
      private static final EntityDataAccessor DATA_STYLE_FLAGS_ID = SynchedEntityData.defineId(Display.TextDisplay.class, EntityDataSerializers.BYTE);
      ...
      protected void readAdditionalSaveData(final ValueInput input) {
         ...
         Optional alignment = input.read("alignment", Display.TextDisplay.Align.CODEC);
         if (alignment.isPresent()) {
            byte var10000;
            switch (((Display.TextDisplay.Align)alignment.get()).ordinal()) {
               case 0:
                  var10000 = flags;
                  break;
               case 1:
                  var10000 = (byte)(flags | 8);
                  break;
               case 2:
                  var10000 = (byte)(flags | 16);
                  break;
               default:
         ...
         this.setFlags(flags);
         Optional text = input.read("text", ComponentSerialization.CODEC);
         if (text.isPresent()) {
            try {
               Level context = this.level();
               if (context instanceof ServerLevel) {
                  ServerLevel serverLevel = (ServerLevel)context;
      ...
      private Display.TextDisplay.TextRenderState createInterpolatedTextRenderState(final Display.TextDisplay.TextRenderState previous, final float progress) {
         ...
         return new Display.TextDisplay.TextRenderState(this.getText(), this.getLineWidth(), new Display.LinearIntInterpolator(currentOpacity, this.getTextOpacity()), new Display.ColorInterpolator(currentBackground, this.getBackgroundColor()), this.getFlags());
      }
      ...
      public static enum Align implements StringRepresentable {
         ...
         public static final Codec CODEC = StringRepresentable.fromEnum(Display.TextDisplay.Align::values);
         private final String name;
   ...
   private static record TransformationInterpolator(Transformation previous, Transformation current) implements Display.GenericInterpolator {
