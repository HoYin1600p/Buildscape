...
public final class WorldGenSettings extends SavedData {
   ...
   public static final SavedDataType TYPE = new SavedDataType(Identifier.withDefaultNamespace("world_gen_settings"), () -> new WorldGenSettings(WorldOptions.defaultWithRandomSeed(), new WorldDimensions(new HashMap())), CODEC, DataFixTypes.SAVED_DATA_WORLD_GEN_SETTINGS);
