...
public class ChunkStatus {
   ...
   private static final EnumSet WORLDGEN_HEIGHTMAPS = EnumSet.of(Heightmap.Types.OCEAN_FLOOR_WG, Heightmap.Types.WORLD_SURFACE_WG);
   public static final EnumSet FINAL_HEIGHTMAPS = EnumSet.of(Heightmap.Types.OCEAN_FLOOR, Heightmap.Types.WORLD_SURFACE, Heightmap.Types.MOTION_BLOCKING, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES);
   public static final ChunkStatus EMPTY = register("empty", (ChunkStatus)null, WORLDGEN_HEIGHTMAPS, ChunkType.PROTOCHUNK);
   ...
   public static final Codec CODEC = BuiltInRegistries.CHUNK_STATUS.byNameCodec();
