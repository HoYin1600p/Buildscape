...
public class Xoroshiro128PlusPlus {
   private long seedLo;
   private long seedHi;
   public static final Codec CODEC = Codec.LONG_STREAM.comapFlatMap((seed) -> Util.fixedSize(seed, 2).map((longs) -> new Xoroshiro128PlusPlus(longs[0], longs[1])), (r) -> LongStream.of(new long[]{r.seedLo, r.seedHi}));
