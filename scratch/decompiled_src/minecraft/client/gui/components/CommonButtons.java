...
public class CommonButtons {
   public static SpriteIconButton language(final int width, final Button.OnPress onPress, final boolean iconOnly) {
      SpriteIconButton button = SpriteIconButton.builder(Component.translatable("options.language"), onPress, iconOnly).width(width).sprite(Identifier.withDefaultNamespace("icon/language"), 15, 15).narration((var0) -> Component.translatable("options.language.narration")).build();
   ...
   public static SpriteIconButton accessibility(final int width, final Button.OnPress onPress, final boolean iconOnly) {
      ...
      SpriteIconButton button = SpriteIconButton.builder(text, onPress, iconOnly).width(width).sprite(Identifier.withDefaultNamespace("icon/accessibility"), 15, 15).narration((var0) -> Component.translatable("accessibility.onboarding.accessibility.button.narration")).build();
