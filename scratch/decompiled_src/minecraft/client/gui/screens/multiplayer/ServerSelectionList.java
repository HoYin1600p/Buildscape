...
public class ServerSelectionList extends ObjectSelectionList {
   ...
   private void refreshEntries() {
      ServerSelectionList.Entry previouslySelected = (ServerSelectionList.Entry)this.getSelected();
      List entriesToAdd = new ArrayList(this.onlineServers);
   ...
   public static class NetworkServerEntry extends ServerSelectionList.Entry {
      ...
      protected boolean matches(final ServerSelectionList.Entry other) {
         if (other instanceof ServerSelectionList.NetworkServerEntry networkServerEntry) {
   ...
   public class OnlineServerEntry extends ServerSelectionList.Entry implements SelectableEntry {
      ...
      public void extractContent(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final boolean hovered, final float a) {
         ...
         List lines = this.minecraft.font.split(this.serverData.motd, this.getContentWidth() - 32 - 2);
         ...
         if (this.serverData.state() == ServerData.State.PINGING) {
            ...
            switch (iconIndex) {
               case 1:
                  var10001 = ServerSelectionList.PINGING_2_SPRITE;
                  break;
               case 2:
                  var10001 = ServerSelectionList.PINGING_3_SPRITE;
                  break;
               case 3:
                  var10001 = ServerSelectionList.PINGING_4_SPRITE;
                  break;
               case 4:
                  var10001 = ServerSelectionList.PINGING_5_SPRITE;
                  break;
               default:
                  var10001 = ServerSelectionList.PINGING_1_SPRITE;
            }
         ...
         } else if (this.onlinePlayersTooltip != null && mouseX >= statusX && mouseX <= statusX + statusWidth && mouseY >= this.getContentY() && mouseY <= this.getContentY() - 1 + 9) {
      ...
      protected boolean matches(final ServerSelectionList.Entry other) {
         if (other instanceof ServerSelectionList.OnlineServerEntry onlineServerEntry) {
