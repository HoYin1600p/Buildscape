...
public class TrialSpawnerConfigFix extends NamedEntityWriteReadFix {
   ...
   private static Dynamic moveToConfigTag(Dynamic input) {
      List keysToMove = List.of("spawn_range", "total_mobs", "simultaneous_mobs", "total_mobs_added_per_player", "simultaneous_mobs_added_per_player", "ticks_between_spawn", "spawn_potentials", "loot_tables_to_eject", "items_to_drop_when_ominous");
      Map map = new HashMap(keysToMove.size());
