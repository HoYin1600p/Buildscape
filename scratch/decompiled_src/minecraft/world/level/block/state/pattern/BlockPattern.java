...
public class BlockPattern {
   ...
   public BlockPattern.@Nullable BlockPatternMatch matches(final LevelReader level, final BlockPos origin, final Direction forwards, final Direction up) {
      LoadingCache cache = createLevelCache(level, false);
      return this.matches(origin, forwards, up, cache);
   }

   private BlockPattern.@Nullable BlockPatternMatch matches(final BlockPos origin, final Direction forwards, final Direction up, final LoadingCache cache) {
