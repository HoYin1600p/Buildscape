...
public class ChunkStatusTasks {
   ...
   public static CompletableFuture passThrough(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      return CompletableFuture.completedFuture(chunk);
   }

   public static CompletableFuture generateStructureStarts(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
   ...
   public static CompletableFuture loadStructureStarts(final WorldGenContext context, final ChunkStep step, final StaticCache2D cache, final ChunkAccess chunk) {
      context.level().onStructureStartsAvailable(chunk);
      return CompletableFuture.completedFuture(chunk);
   }

   public static CompletableFuture generateStructureReferences(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
   ...
   public static CompletableFuture generateBiomes(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
      WorldGenRegion region = new WorldGenRegion(level, chunks, step, chunk);
   ...
   private static Set collectPossibleBiomes(final WorldGenRegion region, final int chunkRadius) {
      Set chunkBiomes = new ObjectOpenHashSet();
   ...
   public static CompletableFuture generateNoise(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
      WorldGenRegion region = new WorldGenRegion(level, chunks, step, chunk);
   ...
   public static CompletableFuture generateSurface(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
      WorldGenRegion region = new WorldGenRegion(level, chunks, step, chunk);
      Set possibleBiomes = collectPossibleBiomes(region, 1);
   ...
   public static CompletableFuture generateCarvers(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
      WorldGenRegion region = new WorldGenRegion(level, chunks, step, chunk);
   ...
   public static CompletableFuture generateFeatures(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      ServerLevel level = context.level();
      WorldGenRegion region = new WorldGenRegion(level, chunks, step, chunk);
   ...
   public static CompletableFuture initializeLight(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
   ...
   public static CompletableFuture light(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
      boolean lighted = isLighted(chunk);
      return context.lightEngine().lightChunk(chunk, lighted);
   }

   public static CompletableFuture generateSpawn(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
   ...
   public static CompletableFuture full(final WorldGenContext context, final ChunkStep step, final StaticCache2D chunks, final ChunkAccess chunk) {
