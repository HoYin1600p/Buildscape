...
public class LootPoolEntries {
   public static final Codec CODEC = BuiltInRegistries.LOOT_POOL_ENTRY_TYPE.byNameCodec().dispatch(LootPoolEntryContainer::codec, (c) -> c);
   ...
   public static MapCodec bootstrap(final Registry registry) {
      ...
      return (MapCodec)Registry.register(registry, "group", EntryGroup.MAP_CODEC);
   }
}
