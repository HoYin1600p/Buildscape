...
public class OceanRuinStructure extends Structure {
   ...
   public OceanRuinStructure(final Structure.StructureSettings settings, final OceanRuinStructure.Type biomeTemp, final float largeProbability, final float clusterProbability) {
      super(settings);
   ...
   public static enum Type implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(OceanRuinStructure.Type::values);
      /** @deprecated */
      @Deprecated
      public static final Codec LEGACY_CODEC = ExtraCodecs.legacyEnum(OceanRuinStructure.Type::valueOf);
