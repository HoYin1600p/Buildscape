...
public abstract class AbstractCubeMobRenderer extends MobRenderer {
   public AbstractCubeMobRenderer(final EntityRendererProvider.Context context, final EntityModel model) {
   ...
   protected void applySizeAndSquish(final SlimeRenderState state, final PoseStack poseStack) {
   ...
   public void extractRenderState(final AbstractCubeMob entity, final SlimeRenderState state, final float partialTicks) {
