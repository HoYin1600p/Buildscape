...
public class OrePlacements {
   ...
   public static void bootstrap(final BootstrapContext context) {
      ...
      Holder oreMagma = configuredFeatures.getOrThrow(OreFeatures.ORE_MAGMA);
      Holder oreSoulSand = configuredFeatures.getOrThrow(OreFeatures.ORE_SOUL_SAND);
      Holder oreNetherGold = configuredFeatures.getOrThrow(OreFeatures.ORE_NETHER_GOLD);
      Holder oreQuartz = configuredFeatures.getOrThrow(OreFeatures.ORE_QUARTZ);
      Holder oreGravelNether = configuredFeatures.getOrThrow(OreFeatures.ORE_GRAVEL_NETHER);
      Holder oreBlackstone = configuredFeatures.getOrThrow(OreFeatures.ORE_BLACKSTONE);
      Holder oreDirt = configuredFeatures.getOrThrow(OreFeatures.ORE_DIRT);
      Holder oreGravel = configuredFeatures.getOrThrow(OreFeatures.ORE_GRAVEL);
      Holder oreGranite = configuredFeatures.getOrThrow(OreFeatures.ORE_GRANITE);
      Holder oreDiorite = configuredFeatures.getOrThrow(OreFeatures.ORE_DIORITE);
      Holder oreAndesite = configuredFeatures.getOrThrow(OreFeatures.ORE_ANDESITE);
      Holder oreTuff = configuredFeatures.getOrThrow(OreFeatures.ORE_TUFF);
      Holder oreCoal = configuredFeatures.getOrThrow(OreFeatures.ORE_COAL);
      Holder oreCoalBuried = configuredFeatures.getOrThrow(OreFeatures.ORE_COAL_BURIED);
      Holder oreIron = configuredFeatures.getOrThrow(OreFeatures.ORE_IRON);
      Holder oreIronSmall = configuredFeatures.getOrThrow(OreFeatures.ORE_IRON_SMALL);
      Holder oreGold = configuredFeatures.getOrThrow(OreFeatures.ORE_GOLD);
      Holder oreGoldBuried = configuredFeatures.getOrThrow(OreFeatures.ORE_GOLD_BURIED);
      Holder oreRedstone = configuredFeatures.getOrThrow(OreFeatures.ORE_REDSTONE);
      Holder oreDiamondSmall = configuredFeatures.getOrThrow(OreFeatures.ORE_DIAMOND_SMALL);
      Holder oreDiamondMedium = configuredFeatures.getOrThrow(OreFeatures.ORE_DIAMOND_MEDIUM);
      Holder oreDiamondLarge = configuredFeatures.getOrThrow(OreFeatures.ORE_DIAMOND_LARGE);
      Holder oreDiamondBuried = configuredFeatures.getOrThrow(OreFeatures.ORE_DIAMOND_BURIED);
      Holder oreLapis = configuredFeatures.getOrThrow(OreFeatures.ORE_LAPIS);
      Holder oreLapisBuried = configuredFeatures.getOrThrow(OreFeatures.ORE_LAPIS_BURIED);
      Holder oreInfested = configuredFeatures.getOrThrow(OreFeatures.ORE_INFESTED);
      Holder oreEmerald = configuredFeatures.getOrThrow(OreFeatures.ORE_EMERALD);
      Holder oreAncientDebrisLarge = configuredFeatures.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_LARGE);
      Holder oreAncientDebrisSmall = configuredFeatures.getOrThrow(OreFeatures.ORE_ANCIENT_DEBRIS_SMALL);
      Holder oreCoppperSmall = configuredFeatures.getOrThrow(OreFeatures.ORE_COPPPER_SMALL);
      Holder oreCopperLarge = configuredFeatures.getOrThrow(OreFeatures.ORE_COPPER_LARGE);
      Holder oreClay = configuredFeatures.getOrThrow(OreFeatures.ORE_CLAY);
