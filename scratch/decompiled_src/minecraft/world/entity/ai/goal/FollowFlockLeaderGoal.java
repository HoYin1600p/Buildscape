...
public class FollowFlockLeaderGoal extends Goal {
   ...
   public boolean canUse() {
      if (this.mob.hasFollowers()) {
         ...
         Predicate predicate = (fish) -> fish.canBeFollowed() || !fish.isFollower();
         List leadersWithSpaceOrNotFollowers = this.mob.level().getEntitiesOfClass(this.mob.getClass(), this.mob.getBoundingBox().inflate(8.0D, 8.0D, 8.0D), predicate);
