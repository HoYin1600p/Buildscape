...
public class EnchantCommand {
   ...
   private static final CommandResponseTracker.MessagesWithArgs RESPONSE_ENCHANT = CommandResponseTracker.messages(ERROR_NOTHING_HAPPENED, (entity, var1, enchantment, level) -> Component.translatable("commands.enchant.success.single", Enchantment.getFullname(enchantment, level), entity.getDisplayName()), (entityCount, var1, enchantment, level) -> Component.translatable("commands.enchant.success.multiple", Enchantment.getFullname(enchantment, level), entityCount));
