...
public abstract class AbstractSelectionList extends AbstractContainerWidget {
   ...
   private AbstractSelectionList.@Nullable Entry selected;
   private AbstractSelectionList.@Nullable Entry hovered;
   ...
   public AbstractSelectionList.@Nullable Entry getSelected() {
      return this.selected;
   }

   public void setSelected(final AbstractSelectionList.@Nullable Entry selected) {
   ...
   public AbstractSelectionList.@Nullable Entry getFocused() {
   ...
   protected void swap(final int firstIndex, final int secondIndex) {
      ...
      this.repositionEntries();
      this.scrollToEntry((AbstractSelectionList.Entry)this.children.get(secondIndex));
   }
   ...
   protected void clearEntriesExcept(final AbstractSelectionList.Entry exception) {
   ...
   public void replaceEntries(final Collection newChildren) {
      ...
      for(AbstractSelectionList.Entry newChild : newChildren) {
   ...
   public int getNextY() {
      ...
      for(AbstractSelectionList.Entry child : this.children) {
         y += child.getHeight();
      }
   ...
   protected int addEntry(final AbstractSelectionList.Entry entry) {
      return this.addEntry(entry, this.defaultEntryHeight);
   }

   protected int addEntry(final AbstractSelectionList.Entry entry, final int height) {
   ...
   protected void addEntryToTop(final AbstractSelectionList.Entry entry) {
      this.addEntryToTop(entry, this.defaultEntryHeight);
   }

   protected void addEntryToTop(final AbstractSelectionList.Entry entry, final int height) {
   ...
   protected void removeEntryFromTop(final AbstractSelectionList.Entry entry) {
      double scrollFromBottom = (double)this.maxScrollAmount() - this.scrollAmount();
   ...
   protected final AbstractSelectionList.@Nullable Entry getEntryAtPosition(final double posX, final double posY) {
      for(AbstractSelectionList.Entry child : this.children) {
   ...
   protected void scrollToEntry(final AbstractSelectionList.Entry entry) {
   ...
   protected void centerScrollOn(final AbstractSelectionList.Entry entry) {
      int y = 0;
      ...
      this.setScrollAmount((double)y - (double)this.height / 2.0D);
   }
   ...
   public void setFocused(final @Nullable GuiEventListener focused) {
      AbstractSelectionList.Entry oldFocus = (E)this.getFocused();
      ...
      if (index >= 0) {
         AbstractSelectionList.Entry magicallyCastEntry = (E)((AbstractSelectionList.Entry)this.children.get(index));
         this.setSelected(magicallyCastEntry);
      }

   }

   protected AbstractSelectionList.@Nullable Entry nextEntry(final ScreenDirection dir) {
      return this.nextEntry(dir, (entry) -> true);
   }

   protected AbstractSelectionList.@Nullable Entry nextEntry(final ScreenDirection dir, final Predicate canSelect) {
      return this.nextEntry(dir, canSelect, this.getSelected());
   }

   protected AbstractSelectionList.@Nullable Entry nextEntry(final ScreenDirection dir, final Predicate canSelect, final AbstractSelectionList.@Nullable Entry startEntry) {
      byte var10000;
      switch (dir) {
         case RIGHT:
         case LEFT:
      ...
      if (!this.children().isEmpty() && delta != 0) {
         ...
         for(int i = index; i >= 0 && i < this.children.size(); i += delta) {
            AbstractSelectionList.Entry selected = (E)((AbstractSelectionList.Entry)this.children().get(i));
   ...
   protected void extractItem(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a, final AbstractSelectionList.Entry entry) {
   ...
   protected void extractSelection(final GuiGraphicsExtractor graphics, final AbstractSelectionList.Entry entry, final int outlineColor) {
   ...
   public int getRowBottom(final int row) {
      AbstractSelectionList.Entry child = (E)((AbstractSelectionList.Entry)this.children.get(row));
   ...
   protected void removeEntry(final AbstractSelectionList.Entry entry) {
   ...
   protected AbstractSelectionList.@Nullable Entry getHovered() {
      return this.hovered;
   }

   private void bindEntryToSelf(final AbstractSelectionList.Entry entry) {
      entry.list = this;
   }

   protected void narrateListElementPosition(final NarrationElementOutput output, final AbstractSelectionList.Entry element) {
   ...
   private class TrackedList extends AbstractList {
      ...
      public AbstractSelectionList.Entry get(final int index) {
         return (AbstractSelectionList.Entry)this.delegate.get(index);
      }
      ...
      public AbstractSelectionList.Entry set(final int index, final AbstractSelectionList.Entry element) {
         AbstractSelectionList.Entry entry = (E)((AbstractSelectionList.Entry)this.delegate.set(index, element));
         AbstractSelectionList.this.bindEntryToSelf(element);
         return entry;
      }

      public void add(final int index, final AbstractSelectionList.Entry element) {
         this.delegate.add(index, element);
         AbstractSelectionList.this.bindEntryToSelf(element);
      }

      public AbstractSelectionList.Entry remove(final int index) {
         return (AbstractSelectionList.Entry)this.delegate.remove(index);
      }
   }
}
