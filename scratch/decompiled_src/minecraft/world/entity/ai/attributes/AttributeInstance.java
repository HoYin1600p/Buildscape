...
public class AttributeInstance {
   ...
   public static record Packed(Holder attribute, double baseValue, List modifiers) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(BuiltInRegistries.ATTRIBUTE.holderByNameCodec().fieldOf("id").forGetter(AttributeInstance.Packed::attribute), ExtraCodecs.optionalAlwaysPresentFieldOf(Codec.DOUBLE, "base", 0.0D).forGetter(AttributeInstance.Packed::baseValue), AttributeModifier.CODEC.listOf().optionalFieldOf("modifiers", List.of()).forGetter(AttributeInstance.Packed::modifiers)).apply(i, AttributeInstance.Packed::new));
