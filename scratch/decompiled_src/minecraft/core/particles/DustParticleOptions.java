...
public class DustParticleOptions extends ScalableParticleOptionsBase {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.INT, (o) -> o.color, ByteBufCodecs.FLOAT, ScalableParticleOptionsBase::getScale, DustParticleOptions::new);
