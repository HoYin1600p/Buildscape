...
public class DimensionTypes {
   public static void bootstrap(final BootstrapContext context) {
      ...
      HolderGetter timelines = context.lookup(Registries.TIMELINE);
      HolderGetter clocks = context.lookup(Registries.WORLD_CLOCK);
