...
public class MusicManager {
   ...
   public MusicManager(final Minecraft minecraft) {
      ...
      this.gameMusicFrequency = (MusicManager.MusicFrequency)minecraft.options.musicFrequency().get();
   }
   ...
   public static enum MusicFrequency implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(MusicManager.MusicFrequency::values);
