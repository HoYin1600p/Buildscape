...
public class TracyZoneFiller implements ProfilerFiller {
   ...
   public void push(final String name) {
      ...
      if (SharedConstants.IS_RUNNING_IN_IDE) {
         Optional result = (Optional)STACK_WALKER.walk((s) -> s.filter((frame) -> frame.getDeclaringClass() != TracyZoneFiller.class && frame.getDeclaringClass() != ProfilerFiller.CombinedProfileFiller.class).findFirst());
         if (result.isPresent()) {
