...
public class TabNavigationBar extends AbstractContainerWidget {
   ...
   protected final ImmutableList tabs;
   protected final ImmutableList tabButtons;

   protected TabNavigationBar(final int x, final int y, final int width, final int height, final TabManager tabManager, final ImmutableList tabButtons, final ImmutableList tabs) {
   ...
   protected void updateWidgetNarration(final NarrationElementOutput output) {
      Optional selected = this.tabButtons.stream().filter(AbstractWidget::isHovered).findFirst().or(() -> Optional.ofNullable(this.currentTabButton()));
   ...
   public static class Builder {
      ...
      protected final List tabButtons = new ArrayList();
