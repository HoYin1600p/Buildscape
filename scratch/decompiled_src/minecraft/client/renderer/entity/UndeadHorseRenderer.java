...
public class UndeadHorseRenderer extends AbstractHorseRenderer {
   ...
   public UndeadHorseRenderer(final EntityRendererProvider.Context context, final EquipmentClientInfo.LayerType saddleLayer, final ModelLayerLocation saddleModel, final UndeadHorseRenderer.Type adult, final UndeadHorseRenderer.Type baby) {
   ...
   public static enum Type {
      ...
      private static UndeadHorseRenderer.Type[] $values() {
         return new UndeadHorseRenderer.Type[]{SKELETON, SKELETON_BABY, ZOMBIE, ZOMBIE_BABY};
      }
   }
}
