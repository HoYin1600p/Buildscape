...
public abstract class AbstractSpreadingStructurePlacement implements StructurePlacement {
   ...
   protected AbstractSpreadingStructurePlacement(final Vec3i locateOffset, final AbstractSpreadingStructurePlacement.FrequencyReductionMethod frequencyReductionMethod, final float frequency, final int salt, final Optional exclusionZone) {
   ...
   public boolean applyInteractionsWithOtherStructures(final ChunkGeneratorStructureState state, final int sourceX, final int sourceZ) {
      return !this.exclusionZone.isPresent() || !((AbstractSpreadingStructurePlacement.ExclusionZone)this.exclusionZone.get()).isPlacementForbidden(state, sourceX, sourceZ);
   }
   ...
   public static record ExclusionZone(Holder otherSet, int chunkCount) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(RegistryCodecs.holder(Registries.STRUCTURE_SET, StructureSet.DIRECT_CODEC, false).fieldOf("other_set").forGetter(AbstractSpreadingStructurePlacement.ExclusionZone::otherSet), Codec.intRange(1, 16).fieldOf("chunk_count").forGetter(AbstractSpreadingStructurePlacement.ExclusionZone::chunkCount)).apply(i, AbstractSpreadingStructurePlacement.ExclusionZone::new));
   ...
   public static enum FrequencyReductionMethod implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(AbstractSpreadingStructurePlacement.FrequencyReductionMethod::values);
      ...
      // $FF: synthetic method
      private static AbstractSpreadingStructurePlacement.FrequencyReductionMethod[] $values() {
         return new AbstractSpreadingStructurePlacement.FrequencyReductionMethod[]{DEFAULT, LEGACY_TYPE_1, LEGACY_TYPE_2, LEGACY_TYPE_3};
      }
   }
}
