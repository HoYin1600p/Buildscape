...
public class OverworldBiomes {
   ...
   public static Biome dappledForest(final HolderGetter placedFeatures, final HolderGetter carvers) {
      BiomeGenerationSettings.Builder generation = new BiomeGenerationSettings.Builder(placedFeatures, carvers);
      globalOverworldGeneration(generation);
   ...
   public static Biome sulfurCaves(final HolderGetter placedFeatures, final HolderGetter carvers) {
      MobSpawnSettings.Builder mobs = new MobSpawnSettings.Builder();
