...
public class ChunkBorderRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void emitGizmos(final double camX, final double camY, final double camZ, final DebugValueAccess debugValues, final Frustum frustum, final float partialTicks) {
      ...
      for(int x = 2; x < 16; x += 2) {
         ...
         Gizmos.line(new Vec3(xstart + (double)x, (double)ymin, zstart + 16.0D), new Vec3(xstart + (double)x, (double)ymax, zstart + 16.0D), color, 1.0F);
      }
      ...
      for(int z = 2; z < 16; z += 2) {
         ...
         Gizmos.line(new Vec3(xstart + 16.0D, (double)ymin, zstart + (double)z), new Vec3(xstart + 16.0D, (double)ymax, zstart + (double)z), color, 1.0F);
      }

      for(int y = this.minecraft.level.getMinY(); y <= this.minecraft.level.getMaxY() + 1; y += 2) {
         float yline = (float)y;
         int color = y % 8 == 0 ? CELL_BORDER : YELLOW;
         Gizmos.line(new Vec3(xstart, (double)yline, zstart), new Vec3(xstart, (double)yline, zstart + 16.0D), color, 1.0F);
         Gizmos.line(new Vec3(xstart, (double)yline, zstart + 16.0D), new Vec3(xstart + 16.0D, (double)yline, zstart + 16.0D), color, 1.0F);
         Gizmos.line(new Vec3(xstart + 16.0D, (double)yline, zstart + 16.0D), new Vec3(xstart + 16.0D, (double)yline, zstart), color, 1.0F);
         Gizmos.line(new Vec3(xstart + 16.0D, (double)yline, zstart), new Vec3(xstart, (double)yline, zstart), color, 1.0F);
      }
      ...
      for(int y = this.minecraft.level.getMinY(); y <= this.minecraft.level.getMaxY() + 1; y += 16) {
         Gizmos.line(new Vec3(xstart, (double)y, zstart), new Vec3(xstart, (double)y, zstart + 16.0D), MAJOR_LINES, 4.0F);
         Gizmos.line(new Vec3(xstart, (double)y, zstart + 16.0D), new Vec3(xstart + 16.0D, (double)y, zstart + 16.0D), MAJOR_LINES, 4.0F);
         Gizmos.line(new Vec3(xstart + 16.0D, (double)y, zstart + 16.0D), new Vec3(xstart + 16.0D, (double)y, zstart), MAJOR_LINES, 4.0F);
         Gizmos.line(new Vec3(xstart + 16.0D, (double)y, zstart), new Vec3(xstart, (double)y, zstart), MAJOR_LINES, 4.0F);
      }
