...
public record TradeCost(Holder item, Holder count, DataComponentExactPredicate components) implements Validatable {
   ...
   public TradeCost(final ItemLike item, final Holder count) {
