...
public final class PatchedDataComponentMap implements DataComponentMap {
   ...
   public @Nullable Object set(final DataComponentType type, final @Nullable Object value) {
      ...
      Object defaultValue = (T)this.prototype.get(type);
      Object lastValue;
      ...
      return lastValue != null ? Objects.requireNonNullElse(Removed.removedToNull(lastValue), defaultValue) : defaultValue;
   }
   ...
   public Object remove(final DataComponentType type) {
      this.ensureMapOwnership();
      Object defaultValue = (T)this.prototype.get(type);
      Object lastValue;
      ...
      return lastValue != null ? Removed.removedToNull(lastValue) : defaultValue;
   }
   ...
   public Set keySet() {
      if (this.patch.isEmpty()) {
         ...
         Set components = new ReferenceArraySet(this.prototype.keySet());
   ...
   public Iterator iterator() {
      if (this.patch.isEmpty()) {
         ...
         List components = new ArrayList(this.patch.size() + this.prototype.size());
         ObjectIterator var2 = Reference2ObjectMaps.fastIterable(this.patch).iterator();
