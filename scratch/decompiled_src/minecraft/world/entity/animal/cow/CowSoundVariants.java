...
public class CowSoundVariants {
   public static final ResourceKey CLASSIC = createKey(CowSoundVariants.SoundSet.CLASSIC);
   public static final ResourceKey MOODY = createKey(CowSoundVariants.SoundSet.MOODY);

   private static ResourceKey createKey(final CowSoundVariants.SoundSet cowSoundVariant) {
   ...
   private static void register(final BootstrapContext context, final ResourceKey key, final CowSoundVariants.SoundSet CowSoundVariant) {
   ...
   public static enum SoundSet {
      ...
      // $FF: synthetic method
      private static CowSoundVariants.SoundSet[] $values() {
         return new CowSoundVariants.SoundSet[]{CLASSIC, MOODY};
      }
   }
}
