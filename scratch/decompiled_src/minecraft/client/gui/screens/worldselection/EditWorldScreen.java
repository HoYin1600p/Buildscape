...
public class EditWorldScreen extends Screen {
   ...
   public static CompletableFuture conditionallyMakeBackupAndShowToast(final boolean createBackup, final LevelStorageSource.LevelStorageAccess access) {
      return createBackup ? makeBackupAndShowToast(access) : CompletableFuture.completedFuture(false);
   }

   public static CompletableFuture makeBackupAndShowToast(final LevelStorageSource.LevelStorageAccess access) {
      ...
      return CompletableFuture.supplyAsync(() -> {
         ...
         Component message = Component.translatable("selectWorld.edit.backupSize", Mth.ceil((double)size.longValue() / 1048576.0D));
