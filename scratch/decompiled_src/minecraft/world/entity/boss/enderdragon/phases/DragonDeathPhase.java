...
public class DragonDeathPhase extends AbstractDragonPhaseInstance {
   ...
   public void doClientTick() {
      if (this.time++ % 10 == 0) {
         ...
         this.dragon.level().addParticle(ParticleTypes.EXPLOSION_EMITTER, this.dragon.getX() + (double)xo, this.dragon.getY() + 2.0D + (double)yo, this.dragon.getZ() + (double)zo, 0.0D, 0.0D, 0.0D);
      }
