...
public class SystemToast implements Toast {
   ...
   private static List nullToEmpty(final @Nullable Component text) {
      return (List)(text == null ? ImmutableList.of() : splitToLength(text));
   }

   private static List splitToLength(final Component text) {
   ...
   private void extractTextLines(final GuiGraphicsExtractor graphics, final Font font, final List textLines, final int yStart, final int textColor) {
