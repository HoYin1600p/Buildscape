   ...
   public static class Builder {
      ...
      public SpriteIconButton build() {
         if (this.sprite == null) {
            ...
            return (SpriteIconButton)(this.iconOnly ? new SpriteIconButton.CenteredIcon(this.width, this.height, this.message, this.spriteWidth, this.spriteHeight, this.spriteOffsetX, this.spriteOffsetY, this.sprite, this.onPress, this.tooltip, this.narration, this.switchToLoadingAfterPress) : new SpriteIconButton.TextAndIcon(this.width, this.height, this.message, this.spriteWidth, this.spriteHeight, this.spriteOffsetX, this.spriteOffsetY, this.sprite, this.onPress, this.tooltip, this.narration, this.switchToLoadingAfterPress));
         }
      }
   }
