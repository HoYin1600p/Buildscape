...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   private static final Set EXPLOSION_RESISTANT = (Set)ImmutableList.builder().add(new Block[]{Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.PIGLIN_HEAD, Blocks.SHULKER_BOX}).addAll(Blocks.DYED_SHULKER_BOX.asList()).build().stream().map(ItemLike::asItem).collect(Collectors.toSet());
   ...
   protected void generate() {
      ...
      this.add(Blocks.SEA_PICKLE, (block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, LootItem.lootTableItem(block).apply(List.of(2, 3, 4), (count) -> (LootItemFunction.Builder)SetItemCountFunction.setCount(ConstantValue.exactly((float)count.intValue())).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, count))))))));
      ...
      this.add(Blocks.SNOW, (block) -> LootTable.lootTable().withPool(((LootPool.Builder)LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS))).add(AlternativesEntry.alternatives((LootPoolEntryContainer.Builder)AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (layers) -> (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, layers)))).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)layers.intValue())))).when(this.doesNotHaveSilkTouch()), AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), (layers) -> (LootPoolEntryContainer.Builder)(layers == 8 ? LootItem.lootTableItem(Blocks.SNOW_BLOCK) : (LootPoolEntryContainer.Builder)((UniformContainerBase.Builder)LootItem.lootTableItem(Blocks.SNOW).apply(SetItemCountFunction.setCount(ConstantValue.exactly((float)layers.intValue())))).when(MatchBlock.blockMatches(this.blocks, block, StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, layers)))))))));
   ...
   private LootTable.Builder createPitcherCropLoot() {
      return (LootTable.Builder)this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(PitcherCropBlock.AGE.getPossibleValues(), (age) -> {
         LootItemCondition.Builder isLowerPart = MatchBlock.blockMatches(this.blocks, Blocks.PITCHER_CROP, StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
