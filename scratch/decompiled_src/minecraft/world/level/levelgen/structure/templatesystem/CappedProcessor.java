...
public class CappedProcessor implements StructureProcessor {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(StructureProcessorType.SINGLE_CODEC.fieldOf("delegate").forGetter((c) -> c.delegate), IntProviders.POSITIVE_CODEC.fieldOf("limit").forGetter((c) -> c.limit)).apply(i, CappedProcessor::new));
