...
public class RuleProcessor implements StructureProcessor {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(ProcessorRule.CODEC.listOf().fieldOf("rules").forGetter((p) -> p.rules)).apply(i, RuleProcessor::new));
