...
public class KillCommand {
   private static final CommandResponseTracker.Messages RESPONSE_KILL = CommandResponseTracker.messages((entity, var1) -> Component.translatable("commands.kill.success.single", entity.getDisplayName()), (entityCount, var1) -> Component.translatable("commands.kill.success.multiple", entityCount));
   ...
   private static int kill(final CommandSourceStack source, final Collection victims) throws CommandSyntaxException {
