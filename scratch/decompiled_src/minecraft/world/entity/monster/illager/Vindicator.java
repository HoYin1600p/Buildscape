...
public class Vindicator extends AbstractIllager {
   ...
   public void applyRaidBuffs(final ServerLevel level, final int wave, final boolean isCaptain) {
      ...
      if (shouldEnchant) {
         ResourceKey provider = wave > raid.getNumGroups(Difficulty.NORMAL) ? VanillaEnchantmentProviders.RAID_VINDICATOR_POST_WAVE_5 : VanillaEnchantmentProviders.RAID_VINDICATOR;
