...
public class RenderTypes {
   static final BiFunction OUTLINE = Util.memoize((BiFunction)((texture, cullState) -> RenderType.create("outline", RenderSetup.builder(cullState ? RenderPipelines.OUTLINE_CULL : RenderPipelines.OUTLINE_NO_CULL).withTexture("Sampler0", texture).setOutline(RenderSetup.OutlineProperty.IS_OUTLINE).createRenderSetup())));
   ...
   private static final RenderType TRANSLUCENT_MOVING_BLOCK = RenderType.create("translucent_moving_block", createMovingBlockSetup(RenderPipelines.TRANSLUCENT_BLOCK, true));
   private static final Function ARMOR_CUTOUT_NO_CULL = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ARMOR_CUTOUT_NO_CULL_GLINT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ARMOR_TRIM = Util.memoize((Function)((texture) -> {
      RenderSetup state = RenderSetup.builder(RenderPipelines.ARMOR_CUTOUT_NO_CULL).withTexture("Sampler0", texture).useLightmap().useOverlay().setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).affectsCrumbling().setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE).createRenderSetup();
      return RenderType.create("armor_trim", state);
   }));
   private static final Function ARMOR_TRIM_DECAL = Util.memoize((Function)((texture) -> {
   ...
   private static final Function WOLF_ARMOR_CRACKS = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ENTITY_SOLID = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ENTITY_SOLID_GLINT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ENTITY_SOLID_Z_OFFSET_FORWARD = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ENTITY_CUTOUT_CULL = Util.memoize((Function)((texture) -> {
   ...
   private static final BiFunction ENTITY_CUTOUT = Util.memoize((BiFunction)((texture, affectsOutline) -> {
   ...
   private static final BiFunction ENTITY_CUTOUT_Z_OFFSET = Util.memoize((BiFunction)((texture, affectsOutline) -> {
   ...
   private static final BiFunction ENTITY_CUTOUT_DISSOLVE = Util.memoize((BiFunction)((texture, maskTexture) -> {
   ...
   private static final Function ENTITY_TRANSLUCENT_CULL = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_CUTOUT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_CUTOUT_GLINT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_CUTOUT_GLINT_SPECIAL = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_TRANSLUCENT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_TRANSLUCENT_GLINT = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ITEM_TRANSLUCENT_GLINT_SPECIAL = Util.memoize((Function)((texture) -> {
   ...
   private static final BiFunction ENTITY_TRANSLUCENT = Util.memoize((BiFunction)((texture, affectsOutline) -> {
   ...
   private static final BiFunction ENTITY_TRANSLUCENT_EMISSIVE = Util.memoize((BiFunction)((texture, affectsOutline) -> {
   ...
   private static final Function END_CRYSTAL_BEAM = Util.memoize((Function)((texture) -> {
   ...
   private static final BiFunction BEACON_BEAM = Util.memoize((BiFunction)((texture, translucent) -> {
   ...
   private static final Function BANNER_PATTERN = Util.memoize((Function)((texture) -> {
   ...
   private static final Function ENTITY_SHADOW = Util.memoize((Function)((texture) -> {
   ...
   private static final Function EYES = Util.memoize((Function)((texture) -> RenderType.create("eyes", RenderSetup.builder(RenderPipelines.EYES).setOitPipelines(RenderPipelines.OIT_EYES).withTexture("Sampler0", texture).sortOnUpload().createRenderSetup())));
   ...
   private static final RenderType PATTERNED_SHIELD_GLINT = RenderType.create("patterned_shield_glint", RenderSetup.builder(RenderPipelines.GLINT).withTexture("Sampler0", ItemFeatureRenderer.ENCHANTED_GLINT_ITEM).setTextureTransform(TextureTransform.ENTITY_GLINT_TEXTURING).withForcedSolidModelPhase().createRenderSetup());
   private static final RenderType TRIMMED_ARMOR_GLINT = RenderType.create("trimmed_armor_glint", RenderSetup.builder(RenderPipelines.GLINT).withTexture("Sampler0", ItemFeatureRenderer.ENCHANTED_GLINT_ARMOR).setTextureTransform(TextureTransform.ARMOR_ENTITY_GLINT_TEXTURING).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).withForcedSolidModelPhase().createRenderSetup());
   private static final Function CRUMBLING = Util.memoize((Function)((texture) -> RenderType.create("crumbling", RenderSetup.builder(RenderPipelines.CRUMBLING).setOitPipelines(RenderPipelines.OIT_CRUMBLING).withTexture("Sampler0", texture).sortOnUpload().createRenderSetup())));
   private static final Function TEXT = Util.memoize((Function)((texture) -> RenderType.create("text", RenderSetup.builder(RenderPipelines.TEXT).setOitPipelines(RenderPipelines.OIT_TEXT).withTexture("Sampler0", texture).useLightmap().createRenderSetup())));
   private static final Function TEXT_GRAYSCALE = Util.memoize((Function)((texture) -> RenderType.create("text_grayscale", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE).setOitPipelines(RenderPipelines.OIT_TEXT_GRAYSCALE).withTexture("Sampler0", texture).useLightmap().createRenderSetup())));
   private static final Function TEXT_POLYGON_OFFSET = Util.memoize((Function)((texture) -> RenderType.create("text_polygon_offset", RenderSetup.builder(RenderPipelines.TEXT_POLYGON_OFFSET).setOitPipelines(RenderPipelines.OIT_TEXT_POLYGON_OFFSET).withTexture("Sampler0", texture).useLightmap().sortOnUpload().createRenderSetup())));
   private static final Function TEXT_GRAYSCALE_POLYGON_OFFSET = Util.memoize((Function)((texture) -> RenderType.create("text_grayscale_polygon_offset", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE_POLYGON_OFFSET).setOitPipelines(RenderPipelines.OIT_TEXT_GRAYSCALE_POLYGON_OFFSET).withTexture("Sampler0", texture).useLightmap().sortOnUpload().createRenderSetup())));
   private static final Function TEXT_SEE_THROUGH = Util.memoize((Function)((texture) -> RenderType.create("text_see_through", RenderSetup.builder(RenderPipelines.TEXT_SEE_THROUGH).withTexture("Sampler0", texture).useLightmap().createRenderSetup())));
   private static final Function TEXT_GRAYSCALE_SEE_THROUGH = Util.memoize((Function)((texture) -> RenderType.create("text_grayscale_see_through", RenderSetup.builder(RenderPipelines.TEXT_GRAYSCALE_SEE_THROUGH).withTexture("Sampler0", texture).useLightmap().sortOnUpload().createRenderSetup())));
   private static final RenderType LIGHTNING = RenderType.create("lightning", RenderSetup.builder(RenderPipelines.LIGHTNING).setOitPipelines(RenderPipelines.OIT_LIGHTNING).sortOnUpload().createRenderSetup());
   private static final RenderType DRAGON_RAYS = RenderType.create("dragon_rays", RenderSetup.builder(RenderPipelines.DRAGON_RAYS).setOitPipelines(RenderPipelines.OIT_DRAGON_RAYS).createRenderSetup());
   private static final RenderType END_PORTAL = RenderType.create("end_portal", RenderSetup.builder(RenderPipelines.END_PORTAL).withTexture("Sampler0", AbstractEndPortalRenderer.END_SKY_LOCATION).withTexture("Sampler1", AbstractEndPortalRenderer.END_PORTAL_LOCATION).setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE).createRenderSetup());
   private static final RenderType END_GATEWAY = RenderType.create("end_gateway", RenderSetup.builder(RenderPipelines.END_GATEWAY).withTexture("Sampler0", AbstractEndPortalRenderer.END_SKY_LOCATION).withTexture("Sampler1", AbstractEndPortalRenderer.END_PORTAL_LOCATION).setOutline(RenderSetup.OutlineProperty.AFFECTS_OUTLINE).createRenderSetup());
   public static final RenderType LINES = RenderType.create("lines", RenderSetup.builder(RenderPipelines.LINES).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   public static final RenderType LINES_TRANSLUCENT = RenderType.create("lines_translucent", RenderSetup.builder(RenderPipelines.LINES_TRANSLUCENT).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   public static final RenderType LINES_TRANSLUCENT_NO_DEPTH_WRITE = RenderType.create("lines_translucent_no_depth_write", RenderSetup.builder(RenderPipelines.LINES_TRANSLUCENT_NO_DEPTH_WRITE).setOitPipelines(RenderPipelines.OIT_LINES_TRANSLUCENT).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   public static final RenderType LINES_DEPTH_BIAS = RenderType.create("lines_translucent_depth_bias", RenderSetup.builder(RenderPipelines.LINES_DEPTH_BIAS).setOitPipelines(RenderPipelines.OIT_LINES_TRANSLUCENT).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   public static final RenderType SECONDARY_BLOCK_OUTLINE = RenderType.create("secondary_block_outline", RenderSetup.builder(RenderPipelines.SECONDARY_BLOCK_OUTLINE).setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   private static final RenderType DEBUG_FILLED_BOX = RenderType.create("debug_filled_box", RenderSetup.builder(RenderPipelines.DEBUG_FILLED_BOX).setOitPipelines(RenderPipelines.OIT_DEBUG_FILLED_BOX).sortOnUpload().setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING).createRenderSetup());
   private static final RenderType DEBUG_POINT = RenderType.create("debug_point", RenderSetup.builder(RenderPipelines.DEBUG_POINTS).setOitPipelines(RenderPipelines.OIT_DEBUG_POINTS).createRenderSetup());
   private static final RenderType DEBUG_QUADS = RenderType.create("debug_quads", RenderSetup.builder(RenderPipelines.DEBUG_QUADS).setOitPipelines(RenderPipelines.OIT_DEBUG_QUADS).sortOnUpload().createRenderSetup());
   private static final RenderType DEBUG_TRIANGLE_FAN = RenderType.create("debug_triangle_fan", RenderSetup.builder(RenderPipelines.DEBUG_TRIANGLE_FAN).setOitPipelines(RenderPipelines.OIT_DEBUG_TRIANGLE_FAN).createRenderSetup());
   private static final Function BLOCK_SCREEN_EFFECT = Util.memoize((Function)((texture) -> RenderType.create("block_screen_effect", RenderSetup.builder(RenderPipelines.BLOCK_SCREEN_EFFECT).withTexture("Sampler0", texture).createRenderSetup())));
   private static final Function FIRE_SCREEN_EFFECT = Util.memoize((Function)((texture) -> RenderType.create("fire_screen_effect", RenderSetup.builder(RenderPipelines.FIRE_SCREEN_EFFECT).withTexture("Sampler0", texture).createRenderSetup())));
