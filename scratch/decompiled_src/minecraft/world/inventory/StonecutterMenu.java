...
public class StonecutterMenu extends AbstractContainerMenu {
   ...
   private SelectableRecipe.SingleInputSet recipesForInput = SelectableRecipe.SingleInputSet.empty();
   ...
   private void setupResultSlot(final int index) {
      ...
      if (!this.recipesForInput.isEmpty() && this.isValidRecipeIndex(index)) {
         SelectableRecipe.SingleInputEntry entry = (SelectableRecipe.SingleInputEntry)this.recipesForInput.entries().get(index);
