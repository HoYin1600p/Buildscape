...
public abstract class RecipeProvider {
   ...
   private final HolderGetter trimPatterns;
   protected final RecipeOutput output;
   protected final BootstrapContext advancementOutput;
   private static final Map SHAPE_BUILDERS = ImmutableMap.builder().put(BlockFamily.Variant.BUTTON, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.buttonBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.CHISELED, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.chiseledBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.CARPET, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.carpetBuilder(RecipeCategory.DECORATIONS, result, Ingredient.of(base))).put(BlockFamily.Variant.CUT, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.cutBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.DOOR, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.doorBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.CUSTOM_FENCE, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.fenceBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.FENCE, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.fenceBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.CUSTOM_FENCE_GATE, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.fenceGateBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.FENCE_GATE, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.fenceGateBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.SIGN, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.signBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.CUSTOM_HANGING_SIGN, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.hangingSignBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.HANGING_SIGN, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.hangingSignBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.SLAB, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.slabBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.STAIRS, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.stairBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.PRESSURE_PLATE, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.pressurePlateBuilder(RecipeCategory.REDSTONE, result, Ingredient.of(base))).put(BlockFamily.Variant.POLISHED, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.polishedBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.TRAPDOOR, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.trapdoorBuilder(result, Ingredient.of(base))).put(BlockFamily.Variant.WALL, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.wallBuilder(RecipeCategory.DECORATIONS, result, Ingredient.of(base))).put(BlockFamily.Variant.BRICKS, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.bricksBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.TILES, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.tilesBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).put(BlockFamily.Variant.PILLAR, (RecipeProvider.FamilyCraftingRecipeProvider)(context, result, base) -> context.pillarBuilder(RecipeCategory.BUILDING_BLOCKS, result, Ingredient.of(base))).build();
   private static final Map STONECUTTER_RECIPE_BUILDERS = ImmutableMap.builder().put(BlockFamily.Variant.SLAB, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 2)).put(BlockFamily.Variant.STAIRS, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.BRICKS, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.WALL, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.DECORATIONS, result, base, 1)).put(BlockFamily.Variant.CHISELED, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.POLISHED, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.CUT, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.TILES, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.PILLAR, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).put(BlockFamily.Variant.COBBLED, (RecipeProvider.FamilyStonecutterRecipeProvider)(context, result, base) -> context.stonecutterResultFromBase(RecipeCategory.BUILDING_BLOCKS, result, base, 1)).build();

   protected RecipeProvider(final BootstrapContext recipeOutput, final BootstrapContext advancementOutput) {
      this.advancementOutput = advancementOutput;
      this.output = new RecipeOutput(this) {
         {
   ...
   protected void trimSmithing(final Item trimTemplate, final ResourceKey patternId, final ResourceKey id) {
      Holder.Reference pattern = this.trimPatterns.getOrThrow(patternId);
   ...
   protected void colorWithDye(final List dyes, final List dyedItems, final @Nullable Item uncoloredItem, final String groupName, final RecipeCategory category) {
      for(int dyeIndex = 0; dyeIndex < dyes.size(); ++dyeIndex) {
         ...
         Stream sourceItems = dyedItems.stream().filter((b) -> !b.equals(dyedItem));
         if (uncoloredItem != null) {
            sourceItems = Stream.concat(sourceItems, Stream.of(uncoloredItem));
         }

         this.shapeless(category, dyedItem).requires(dye).requires(Ingredient.of(sourceItems)).group(groupName).unlockedBy("has_needed_dye", this.has(dye)).save(this.output, "dye_" + getItemName(dyedItem));
      }
   ...
   protected void concretePowder(final ItemLike result, final ItemLike dye) {
      this.shapeless(RecipeCategory.BUILDING_BLOCKS, result, 8).requires(dye).requires(Blocks.SAND, 4).requires(Blocks.GRAVEL, 4).group("concrete_powder").unlockedBy("has_sand", this.has(Blocks.SAND)).unlockedBy("has_gravel", this.has(Blocks.GRAVEL)).save(this.output);
   }
   ...
   protected void stonecutterResultFromBase(final RecipeCategory category, final ItemLike result, final ItemLike base, final int count) {
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(base), category, result, count).unlockedBy(getHasName(base), this.has(base)).save(this.output, getConversionRecipeName(result, base) + "_stonecutting");
   }
   ...
   private void simpleCookingRecipe(final String source, final AbstractCookingRecipe.Factory factory, final int cookingTime, final ItemLike base, final ItemLike result, final float experience) {
      SimpleCookingRecipeBuilder.generic(Ingredient.of(base), RecipeCategory.FOOD, CookingBookCategory.FOOD, result, experience, cookingTime, factory).unlockedBy(getHasName(base), this.has(base)).save(this.output, getItemName(result) + "_from_" + source);
   }
   ...
   protected void waxRecipes(final FeatureFlagSet flagSet) {
      ((BiMap)HoneycombItem.WAXABLES.get()).forEach((block, waxedBlock) -> {
         if (waxedBlock.requiredFeatures().isSubsetOf(flagSet)) {
            Pair pair = (Pair)HoneycombItem.WAXED_RECIPES.getOrDefault(waxedBlock, Pair.of(RecipeCategory.BUILDING_BLOCKS, getItemName(waxedBlock)));
            RecipeCategory recipeCategory = (RecipeCategory)pair.getFirst();
            String group = (String)pair.getSecond();
            this.shapeless(recipeCategory, waxedBlock).requires(block).requires(Items.HONEYCOMB).group(group).unlockedBy(getHasName(block), this.has(block)).save(this.output, getConversionRecipeName(waxedBlock, Items.HONEYCOMB));
         }
      });
   }
   ...
   protected void suspiciousStew(final Item item, final SuspiciousEffectHolder effectHolder) {
      ...
      this.shapeless(RecipeCategory.FOOD, stew).requires(Items.BOWL).requires(ItemTags.MUSHROOMS).requires(ItemTags.MUSHROOMS).requires(item).group("suspicious_stew").unlockedBy(getHasName(item), this.has(item)).save(this.output, getItemName((ItemLike)stew.item().value()) + "_from_" + getItemName(item));
   }
