...
public class JigsawBlockEntity extends BlockEntity {
   public static final Codec POOL_CODEC = ResourceKey.codec(Registries.TEMPLATE_POOL);
   ...
   private ResourceKey pool = Pools.EMPTY;
   ...
   protected void loadAdditional(final ValueInput input) {
      ...
      this.joint = (JigsawBlockEntity.JointType)input.read("joint", JigsawBlockEntity.JointType.CODEC).orElseGet(() -> StructureTemplate.getDefaultJointType(this.getBlockState()));
   ...
   public void generate(final ServerLevel level, final int levels, final boolean keepJigsaws) {
      ...
      Registry poolRegistry = level.registryAccess().lookupOrThrow(Registries.TEMPLATE_POOL);
      Holder pool = poolRegistry.getOrThrow(this.pool);
   ...
   public static enum JointType implements StringRepresentable {
      ...
      public static final StringRepresentable.EnumCodec CODEC = StringRepresentable.fromEnum(JigsawBlockEntity.JointType::values);
