...
public class ServerData {
   ...
   public static enum ServerPackStatus {
      ...
      public static final MapCodec FIELD_CODEC = Codec.BOOL.optionalFieldOf("acceptTextures").xmap((acceptTextures) -> (ServerData.ServerPackStatus)acceptTextures.map((b) -> b ? ENABLED : DISABLED).orElse(PROMPT), (status) -> {
         Optional var10000;
