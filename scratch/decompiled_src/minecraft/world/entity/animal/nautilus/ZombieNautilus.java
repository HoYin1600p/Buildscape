...
public class ZombieNautilus extends AbstractNautilus {
   ...
   private static final EntityDataAccessor DATA_VARIANT_ID = SynchedEntityData.defineId(ZombieNautilus.class, EntityDataSerializers.ZOMBIE_NAUTILUS_VARIANT);
   ...
   protected boolean applyImplicitComponent(final DataComponentType type, final Object value) {
      if (type == DataComponents.ZOMBIE_NAUTILUS_VARIANT) {
         Holder variant = (Holder)castComponentValue(DataComponents.ZOMBIE_NAUTILUS_VARIANT, value);
