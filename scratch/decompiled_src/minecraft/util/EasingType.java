...
public interface EasingType {
   ...
   Codec CODEC = Codec.either(SIMPLE_REGISTRY.codec(Codec.STRING), EasingType.CubicBezier.CODEC).xmap(Either::unwrap, (easing) -> {
      Either var10000;
      if (easing instanceof EasingType.CubicBezier bezier) {
   ...
   public static final class CubicBezier implements EasingType {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(EasingType.CubicBezierControls.CODEC.fieldOf("cubic_bezier").forGetter((b) -> b.controls)).apply(i, EasingType.CubicBezier::new));
      ...
      public boolean equals(final Object obj) {
         if (obj instanceof EasingType.CubicBezier bezier) {
   ...
   public static record CubicBezierControls(float x1, float y1, float x2, float y2) {
      public static final Codec CODEC = Codec.FLOAT.listOf(4, 4).xmap((floats) -> new EasingType.CubicBezierControls(floats.get(0), floats.get(1), floats.get(2), floats.get(3)), (controls) -> List.of(controls.x1, controls.y1, controls.x2, controls.y2)).validate(EasingType.CubicBezierControls::validate);
