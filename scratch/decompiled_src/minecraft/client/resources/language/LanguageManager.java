...
public class LanguageManager implements ResourceManagerReloadListener {
   ...
   private Map languages = ImmutableMap.of("en_us", DEFAULT_LANGUAGE);
   private String currentCode;
   private final Consumer reloadCallback;

   public LanguageManager(final Minecraft minecraft, final String languageCode, final Consumer reloadCallback) {
   ...
   public void onResourceManagerReload(final ResourceManager resourceManager) {
      ...
      List languageStack = new ArrayList(2);
      ...
      try {
         ...
         this.minecraft.gui.setScreen(new ErrorScreen(Component.translatable("options.language.load_translations_failed"), Component.translatable("options.language.empty_or_missing_translation", var5.getLanguageCode())));
