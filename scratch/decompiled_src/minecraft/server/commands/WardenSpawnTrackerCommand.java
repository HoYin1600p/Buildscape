...
public class WardenSpawnTrackerCommand {
   private static final CommandResponseTracker.Messages RESPONSE_SET_LEVEL = CommandResponseTracker.messages((player, var1) -> Component.translatable("commands.warden_spawn_tracker.set.success.single", player.getDisplayName()), (playerCount, var1) -> Component.translatable("commands.warden_spawn_tracker.set.success.multiple", playerCount));
   private static final CommandResponseTracker.Messages RESPONSE_RESET = CommandResponseTracker.messages((player, var1) -> Component.translatable("commands.warden_spawn_tracker.clear.success.single", player.getDisplayName()), (playerCount, var1) -> Component.translatable("commands.warden_spawn_tracker.clear.success.multiple", playerCount));
   ...
   private static int setWarningLevel(final CommandSourceStack source, final Collection players, final int warningLevel) throws CommandSyntaxException {
   ...
   private static int resetTracker(final CommandSourceStack source, final Collection players) throws CommandSyntaxException {
      CommandResponseTracker tracker = CommandResponseTracker.create();
