...
public abstract class AbstractSignRenderer implements BlockEntityRenderer {
   ...
   private void submitSignText(final SignRenderState state, final PoseStack poseStack, final SubmitNodeCollector submitNodeCollector, final SignText signText) {
      ...
      FormattedCharSequence[] formattedLines = signText.getRenderMessages(state.isTextFilteringEnabled, (input) -> {
         List components = this.font.split(input, state.maxTextLineWidth);
