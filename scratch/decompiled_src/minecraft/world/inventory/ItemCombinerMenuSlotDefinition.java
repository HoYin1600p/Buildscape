...
public class ItemCombinerMenuSlotDefinition {
   ...
   private ItemCombinerMenuSlotDefinition(final List inputSlots, final ItemCombinerMenuSlotDefinition.SlotDefinition resultSlot) {
   ...
   public static class Builder {
      ...
      public ItemCombinerMenuSlotDefinition.Builder withSlot(final int slotIndex, final int xPlacement, final int yPlacement, final Predicate mayPlace) {
