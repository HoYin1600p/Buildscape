...
public class HttpUtil {
   ...
   public static Path downloadFile(final Path targetDir, final URL url, final Map headers, final HashFunction hashFunction, final @Nullable HashCode requestedHash, final int maxSize, final Proxy proxy, final HttpUtil.DownloadProgressListener listener) {
      ...
      if (requestedHash != null) {
         ...
         try {
            ...
            throw new UncheckedIOException("Failed to remove existing file " + String.valueOf(targetFile), var34);
         }
      } else {
         targetFile = null;
      }
   ...
   private static HashCode downloadAndHash(final HashFunction hashFunction, final int maxSize, final HttpUtil.DownloadProgressListener listener, final InputStream input, final Path downloadFile) throws IOException {
