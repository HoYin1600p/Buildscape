...
public class Sound implements Weighted {
   ...
   public Sound(final Identifier location, final SampledFloat volume, final SampledFloat pitch, final int weight, final Sound.Type type, final boolean stream, final boolean preload, final int attenuationDistance) {
