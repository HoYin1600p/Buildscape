...
public class Armadillo extends Animal {
   ...
   private static final Brain.Provider BRAIN_PROVIDER = Brain.provider(List.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.HURT_BY, SensorType.FOOD_TEMPTATIONS, SensorType.NEAREST_ADULT, SensorType.ARMADILLO_SCARE_DETECTED), (var0) -> ArmadilloAi.getActivities());
   private static final EntityDataAccessor ARMADILLO_STATE = SynchedEntityData.defineId(Armadillo.class, EntityDataSerializers.ARMADILLO_STATE);
   ...
   public @Nullable AgeableMob getBreedOffspring(final ServerLevel level, final AgeableMob partner) {
      return (AgeableMob)EntityTypes.ARMADILLO.create(level, EntitySpawnReason.BREEDING);
   }
   ...
   public static enum ArmadilloState implements StringRepresentable {
      ...
      private static final Codec CODEC = StringRepresentable.fromEnum(Armadillo.ArmadilloState::values);
      private static final IntFunction BY_ID = ByIdMap.continuous(Armadillo.ArmadilloState::id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      public static final StreamCodec STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, Armadillo.ArmadilloState::id);
