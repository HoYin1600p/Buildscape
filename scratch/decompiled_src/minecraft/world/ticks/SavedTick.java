...
public record SavedTick(Object type, BlockPos pos, int delay, TickPriority priority) {
   ...
   public static Codec codec(final Codec typeCodec) {
      MapCodec posCodec = RecordCodecBuilder.mapCodec((i) -> i.group(Codec.INT.fieldOf("x").forGetter(Vec3i::getX), Codec.INT.fieldOf("y").forGetter(Vec3i::getY), Codec.INT.fieldOf("z").forGetter(Vec3i::getZ)).apply(i, BlockPos::new));
