...
public record ItemQuads(List all, List solid, List translucent) {
   public static final ItemQuads EMPTY = new ItemQuads(List.of(), List.of(), List.of());

   public static ItemQuads split(final List quads) {
      if (quads.isEmpty()) {
         return EMPTY;
      } else {
         List solid = new ArrayList();
         List translucent = new ArrayList();
