...
public record DeathProtection(List deathEffects) {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ConsumeEffect.STREAM_CODEC.apply(ByteBufCodecs.list()), DeathProtection::deathEffects, DeathProtection::new);
