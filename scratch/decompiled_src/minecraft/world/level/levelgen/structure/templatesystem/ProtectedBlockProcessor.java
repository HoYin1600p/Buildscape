...
public record ProtectedBlockProcessor(HolderSet cannotReplace) implements StructureProcessor {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(RegistryCodecs.holderSet(Registries.BLOCK).fieldOf("value").forGetter(ProtectedBlockProcessor::cannotReplace)).apply(i, ProtectedBlockProcessor::new));
