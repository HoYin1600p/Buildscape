...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   private final AtomicReference state = new AtomicReference(ClientHandshakePacketListenerImpl.State.CONNECTING);
   ...
   public void fillListenerSpecificCrashDetails(final CrashReport report, final CrashReportCategory connectionDetails) {
      ...
      connectionDetails.setDetail("Login phase", (CrashReportDetail)(() -> ((ClientHandshakePacketListenerImpl.State)this.state.get()).toString()));
