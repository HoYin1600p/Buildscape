...
public abstract class AbstractMountInventoryMenu extends AbstractContainerMenu {
   ...
   public boolean stillValid(final Player player) {
      return !this.hasInventoryChanged(this.mountContainer) && this.mountContainer.stillValid(player) && this.mount.isAlive() && player.isWithinEntityInteractionRange(this.mount, 4.0D);
   }
