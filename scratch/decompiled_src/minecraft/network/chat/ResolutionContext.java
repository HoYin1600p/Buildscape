...
public record ResolutionContext(@Nullable CommandSourceStack source, @Nullable Entity defaultScoreboardEntity, Predicate objectInfoValidator, int depthLimit, ResolutionContext.LimitBehavior depthLimitBehavior, int resolvedComponentLimit, MutableInt resolvedComponentCount) {
   ...
   public static class Builder {
      ...
      private Predicate objectInfoValidator = (var0) -> true;
      ...
      public ResolutionContext.Builder withObjectInfoValidator(final Predicate objectInfoValidator) {
   ...
   public static enum LimitBehavior {
      ...
      // $FF: synthetic method
      private static ResolutionContext.LimitBehavior[] $values() {
         return new ResolutionContext.LimitBehavior[]{DISCARD_REMAINING, STOP_PROCESSING_AND_COPY_REMAINING};
      }
   }
}
