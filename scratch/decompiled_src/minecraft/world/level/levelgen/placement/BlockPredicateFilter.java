...
public record BlockPredicateFilter(BlockPredicate predicate) implements PlacementFilter {
   public static final MapCodec CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(BlockPredicate.CODEC.fieldOf("predicate").forGetter(BlockPredicateFilter::predicate)).apply(i, BlockPredicateFilter::new));
