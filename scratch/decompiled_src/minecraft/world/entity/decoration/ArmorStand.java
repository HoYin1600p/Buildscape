...
public class ArmorStand extends LivingEntity {
   ...
   private EquipmentSlot getClickedSlot(final Vec3 location) {
      ...
      if (clickYPosition >= 0.1D && clickYPosition < 0.1D + (small ? 0.8D : 0.45D) && this.hasItemInSlot(feet)) {
         slotClicked = EquipmentSlot.FEET;
      } else if (clickYPosition >= 0.9D + (small ? 0.3D : 0.0D) && clickYPosition < 0.9D + (small ? 1.0D : 0.7D) && this.hasItemInSlot(EquipmentSlot.CHEST)) {
         slotClicked = EquipmentSlot.CHEST;
      } else if (clickYPosition >= 0.4D && clickYPosition < 0.4D + (small ? 1.0D : 0.8D) && this.hasItemInSlot(EquipmentSlot.LEGS)) {
         slotClicked = EquipmentSlot.LEGS;
      } else if (clickYPosition >= 1.6D && this.hasItemInSlot(EquipmentSlot.HEAD)) {
   ...
   public static record ArmorStandPose(Rotations head, Rotations body, Rotations leftArm, Rotations rightArm, Rotations leftLeg, Rotations rightLeg) {
      ...
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(Rotations.CODEC.optionalFieldOf("Head", ArmorStand.DEFAULT_HEAD_POSE).forGetter(ArmorStand.ArmorStandPose::head), Rotations.CODEC.optionalFieldOf("Body", ArmorStand.DEFAULT_BODY_POSE).forGetter(ArmorStand.ArmorStandPose::body), Rotations.CODEC.optionalFieldOf("LeftArm", ArmorStand.DEFAULT_LEFT_ARM_POSE).forGetter(ArmorStand.ArmorStandPose::leftArm), Rotations.CODEC.optionalFieldOf("RightArm", ArmorStand.DEFAULT_RIGHT_ARM_POSE).forGetter(ArmorStand.ArmorStandPose::rightArm), Rotations.CODEC.optionalFieldOf("LeftLeg", ArmorStand.DEFAULT_LEFT_LEG_POSE).forGetter(ArmorStand.ArmorStandPose::leftLeg), Rotations.CODEC.optionalFieldOf("RightLeg", ArmorStand.DEFAULT_RIGHT_LEG_POSE).forGetter(ArmorStand.ArmorStandPose::rightLeg)).apply(i, ArmorStand.ArmorStandPose::new));
   }
}
