...
public abstract class StructurePoolElement {
   public static final Codec CODEC = BuiltInRegistries.STRUCTURE_POOL_ELEMENT.byNameCodec().dispatch("element_type", StructurePoolElement::getType, StructurePoolElementType::codec);
   private static final Holder EMPTY = Holder.direct(new StructureProcessorList(List.of()));
