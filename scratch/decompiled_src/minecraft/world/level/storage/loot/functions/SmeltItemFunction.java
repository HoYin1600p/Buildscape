...
public class SmeltItemFunction extends LootItemConditionalFunction {
   ...
   private SmeltItemFunction(final Optional condition, final boolean useInputCount) {
      super(condition);
   ...
   public ItemStack run(final ItemStack itemStack, final LootContext context) {
      if (itemStack.isEmpty()) {
         ...
         Optional recipe = context.getLevel().recipeAccess().getRecipeFor(RecipeType.SMELTING, input, context.getLevel());
         if (recipe.isPresent()) {
