...
public record CardinalLighting(float down, float up, float north, float south, float west, float east) {
   ...
   public static enum Type implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(CardinalLighting.Type::values);
      ...
      // $FF: synthetic method
      private static CardinalLighting.Type[] $values() {
         return new CardinalLighting.Type[]{DEFAULT, NETHER};
      }
   }
}
