...
public class FoxRenderer extends AgeableMobRenderer {
   ...
   private static final EnumMap TEXTURES_BY_VARIANT = Maps.newEnumMap(Map.of(Fox.Variant.RED, new FoxRenderer.FoxTexturesByState(new FoxRenderer.FoxTexturesByAge(RED_FOX_TEXTURE, BABY_RED_FOX_TEXTURE), new FoxRenderer.FoxTexturesByAge(RED_FOX_SLEEP_TEXTURE, BABY_RED_FOX_SLEEP_TEXTURE)), Fox.Variant.SNOW, new FoxRenderer.FoxTexturesByState(new FoxRenderer.FoxTexturesByAge(SNOW_FOX_TEXTURE, BABY_SNOW_FOX_TEXTURE), new FoxRenderer.FoxTexturesByAge(SNOW_FOX_SLEEP_TEXTURE, BABY_SNOW_FOX_SLEEP_TEXTURE))));
