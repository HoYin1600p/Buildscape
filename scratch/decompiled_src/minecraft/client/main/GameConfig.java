...
public class GameConfig {
   ...
   public GameConfig(final GameConfig.UserData userData, final DisplayData displayData, final GameConfig.FolderData folderData, final GameConfig.GameData gameData, final GameConfig.QuickPlayData quickPlayData) {
      this.user = userData;
