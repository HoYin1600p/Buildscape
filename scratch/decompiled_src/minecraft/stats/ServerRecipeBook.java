...
public class ServerRecipeBook extends RecipeBook {
   ...
   public int addRecipes(final Collection recipes, final ServerPlayer player) {
      List recipesToAdd = new ArrayList();
   ...
   public int removeRecipes(final Collection recipes, final ServerPlayer player) {
      List recipesToRemove = Lists.newArrayList();
   ...
   public void sendInitialRecipeBook(final ServerPlayer player) {
      ...
      List recipesToSend = new ArrayList(this.known.size());
   ...
   public void loadUntrusted(final ServerRecipeBook.Packed packed, final Predicate validator) {
      this.bookSettings.replaceFrom(packed.settings);
   ...
   public static record Packed(RecipeBookSettings settings, List known, List highlight) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(RecipeBookSettings.MAP_CODEC.forGetter(ServerRecipeBook.Packed::settings), Recipe.KEY_CODEC.listOf().fieldOf("recipes").forGetter(ServerRecipeBook.Packed::known), Recipe.KEY_CODEC.listOf().fieldOf("toBeDisplayed").forGetter(ServerRecipeBook.Packed::highlight)).apply(i, ServerRecipeBook.Packed::new));
   }
}
