         ...
         Util.ioPool().execute(() -> {
            try {
               ...
               try {
                  ...
                  Component component = Component.literal(file.getName()).withStyle(ChatFormatting.UNDERLINE).withStyle((s) -> s.withClickEvent(new ClickEvent.OpenFile(file.getAbsoluteFile())));
