...
public record StructureCheck(HolderSet requiredStructures) implements SpawnCondition {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(RegistryCodecs.holderSet(Registries.STRUCTURE).fieldOf("structures").forGetter(StructureCheck::requiredStructures)).apply(i, StructureCheck::new));
