...
public class RabbitRenderer extends AgeableMobRenderer {
   ...
   public Identifier getTextureLocation(final RabbitRenderState state) {
      if (state.isToast) {
         ...
         Map locations = state.isBaby ? BABY_RABBIT_LOCATIONS : RABBIT_LOCATIONS;
