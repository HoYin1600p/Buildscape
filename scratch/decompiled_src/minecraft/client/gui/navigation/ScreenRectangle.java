...
public record ScreenRectangle(ScreenPosition position, int width, int height) {
   ...
   public static ScreenRectangle of(final ScreenAxis primaryAxis, final int primaryIndex, final int secondaryIndex, final int primaryLength, final int secondaryLength) {
      ...
      switch (primaryAxis) {
         case HORIZONTAL:
            var10000 = new ScreenRectangle(primaryIndex, secondaryIndex, primaryLength, secondaryLength);
            break;
         case VERTICAL:
            var10000 = new ScreenRectangle(secondaryIndex, primaryIndex, secondaryLength, primaryLength);
            break;
         default:
