...
public class PoiRecord {
   ...
   public static record Packed(BlockPos pos, Holder poiType, int freeTickets) {
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(BlockPos.CODEC.fieldOf("pos").forGetter(PoiRecord.Packed::pos), RegistryCodecs.holder(Registries.POINT_OF_INTEREST_TYPE).fieldOf("type").forGetter(PoiRecord.Packed::poiType), Codec.INT.optionalFieldOf("free_tickets", 0).forGetter(PoiRecord.Packed::freeTickets)).apply(i, PoiRecord.Packed::new));
