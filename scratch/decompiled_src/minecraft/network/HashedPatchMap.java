...
public record HashedPatchMap(Map addedComponents, Set removedComponents) {
   ...
   public static HashedPatchMap create(final DataComponentPatch patch, final HashedPatchMap.HashGenerator hasher) {
      ...
      Map setComponentHashes = new IdentityHashMap(split.added().size());
