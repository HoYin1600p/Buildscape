...
public class CamelRenderer extends AgeableMobRenderer {
   ...
   protected static SimpleEquipmentLayer createCamelSaddleLayer(final EntityRendererProvider.Context context, final MobRenderer renderer, final EquipmentClientInfo.LayerType saddleLayerType, final ModelLayerLocation saddleModelLayer) {
      return new SimpleEquipmentLayer(renderer, context.getEquipmentRenderer(), saddleLayerType, (state) -> state.saddle, new CamelSaddleModel(context.bakeLayer(saddleModelLayer)), (EntityModel)null);
   }
