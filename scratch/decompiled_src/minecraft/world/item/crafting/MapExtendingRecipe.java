...
public class MapExtendingRecipe extends CustomRecipe {
   public static final MapCodec MAP_CODEC = RecordCodecBuilder.mapCodec((i) -> i.group(Ingredient.CODEC.fieldOf("map").forGetter((o) -> o.map), Ingredient.CODEC.fieldOf("material").forGetter((o) -> o.material), TransmuteResult.CODEC.fieldOf("result").forGetter((o) -> o.result)).apply(i, MapExtendingRecipe::new));
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.map, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.material, TransmuteResult.STREAM_CODEC, (o) -> o.result, MapExtendingRecipe::new);
