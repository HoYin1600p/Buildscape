...
public class ShipwreckPieces {
   ...
   private static final Map MARKERS_TO_LOOT = Map.of("map_chest", BuiltInLootTables.SHIPWRECK_MAP, "treasure_chest", BuiltInLootTables.SHIPWRECK_TREASURE, "supply_chest", BuiltInLootTables.SHIPWRECK_SUPPLY);

   public static ShipwreckPieces.ShipwreckPiece addRandomPiece(final StructureTemplateManager structureTemplateManager, final BlockPos position, final Rotation rotation, final StructurePieceAccessor structurePieceAccessor, final RandomSource random, final boolean isBeached) {
   ...
   public static class ShipwreckPiece extends TemplateStructurePiece {
      ...
      protected void handleDataMarker(final String markerId, final BlockPos position, final ServerLevelAccessor level, final RandomSource random, final BoundingBox chunkBB) {
         ResourceKey lootTable = (ResourceKey)ShipwreckPieces.MARKERS_TO_LOOT.get(markerId);
         if (lootTable != null) {
