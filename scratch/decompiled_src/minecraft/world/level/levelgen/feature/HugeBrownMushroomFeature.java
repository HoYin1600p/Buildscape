         ...
         for(int dz = -this.foliageRadius; dz <= this.foliageRadius; ++dz) {
            ...
            if (!xEdge || !zEdge) {
               ...
               if (state.hasProperty(HugeMushroomBlock.WEST) && state.hasProperty(HugeMushroomBlock.EAST) && state.hasProperty(HugeMushroomBlock.NORTH) && state.hasProperty(HugeMushroomBlock.SOUTH)) {
                  state = (BlockState)((BlockState)((BlockState)((BlockState)state.setValue(HugeMushroomBlock.WEST, Boolean.valueOf(west))).setValue(HugeMushroomBlock.EAST, Boolean.valueOf(east))).setValue(HugeMushroomBlock.NORTH, Boolean.valueOf(north))).setValue(HugeMushroomBlock.SOUTH, Boolean.valueOf(south));
               }
