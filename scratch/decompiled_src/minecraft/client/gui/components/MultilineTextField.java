...
public class MultilineTextField {
   ...
   private void reflowDisplayLines() {
      ...
      if (this.value.isEmpty()) {
         ...
         this.font.getSplitter().splitLines(this.value, this.width, Style.EMPTY, false, (style, start, end) -> this.displayLines.add(new MultilineTextField.StringView(start, end)));
