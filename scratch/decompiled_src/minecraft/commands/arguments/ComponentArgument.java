...
public class ComponentArgument extends ParserBasedArgument {
   ...
   private static final DynamicOps OPS = NbtOps.INSTANCE;
   private static final CommandArgumentParser TAG_PARSER = SnbtGrammar.createParser(OPS);
   ...
   public static Component getResolvedComponent(final CommandContext context, final String name, final Entity contentEntity) throws CommandSyntaxException {
