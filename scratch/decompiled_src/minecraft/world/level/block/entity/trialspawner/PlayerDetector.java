...
public interface PlayerDetector {
   ...
   List detect(final ServerLevel level, final PlayerDetector.EntitySelector selector, final BlockPos spawnerPos, final double requiredPlayerRange, final boolean requireLineOfSight);
   ...
   public interface EntitySelector {
      ...
      static PlayerDetector.EntitySelector onlySelectPlayers(final List players) {
