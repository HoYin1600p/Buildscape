...
public class RandomSpreadStructurePlacement extends AbstractSpreadingStructurePlacement {
   ...
   public RandomSpreadStructurePlacement(final Vec3i locateOffset, final AbstractSpreadingStructurePlacement.FrequencyReductionMethod frequencyReductionMethod, final float frequency, final int salt, final Optional exclusionZone, final int spacing, final int separation, final RandomSpreadType spreadType) {
