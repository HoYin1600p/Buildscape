...
public class ShadowFeatureRenderer extends RenderTypeFeatureRenderer {
   public static final FeatureRendererType TYPE = FeatureRendererType.create("Shadow");
   ...
   public static record Submit(Matrix4fc pose, float radius, List pieces) implements SubmitNode {
