...
public class DripParticle extends SingleQuadParticle {
   ...
   public static class HoneyHangProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         DripParticle.DripHangParticle particle = new DripParticle.DripHangParticle(level, x, y, z, Fluids.EMPTY, ParticleTypes.FALLING_HONEY, this.sprite.get(random));
         particle.gravity *= 0.01F;
   ...
   public static class HoneyLandProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         ...
         particle.lifetime = (int)(128.0D / ((double)random.nextFloat() * 0.8D + 0.2D));
   ...
   public static class NectarFallProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         ...
         particle.lifetime = (int)(16.0D / ((double)random.nextFloat() * 0.8D + 0.2D));
   ...
   public static class ObsidianTearHangProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         DripParticle.DripHangParticle particle = new DripParticle.DripHangParticle(level, x, y, z, Fluids.EMPTY, ParticleTypes.FALLING_OBSIDIAN_TEAR, this.sprite.get(random));
         particle.isGlowing = true;
         particle.gravity *= 0.01F;
         particle.lifetime = 100;
         particle.setColor(0.51171875F, 0.03125F, 0.890625F);
   ...
   public static class ObsidianTearLandProvider implements ParticleProvider {
      ...
      public Particle createParticle(final SimpleParticleType options, final ClientLevel level, final double x, final double y, final double z, final double xAux, final double yAux, final double zAux, final RandomSource random) {
         DripParticle particle = new DripParticle.DripLandParticle(level, x, y, z, Fluids.EMPTY, this.sprite.get(random));
         particle.isGlowing = true;
         particle.lifetime = (int)(28.0D / ((double)random.nextFloat() * 0.8D + 0.2D));
         particle.setColor(0.51171875F, 0.03125F, 0.890625F);
         return particle;
      }
   }
