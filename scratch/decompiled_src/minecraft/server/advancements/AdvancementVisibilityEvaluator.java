...
public class AdvancementVisibilityEvaluator {
   ...
   private static boolean evaluateVisibility(final AdvancementNode node, final Stack ascendants, final Predicate isDoneTest, final AdvancementVisibilityEvaluator.Output output) {
   ...
   public static void evaluateVisibility(final AdvancementNode node, final Predicate isDone, final AdvancementVisibilityEvaluator.Output output) {
      AdvancementNode root = node.root();
      Stack visibilityStack = new ObjectArrayList();
