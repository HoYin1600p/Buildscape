...
public class Vec2 {
   ...
   public static final Codec CODEC = Codec.FLOAT.listOf().comapFlatMap((input) -> Util.fixedSize(input, 2).map((floats) -> new Vec2(floats.get(0), floats.get(1))), (vec) -> List.of(vec.x, vec.y));
