...
public class StructureCheck {
   ...
   private boolean canCreateStructure(final ChunkPos pos, final Structure structure) {
      return structure.findValidGenerationPoint(new Structure.GenerationContext(this.registryAccess, this.chunkGenerator, this.biomeResolver, this.randomState, this.structureTemplateManager, this.seed, pos, this.heightAccessor, structure.biomes()::contains)).isPresent();
   }
   ...
   private @Nullable StructureCheckResult tryLoadFromStorage(final ChunkPos pos, final Structure structure, final boolean requireUnreferenced, final long posKey) {
      ...
      if (result instanceof CompoundTag chunkTag) {
         ...
         Object2IntMap knownStarts = this.loadStructures(fixedChunkTag);
         if (knownStarts == null) {
            return null;
         } else {
   ...
   private @Nullable Object2IntMap loadStructures(final CompoundTag chunkTag) {
      ...
      if (maybeStartsTag.isEmpty()) {
         ...
         if (startsTag.isEmpty()) {
            ...
            Object2IntMap knownStarts = new Object2IntOpenHashMap();
            Registry structuresRegistry = this.registryAccess.lookupOrThrow(Registries.STRUCTURE);
   ...
   public void onStructureLoad(final ChunkPos pos, final Map starts) {
      long posKey = pos.pack();
      Object2IntMap startsToReferences = new Object2IntOpenHashMap();
