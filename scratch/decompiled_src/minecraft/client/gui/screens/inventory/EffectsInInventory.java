...
public class EffectsInInventory {
   ...
   private void extractEffects(final GuiGraphicsExtractor graphics, final Collection activeEffects, final int x0, final int yStep, final int mouseX, final int mouseY, final int maxWidth) {
      Iterable sortedEffects = Ordering.natural().sortedCopy(activeEffects);
