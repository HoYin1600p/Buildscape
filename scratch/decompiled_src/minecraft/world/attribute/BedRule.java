...
public record BedRule(BedRule.Rule canSleep, BedRule.Rule canSetSpawn, boolean destroyOnUse, boolean destroyOnLeave, Optional errorMessage) {
   public static final BedRule CAN_SLEEP_WHEN_DARK = new BedRule(BedRule.Rule.WHEN_DARK, BedRule.Rule.ALWAYS, false, false, Optional.of(Component.translatable("block.minecraft.bed.no_sleep")));
   public static final BedRule DESTROY_ON_USE = new BedRule(BedRule.Rule.NEVER, BedRule.Rule.NEVER, true, false, Optional.empty());
   public static final BedRule DESTROY_ON_LEAVE = new BedRule(BedRule.Rule.WHEN_DARK, BedRule.Rule.NEVER, false, true, Optional.of(Component.translatable("block.minecraft.bed.no_sleep")));
   ...
   public static enum Rule implements StringRepresentable {
      ...
      public static final Codec CODEC = StringRepresentable.fromEnum(BedRule.Rule::values);
