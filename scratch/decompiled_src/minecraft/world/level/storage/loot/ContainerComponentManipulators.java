...
public interface ContainerComponentManipulators {
   ContainerComponentManipulator CONTAINER = new ContainerComponentManipulator(DataComponents.CONTAINER, ItemContainerContents.EMPTY);
   ContainerComponentManipulator BUNDLE_CONTENTS = new ContainerComponentManipulator(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY);
   ContainerComponentManipulator CHARGED_PROJECTILES = new ContainerComponentManipulator(DataComponents.CHARGED_PROJECTILES, ChargedProjectiles.EMPTY);
