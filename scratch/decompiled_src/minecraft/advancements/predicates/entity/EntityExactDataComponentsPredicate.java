...
public record EntityExactDataComponentsPredicate(DataComponentExactPredicate predicate) implements EntitySubPredicate {
   public static final Codec CODEC = DataComponentExactPredicate.CODEC.xmap(EntityExactDataComponentsPredicate::new, EntityExactDataComponentsPredicate::predicate);
