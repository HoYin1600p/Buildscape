...
public record ProfilePublicKey(ProfilePublicKey.Data data) {
   ...
   public static record Data(Instant expiresAt, PublicKey key, byte[] keySignature) {
      ...
      public static final Codec CODEC = RecordCodecBuilder.create((i) -> i.group(ExtraCodecs.INSTANT_ISO8601.fieldOf("expires_at").forGetter(ProfilePublicKey.Data::expiresAt), Crypt.PUBLIC_KEY_CODEC.fieldOf("key").forGetter(ProfilePublicKey.Data::key), ExtraCodecs.BASE64_STRING.fieldOf("signature_v2").forGetter(ProfilePublicKey.Data::keySignature)).apply(i, ProfilePublicKey.Data::new));
      public static final StreamCodec STREAM_CODEC = StreamCodec.composite(ByteBufCodecs.INSTANT, ProfilePublicKey.Data::expiresAt, ByteBufCodecs.PUBLIC_KEY, ProfilePublicKey.Data::key, ByteBufCodecs.byteArray(4096), ProfilePublicKey.Data::keySignature, ProfilePublicKey.Data::new);
      ...
      public boolean equals(final Object o) {
         if (!(o instanceof ProfilePublicKey.Data data)) {
            return false;
         } else {
