...
public class NetherBiomes {
   ...
   public static Biome netherWastes(final HolderGetter placedFeatures, final HolderGetter carvers) {
      ...
      return baseBiome().setAttribute(EnvironmentAttributes.FOG_COLOR, -13432824).setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_NETHER_WASTES)).setAttribute(EnvironmentAttributes.AMBIENT_SOUNDS, new AmbientSounds(Optional.of(SoundEvents.AMBIENT_NETHER_WASTES_LOOP), Optional.of(new AmbientMoodSettings(SoundEvents.AMBIENT_NETHER_WASTES_MOOD, 6000, 8, 2.0D)), List.of(new AmbientAdditionsSettings(SoundEvents.AMBIENT_NETHER_WASTES_ADDITIONS, 0.0111D)))).mobSpawnSettings(mobSpawnSettings).generationSettings(generation.build()).build();
   }

   public static Biome soulSandValley(final HolderGetter placedFeatures, final HolderGetter carvers) {
      double unitCharge = 0.7D;
      double energyBudget = 0.15D;
      MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addSpawn(EntityTypes.SKELETON, 20, 5, 5).addSpawn(EntityTypes.GHAST, 50, 4, 4).addSpawn(EntityTypes.ENDERMAN, 1, 4, 4).addSpawn(EntityTypes.STRIDER, 60, 1, 2).addMobSpawnCost(EntityTypes.SKELETON, 0.7D, 0.15D).addMobSpawnCost(EntityTypes.GHAST, 0.7D, 0.15D).addMobSpawnCost(EntityTypes.ENDERMAN, 0.7D, 0.15D).addMobSpawnCost(EntityTypes.STRIDER, 0.7D, 0.15D).build();
   ...
   public static Biome warpedForest(final HolderGetter placedFeatures, final HolderGetter carvers) {
      ...
      BiomeDefaultFeatures.addNetherDefaultOres(generation);
      return baseBiome().setAttribute(EnvironmentAttributes.FOG_COLOR, -15071974).setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_WARPED_FOREST)).modifyAttribute(EnvironmentAttributes.AMBIENT_PARTICLES, ListModifier.append(), AmbientParticle.of(ParticleTypes.WARPED_SPORE, 0.01428F)).setAttribute(EnvironmentAttributes.AMBIENT_SOUNDS, new AmbientSounds(Optional.of(SoundEvents.AMBIENT_WARPED_FOREST_LOOP), Optional.of(new AmbientMoodSettings(SoundEvents.AMBIENT_WARPED_FOREST_MOOD, 6000, 8, 2.0D)), List.of(new AmbientAdditionsSettings(SoundEvents.AMBIENT_WARPED_FOREST_ADDITIONS, 0.0111D)))).mobSpawnSettings(mobSpawnSettings).generationSettings(generation.build()).build();
   }
}
