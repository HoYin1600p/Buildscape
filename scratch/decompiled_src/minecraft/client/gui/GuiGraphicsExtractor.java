...
public class GuiGraphicsExtractor {
   ...
   public void profilerChart(final List chartData, final int x0, final int y0, final int x1, final int y1) {
   ...
   public void setTooltipForNextFrame(final Font font, final List texts, final Optional optionalImage, final int xo, final int yo, final @Nullable Identifier style, final boolean extraSpaceAfterFirstLine) {
   ...
   public void setTooltipForNextFrame(final Font font, final List tooltip, final Optional component, final ClientTooltipPositioner positioner, final int xo, final int yo, final boolean replaceExisting, final @Nullable Identifier style) {
      List components = (List)tooltip.stream().map(ClientTooltipComponent::create).collect(Collectors.toList());
   ...
   public void setTooltipForNextFrame(final Font font, final List lines, final int xo, final int yo) {
      this.setTooltipForNextFrame(font, lines, xo, yo, (Identifier)null);
   }
   ...
   private void setTooltipForNextFrameInternal(final Font font, final List lines, final int xo, final int yo, final ClientTooltipPositioner positioner, final @Nullable Identifier style, final boolean replaceExisting, final boolean extraSpaceAfterFirstLine) {
      if (!lines.isEmpty()) {
   ...
   public void tooltip(final Font font, final List lines, final int xo, final int yo, final ClientTooltipPositioner positioner, final @Nullable Identifier style, boolean extraSpaceAfterFirstLine) {
      int textWidth = 0;
   ...
   public ActiveTextCollector textRendererForWidget(final AbstractWidget owner, final GuiGraphicsExtractor.HoveredTextEffects hoveredTextEffects) {
      return new GuiGraphicsExtractor.RenderingTextCollector(this.createDefaultTextParameters(owner.getAlpha()), hoveredTextEffects, (Consumer)null);
   }
   ...
   public ActiveTextCollector textRenderer(final GuiGraphicsExtractor.HoveredTextEffects hoveredTextEffects, final @Nullable Consumer additionalHoverStyleConsumer) {
   ...
   public static enum HoveredTextEffects {
      ...
      // $FF: synthetic method
      private static GuiGraphicsExtractor.HoveredTextEffects[] $values() {
         return new GuiGraphicsExtractor.HoveredTextEffects[]{NONE, TOOLTIP_ONLY, TOOLTIP_AND_CURSOR};
      }
   }
   ...
   private class RenderingTextCollector implements ActiveTextCollector, Consumer {
      ...
      private RenderingTextCollector(final ActiveTextCollector.Parameters initialParameters, final GuiGraphicsExtractor.@Nullable HoveredTextEffects hoveredTextEffects, final Consumer additonalConsumer) {
