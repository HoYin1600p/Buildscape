...
public class ClientBundleTooltip implements ClientTooltipComponent {
   ...
   private void extractBundleWithItemsTooltip(final Font font, final int x, final int y, final int w, final int h, final GuiGraphicsExtractor graphics, final Fraction weight) {
      ...
      List shownItems = this.getShownItems(this.contents.getNumberOfItemsToShow());
   ...
   private void extractSlot(final int slotNumber, final int drawX, final int drawY, final List shownItems, final int slotIndex, final Font font, final GuiGraphicsExtractor graphics) {
