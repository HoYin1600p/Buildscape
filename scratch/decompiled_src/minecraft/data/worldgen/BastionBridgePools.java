...
public class BastionBridgePools {
   public static void bootstrap(final BootstrapContext context) {
      ...
      Holder entranceReplacement = processorLists.getOrThrow(ProcessorLists.ENTRANCE_REPLACEMENT);
      Holder bastionGenericDegradation = processorLists.getOrThrow(ProcessorLists.BASTION_GENERIC_DEGRADATION);
      Holder bridge = processorLists.getOrThrow(ProcessorLists.BRIDGE);
      Holder rampartDegradation = processorLists.getOrThrow(ProcessorLists.RAMPART_DEGRADATION);
