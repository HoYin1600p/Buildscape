...
public class SmithingTrimRecipe extends SimpleSmithingRecipe {
   ...
   public static final StreamCodec STREAM_CODEC = StreamCodec.composite(Recipe.CommonInfo.STREAM_CODEC, (o) -> o.commonInfo, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.template, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.base, Ingredient.CONTENTS_STREAM_CODEC, (o) -> o.addition, TrimPattern.STREAM_CODEC, (o) -> o.pattern, SmithingTrimRecipe::new);
   ...
   public static ItemStack applyTrim(final ItemStack baseItem, final ItemStack materialItem, final Holder pattern) {
      Holder material = (Holder)materialItem.get(DataComponents.PROVIDES_TRIM_MATERIAL);
      if (material != null) {
